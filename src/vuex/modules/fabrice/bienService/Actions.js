...
// export function ajouterTypeFacture({ commit, dispatch }, elementAjout) {
//   asyncLoading(axios.post('/type_factures', {
//     libelle: elementAjout.libelle

//   })).then(response => {
//     if (response.status == 201) {
//       commit('AJOUTER_TYPE_FACTURE', response.data)
//       dispatch('getTypeFacture')
//       this.$app.$notify({
//         title: 'success ',
...
// export function modifierTypeFacture({ commit, dispatch }, element_modifie) {
//   asyncLoading(axios.put('/type_factures/' + element_modifie.id, {
...
// action for print all to procedure
// export function getTypeProcedure({ commit }) {
//   queue.push(() => {
//     axios
//       .get("/type_procedures")
//       .then(response => {
//         commit("GET_ALL_TYPE_PROCEDURE", response.data);
//       })
//       .catch(error => console.log(error));
//   });
// }
...
//ajouter
// export function ajouterTypeProcedure({ commit, dispatch }, nouveau) {
//   asyncLoading(axios
//     .post("/type_procedures", {
...
// // modifier
// export function modifierTypeProcedure({ commit, dispatch }, nouveau) {
//   asyncLoading(axios
//     .put("/type_procedures/" + nouveau.id, {
...
//     .confirm("Voulez vouz vraiment supprimer ?.")
//     .then(dialog => {
//       commit("DELETE_TYPE_PROCEDURE", id);
