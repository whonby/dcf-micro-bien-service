...
export const  investissements = state => state.investissements

export const actesEffetInvestissement = state => state.actesEffetInvestissement



export  const getpersonnaliserInvestissement = (state, getters,rootState, rootGetters) =>
getters.investissements.map(element => {
if (element.unite_administrative_id !== null
    && element.activite_id !== null
    && element.economique_id !== null && 
    element.type_marche_id !== null && element.marche_id !== null) {
element = {
    ...element,
  ...
  "parametreGenerauxActivite/plans_activites"
    ...
    objetMarche: rootGetters[
        "bienService/marches"
    ].find(marche => marche.id == element.marche_id)
