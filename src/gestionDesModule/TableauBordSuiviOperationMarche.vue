         ...
         <div class="card" style="background-color:#f18383;">
           <h4 style="text-align:center;background-color:#f18383;color:black;font-weight:bold;"> 
            ...
            <div class="card-body">
              ...
              <p style="color:black;font-size:18px;font-weight:bold;">-Nombre des UA:2</p>
              <p  style="color:black;font-size:18px;font-weight:bold;">-Nombre des Marchés:2</p>
              <p  style="color:black;font-size:18px;font-weight:bold;">-Montant Total:2</p>
              <p  style="color:black;font-size:18px;font-weight:bold;">-Taux:2</p>
              <br>
              <br>
