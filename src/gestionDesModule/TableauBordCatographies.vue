...
<h6 align="center"> {{objetUnite.ville}}</h6>
        ...
        <!-- project -->
        <li class="span12 project shuffle-item filtered" v-for="marche_image in imageMarcheSelectionner(objetUnite.id)" :key="marche_image.id">
            <div class="card mb-0">
                <div class="project m-0">
                    <figure class="portfolio-item">
                        <div class="hovereffect">
                            <img class="center_image" :src="afficheImageMarche(marche_image.fichier)" alt="">
                            <div class="overlay">
                                <div class="hovereffect-title project-icons">
                                    <router-link :to="{ name: 'DetailImageMarche', params: { id:marche_image.id }}" title="Detail Marche CF">
                ...
                <!-- / project -->
                <div class="card-body">
                    <a href="#" class="card-title title-link fs-16 fw-bold" style="color:black">{{marche_image.libelle}}</a>
