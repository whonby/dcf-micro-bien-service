...
export default {
  ...
  computed: {
   ...
   ...mapActions('parametreGenerauxProgrammeUnite',['getUnite', 'getZone']),
    ...
    // ...mapActions([
    //   'parametreGenerauxAdministratif/getExercicesBudgetaires',
    //   'parametreGenerauxAdministratif/getTitres',
    //   'parametreGenerauxAdministratif/getNatureSection',
    //   'parametreGenerauxFonctionnelle/getStructureFonctionnelle',
