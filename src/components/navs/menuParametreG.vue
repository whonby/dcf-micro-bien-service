    ...
    <ul class="nav">
      ...
      <li class="dropdown" id="personnelPara">
        ...
        <ul class="dropdown-menu">
          ...
          <li>
            <router-link
              :to="{ name: 'ClassificationEmploisGradePrincipal' }"
              tag="a"
            >
              <i class="icon-user"></i>
      ...
      <li class="dropdown" id="comptaMatiere">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="divider"></li>
          <li>
            <router-link :to="{ name: 'ParametrageVehicule' }" tag="a">
              <i class="icon-check"></i>
