...
<template>
 ...
 <div ref="document">
     ...
     <h3 style="text-align:center">REGISTRE DES DEPENSES ENGAGEES :<span style="color: red;">{{anneeAmort}}</span></h3>
           
              <table class="table table-bordered table-striped" >
                <thead>
                   <tr style=";color: #000000;">
    <td style="width:10%;background-color: red" colspan="1">Exercice Budgétaire</td>
    <td style="width:90%;" colspan="12"></td>
   ...
   <td style="width:10%;" colspan="1">N° </td> 
    <td style="width:10%" colspan="1">Paragraphe</td>
    <td style="width:10%" colspan="1">Crédit Initial</td>
   <td style="width:10%" colspan="1">Crédit Final</td>
   ...
   <td style="width:10%" colspan="1">Crédit de paiement initial</td>
   <td style="width:10%" colspan="1">Crédit de paiement Final</td>
   <td style="width:10%" colspan="1">Date du Mandat</td>
   <td style="width:10%" colspan="1">Montant du Mandat</td>
    <td style="width:10%" colspan="1">Cumul du Mandat</td>
