                  ...
                  <div id="INFORMATIONUA" class="tab-pane active">
                    <table class="table table-bordered table-striped">
                      <tr>
                        ...
                        <td>
                          <div class="control-group">
                            <label class="control-label">Type de Dossier</label>
                            <div class="controls">
                              <select
                                v-model="formData123.typeDossier1"
                                class="span"
                                style="border: 1px solid #000"
                              >
                        ...
                        <td colspan="">
                          <div class="control-group" v-if="formData123.typeDossier1 == 1">
                            <label class="control-label"
                              >Numéro Démande
                      ...
                      <tr v-if="formData123.typeDossier1 != 0 && formData123.typeDossier1 != 1">
                         <td colspan="">
                          <label
                         ...
                         <td >
                          <div class="control-group" v-if="formData123.typeDossier1 == 'Mandat'">
                            <label class="control-label"
                              >Numéro Liquidation </label
                            >
                            <div class="controls">
                              <input
                                type="text"
                                style="border: 1px solid #000"
                                :value="NumeroLiquidation(formData123.dmd_engagement_id)"
                                class="span"
                                readonly
                              />
                            </div>
                        ...
                        <td>
                          <div class="control-group">
                            <label class="control-label">Numéro {{formData123.typeDossier1}}</label>
                            <div class="controls">
                              <input
                                type="text"
                                style="border: 1px solid #000; font-size: 15px"
                        ...
                        <td>
                          <div class="control-group">
                            <label class="control-label">Date {{formData123.typeDossier1}}</label>
                            <div class="controls">
                              <input
                                type="date"
                                style="border: 1px solid #000; font-size: 15px"
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <input
                                type="text"
                                style="border: 1px solid #000"
                                :value="FonctionUniteAdministrative"
                                class="span"
                                readonly
                              />
                            </div>
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <input
                                type="text"
                                style="border: 1px solid #000"
                                :value="FonctionLibelleEconomique"
...
<tr v-if="formData123.typeDossier1 != 0 && formData123.typeDossier1 != 1">
 ...
 <td >
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <input
                                type="text"
                                style="border: 1px solid #000"
                                :value="FonctionProcedureDepense"
                                class="span"
                                readonly
                              />
                            </div>
                      ...
                      <tr v-if="formData123.typeDossier1 == 0 || formData.type_engagement_id =='M' && formData123.typeDossier1 == 1" >
                ...
                <div class="controls">
                  <model-list-select style="border:1px solid #000"
                      ...
                      <tr>
                         <td colspan="" class="control-group" v-if="formData123.typeDossier1 == 0 || formData.type_engagement_id =='M' && formData123.typeDossier1 == 1">
                          <div >
                            <label class="control-label"
                              >Montant global Marche(Av+Mont marché)</label
                            >
                        ...
                        <td colspan="2" v-if="formData123.typeDossier1 == 0 || formData123.typeDossier1 == 1 && formData.type_engagement_id =='AD'">
                       <div class="control-group">
                ...
                <div class="controls">
                  <model-list-select style="border:1px solid #000"
                        ...
                        <td colspan="3" v-if="formData123.typeDossier1 == 1 && formData.type_engagement_id =='M'">
                          <div class="control-group">
                      ...
                      <!-- <tr>
                        <td>
                          <div class="control-group">
                            <label class="control-label"
                              >Réf.Engagement juridique</label
                            >
                            <div class="controls">
                              <input
                                type="text"
                    ...
                    <table class="table table-bordered table-striped">
                      <tr>
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <select
                                ...
                                class="span"
                                style="border: 1px solid #000"
                                v-if="formData123.typeDossier1 == 0 || formData123.typeDossier1 == 1"
                              >
                                <option
                        ...
                        <!-- <td colspan="">
                          <div class="control-group">
                            <label class="control-label"
                              >Auteur(Bénéficiaire ou fournisseur)</label
                            >
                            <div class="controls">
                              <select
                                v-model="formData5.Auteur_id"
                                class="span"
                                style="border: 1px solid #000"
                              >
                  ...
                  <div id="tab1" class="tab-pane active">
                    <table class="table table-bordered table-striped">
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <input
                                ...
                                "
                                class="span"
                                v-if="formData.type_engagement_id != 'AD' && formData123.typeDossier1 == 0 || formData.type_engagement_id != 'AD' && formData123.typeDossier1 == 1"
                                readonly
                              />
                      ...
                      <tr>
                        <td colspan="">
                          <div class="control-group">
                            <label class="control-label" v-if="formData123.typeDossier1 == 0 && formData123.typeDossier1 == 1">Montant Engagé</label>
                            <label class="control-label" v-else>Montant {{formData123.typeDossier1}}</label>
                            <div class="controls">
                             
                  <money
                  v-if="formData123.typeDossier1 != 0 && formData123.typeDossier1 != 1"
                                :value="FonctionMontantTotal"
                                readOnly
                                style="text-align: left; color: red"
                                class="span"
                              ></money>
                             ...
                             v-else
                              ...
                              <code style="color: red; font-size: 12px" v-if="formData123.typeDossier1 == 0 && formData123.typeDossier1 == 1"
                                >MONTANT A PAYE:
                                {{
...
<table class="table table-bordered table-striped">
    ...
    <tr>
       <label
                          ...
                          <table v-if="formData123.typeDossier1 != 0 && formData123.typeDossier1 != 1"
                       ...
                       <tr>
                        <td colspan="3">
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <input v-if="formData123.typeDossier1 != 0 && formData123.typeDossier1 != 1"
                                type="text"
                                style="border: 1px solid #000"
                                :value="FonctionCodeActivite"
                                class="span"
                      ...
                      <tr>
                        <td colspan="">
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <money   v-if="formData123.typeDossier1 != 0 && formData123.typeDossier1 != 1"
                                :value="FonctionMontantTotal"
                                readOnly
                                style="text-align: left; color: red"
                                class="span"
...
ajouterBudgetaireLocal () {
  var objet={
    ...
    AjouterDemandeEngagement() {
      ...
      this.ajouterDossierMandat(nouvelObjet2);
      }
      else if (this.formData123.typeDossier1 == "Bon DE Commande") {
        var nouvelObjet47 = {
        
        dmd_engagement_id: this.formData123.dmd_engagement_id,
        
        	numero_bon_commande:this.formData1122.numero,
        date_bon_commande:this.formData1122.date
      };
      this.ajouterBonCommandes(nouvelObjet47);
      }
      else{
        return ""
      }
