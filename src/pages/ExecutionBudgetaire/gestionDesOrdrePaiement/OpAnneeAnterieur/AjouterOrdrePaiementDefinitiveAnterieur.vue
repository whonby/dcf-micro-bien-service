...
<table class="table table-bordered table-striped">
 ...
 <tr>
                        <td colspan="4">
                          ...
                          <label
                            ...
                            >PIECE JUSTIFICATIVE PROVISOIRE</label
                          >
 ...
 <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="(type) in listeFacturePiece(formData.numero_ordre_paiement)"
                          :key="type.id"
                        >
 ...
 <tr>
                        <td colspan="4">
                          ...
                          <label
                            ...
                            >PIECE JUSTIFICATIVE DEFINITIVE</label
                          >
                          ...
                          >
                            ...
                            <tbody>
                              <tr
                                class="odd gradeX"
                                v-for="type in listePieceJustificativeOpDefinitive(formData.numero_ordre_paiement)"
                                :key="type.id"
                              >
                                <td
                                  style="width:20%,text-align:center"
                  ...
                  <div class="controls">
                    <div data-toggle="buttons-checkbox" class="btn-group">
                      <a
                        ...
                        @click.prevent="AjouterOrdrePaiementDefinitive"
                        >Valider</a
                      >
                       <a
...
<money :value="montantTva"  readonly  style="text-align:left;color:red;font-size:16px"  class="span4"></money>
    ...
    <div id="modificationModal12" class="modal hide tailles">
      <div class="modal-header">
        <button data-dismiss="modal" class="close" type="button">×</button>
 ...
 RecuperereTaux() {
          ...
          return this.gettersgestionOrdrePaiement
            .filter(
              (qtreel) =>
                ...
                qtreel.decision_cf == 8  && qtreel.exercice == this.formData.exercice &&
                qtreel.diff_op == null
            )
            .reduce(
              (prec, cur) =>
        ...
        if (id != null && id != "" && id1 != null && id1 != "") {
          const qtereel = this.budgetEclate.find(
            (qtreel) =>
              ...
              qtreel.ligneeconomique_id == id1 &&  qtreel.annebudgetaire == this.formData.exercice
          );
        ...
        if (id != null && id != "") {
          return this.groupeActiviteBudget.filter(
            (qtreel) =>
              qtreel[0].ua_id == id &&
              qtreel[0].actived == 1 &&
              qtreel[0].exercicebudget_id == this.formData.exercice
          );
        }
      };
    },
  ...
  methods: {
    ...
    afficherModalModifierFacture(id) {
      this.$("#modificationModal12").modal({
        backdrop: "static",
        keyboard: false
      });
