                        ...
                        <td colspan="">
                          <div class="control-group">
                            ...
                            <div class="controls">
                              ...
                              >
                                <option
                                  v-for="typeFact in AfficheBanqueEntreprise(formData45.nom_autre_depense)"
                                  :key="typeFact.id"
                                  :value="typeFact.banq_id"
                                >
                                  {{ libelleBanque(typeFact.banq_id) }}
                                </option>
                              </select>
                            </div>
                          </div>
                        ...
                        <td colspan="">
                          <div class="control-group">
                            ...
                            <div class="controls">
                              ...
                              >
                                <option
                                  v-for="typeFact in AfficheCompteEntreprise(formData45.nom_autre_depense,formData45.reference_autre_depense)"
                                  :key="typeFact.id"
                                  :value="typeFact.id"
                                >
                                  {{typeFact.rib }}
  ...
  //  };
    ...
    LigneEconomiqueSousBudget() {
      //return (id) => {
        ...
        let objet = this.budgetEclate.filter(budget=> budget.sous_budget_id ==this.formData.sous_budget_id  && budget.budget_active==1 && budget.annebudgetaire == this.formData.exercice);
        //  let vm=this
        let array_exercie = [];
        if (objet.length > 0) {
          objet.forEach(function (val) {
