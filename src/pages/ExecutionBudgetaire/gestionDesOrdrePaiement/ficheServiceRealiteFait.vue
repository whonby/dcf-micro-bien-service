          ...
          <div class="subpage">
            ...
            <div style="border: 2px double #000; text-align: center">
              <p style="margin-top: 10px; font-weight: bold">
                FICHE DE CONTRÔLE DE LA REALITE DU SERVICE FAIT <br />
                INSTITUEE PAR L'ARRETE N° 638 MEF/CAB/YKM DU 20 JUILLET 2009
              </p>
            </div>
            <br />
            <br />
      ...
      <br>
                ...
                <td>
                  ...
                  {{
                    recupererNomDuControleurF(
                      recupererIdUser(
                        recupererIdServiceCF(detailOp.unite_administrative_id)
                      )
                    )
                  }}
                  <br />
        ...
        <div class="page">
          ...
          <div class="subpage">
            ...
            <div style="border: 2px double #000; text-align: center">
              <p style="margin-top: 10px; font-weight: bold">
                FICHE DE CONTRÔLE DE LA REALITE DU SERVICE FAIT
              </p>
            </div>
            <br />
            <br />
      ...
      <br>
        <span style="font-weight: bold;font-size:20px">TAUX DE REALISATION</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:16px;text-align:center"></span>
            ...
            <h5
              ...
              "
            >
              CACHET ET SIGNATURE DE L'AGENT DCF
            </h5>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...
    afficheDateFacture() {
      return (id) => {
        if (id != null && id != "") {
          const qtereel = this.gettersnomPieceJustificative.find(
            (qtreel) => qtreel.numero_ordrepaiement == id
          );
        ...
        if (id != null && id != "") {
          ...
          if (qtereel) {
            return qtereel.email
              .concat(" / ", qtereel.telephone)
              .concat(" / ", qtereel.adresse);
          }
          return "";
        }
      };
  ...
  methods: {
    ...
    getColumns() {
      return [{ title: "EXERCICE BUDGETAIRE", dataKey: "exercice_budget" }];
    },
    alert() {
      console.log("ok");
    },
