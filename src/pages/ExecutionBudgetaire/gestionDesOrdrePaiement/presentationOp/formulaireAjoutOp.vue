            ...
            <table class="table table-bordered table-striped">
              <div class="widget-box">
                ...
                <div class="widget-content tab-content">
                  ...
                  <AjouterOrdrePaiementProvisoire></AjouterOrdrePaiementProvisoire>
                  </div>
                  <div id="ANNULATION" class="tab-pane active" v-if="formData.type_ordre_paiement==3">
                  
                  <AjouterOrdrePaiementAnnulation></AjouterOrdrePaiementAnnulation>
                  </div>
                  <div id="DEFINITIF" class="tab-pane active" v-if="formData.type_ordre_paiement==4">
                
                  <AjouterOrdrePaiementDefinitive></AjouterOrdrePaiementDefinitive>
                  </div>
