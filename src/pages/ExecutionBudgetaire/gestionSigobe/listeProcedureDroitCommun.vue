      ...
      <div class="span12">
       ...
       <table>
        ...
        <div align="right" style="cursor:pointer;">
            ...
            <h5>Liste Procedures de dépenses </h5>
             <div align="right">
        Recherche: <input type="text" v-model="search">
          ...
          <div class="span4">
           ...
           <div class="widget-content nopadding">
            ...
            <div v-else>
              <div align="center">
                <h6 style="color:red;">Pas de Procedures de dépenses enregistré </h6>
              </div>
            </div>
          </div>
        </div>
...
<!----- ajouter modal   ---->
 ...
 <div id="exampleModal" class="modal hide">
              <div class="modal-header">
                ...
                <h3>Ajouter Procedures de dépenses</h3>
              </div>
...
<!----- modifier modal debut  ---->
 ...
 <div id="modifierModal" class="modal hide">
              <div class="modal-header">
             <button data-dismiss="modal" class="close" type="button">×</button>
                <h3>Modifier Procedures de dépenses</h3>
              </div>
              <div class="modal-body">
               <table class="table table-bordered table-striped">
...
// methode pour maper notre guetter
   ...mapGetters('bienService', ['gettersProcedureDroitCommuns']) ,
...
return this.gettersProcedureDroitCommuns.filter((item) => {
  ...
  methods: {
   ...
   ...mapActions('bienService', ['getStructureActivite', 'ajouterProcedureDroitCommun', 
   'modifierProcedureDroitCommun','supprimerProcedureDroitCommun']),  
...
getColumns() {
    ...
    afficherModalajouterProcedureDroitCommun(){
   ...
   // fonction pour vider l'input
    ajouterBudgetaireLocal () {
      ...
      this.ajouterProcedureDroitCommun(this.formData)
...
afficherModalModifierBudgetaire(id){
 ...
 this.$('#modifierModal').modal({
        ...
        this.editProcedureDroitCommun = this.gettersProcedureDroitCommuns.find(item => item.id==id);
...
modifierBudgetaireLocal(){
  this.modifierProcedureDroitCommun(this.editProcedureDroitCommun)
