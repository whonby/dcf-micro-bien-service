                ...
                <thead>
                 ...
                 <th style="font-size:14px;font-weight:bold;background-color: #73aff6;color:#000">N°demande</th>
                   <th style="font-size:14px;font-weight:bold;background-color: #73aff6;color:#000">Type Engagement </th>
                    ...
                    <th style="font-size:14px;font-weight:bold;background-color: #73aff6;color:#000">Tresor</th>
                    <th style="font-size:14px;font-weight:bold;background-color: #73aff6;color:#000">Don</th>
                    <th style="font-size:14px;font-weight:bold;background-color: #73aff6;color:#000">Emprunt</th>
...
recupererLibelleTypeDepense() {
     ...
     listeDemandeParUa() {
      return id => {
        if (id != null && id != "") {
           return this.gettersDemandeEngagement.filter(qtreel => qtreel.ua_id == id && qtreel.type_procedure_id==7 && qtreel.decision_cf == 0);
