   ...
   <div id="demandeVise1" class="modal hide tailgrand">
    ...
    <table class="table table-bordered table-striped">
                <thead>
                 ...
                 <th style="font-size:14px;font-weight:bold;background-color: #e6b637;color:#000">N°Bon Commande</th>
                 <th style="font-size:14px;font-weight:bold;background-color: #e6b637;color:#000">Date Bon Commande</th>
...
RecupererNiveau3StructureDecision() {
     ...
     listeBonCommandeParUa() {
      return id => {
        if (id != null && id != "") {
           return this.gettersBonCommande.filter(qtreel => this.idUa(qtreel.dmd_engagement_id) == id &&  this.AfficheTypeProcedure(qtreel.dmd_engagement_id)==7 && qtreel.decision_cf == 2);
