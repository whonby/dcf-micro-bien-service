...
<template>
  <div>
     <div id="demandeVise45" class="modal hide tailgrand">
          ...
          <tr>
            <td>
              <div class="control-group">
                            ...
                            <div class="controls">
                              <select v-model="editMandatbc.decision_cf" class="span4">
                                <option value=""></option>
              ...
              <td>
                    <div class="control-group">
                            ...
                            <div class="controls">
                               <select v-model="editMandatbc.famille_motif_cf" class="span4" >
                 ...
                 <td>
                    <div class="control-group">
                            ...
                            <div class="controls">
                               <select v-model="editMandatbc.motif_cf" class="span4" >
                                 <option value="0"></option>
                                <option v-for="varText in AffichierElementEnfant(editMandatbc.famille_motif_cf)" :key="varText.id"
                                        :value="varText.id">{{varText.libelle}}</option>
                            </select>
               ...
               <tr>
                  <td colspan="2">
                        <div class="control-group">
                            ...
                            <div class="controls">
                              <textarea  class="span8" row = "6" v-model="editMandatbc.autre_motif_cf" :readonly="griserAutreMotif" >
                              </textarea>
                            </div>
                          </div>
                       </td>
                  <td>
                            ...
                            <div class="controls">
                               ...
                               <input type="date" class="span4"  v-model="editMandatbc.date_motif" />
                   ...
                   <tr>
                     <td colspan="2">
                        <div class="control-group">
                            ...
                            <div class="controls">
                              <textarea  class="span8" row = "6" v-model="editMandatbc.observation" :readonly="griserObservation">
                              </textarea>
                            </div>
                          </div>
                       </td>
    ...
    <table class="table table-bordered table-striped">
                <thead>
                 ...
                 <th style="font-size:14px;font-weight:bold;background-color: red;color:#000">N°demande</th>
                 <th style="font-size:14px;font-weight:bold;background-color: red;color:#000">N°Liquidation</th>
                 <th style="font-size:14px;font-weight:bold;background-color: red;color:#000">N°Mandat</th>
                   <th style="font-size:14px;font-weight:bold;background-color: red;color:#000">Date Mandat</th>
                   <th style="font-size:14px;font-weight:bold;background-color: red;color:#000">Type d'engagement</th>
                    <th style="font-size:14px;font-weight:bold;background-color: red;color:#000">Objet de la depense</th>
                    
                     <th style="font-size:14px;font-weight:bold;background-color: red;color:#000">Montant Engagé</th>
...
props:["macheid"],
 ...
 ...mapGetters("bienService", ["gettersProcedureTypeDepense","gettersDossierLiquidation","gettersDossierMandat","gettersDemandeEngagement","gettersnomPieceJustificative","modepaiements","gettersCotationPersonnaliser","typeCandidat",'acteDepense',"getMarchePersonnaliser","appelOffres","lots","villes","communes","pays","modePassations", "procedurePassations","getterDossierCandidats","marches","gettersPersonnaliserRapportJugement",
          ...
          griserObservation(){
  return this.editMandatbc.decision_cf != 9
},
    griserFamilleEtMotif(){
  return this.editMandatbc.decision_cf != 3 && this.editMandatbc.decision_cf != 2
},
griserAutreMotif(){
  return this.editMandatbc.motif != 237 
},
...
RecupererNiveau3StructureDecision() {
 ...
 AfficheExeciceBudgetaire() {
     ...
     listeDemandeParUa() {
      return id => {
        if (id != null && id != "") {
           return this.gettersDossierMandat.filter(qtreel => this.idUa(qtreel.demande_engagement_id) == id && this.AfficheTypeProcedure(qtreel.demande_engagement_id)==7 && qtreel.decision_cf==3);
  ...
  methods: {
   ...mapActions("bienService", [
     ...
     "modifierDossierLiquidation",
      ...
      this.$("#demandeVise45").modal({
        backdrop: "static",
        keyboard: false
      });

       this.editMandatbc = this.listeDemandeParUa(this.macheid).find(item=>item.id==id);
    },
    modifierTypeTexteLocal() {
      var Mandat ={
        
        id:this.editMandatbc.id,
        decision_cf:this.editMandatbc.decision_cf,
        famille_motif_cf:this.editMandatbc.famille_motif_cf,
        autre_motif_cf:this.editMandatbc.autre_motif_cf,
        motif_cf:this.editMandatbc.motif_cf,
        date_motif:this.editMandatbc.date_motif,
        observation:this.editMandatbc.observation
      }
       
       
      this.modifierDossierMandat(Mandat);
     
this.$("#demandeVise45").modal('hide');
