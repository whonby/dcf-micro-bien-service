...
RecupererNiveau3StructureDecision() {
 ...
 AfficheExeciceBudgetaire() {
     ...
     listeDemandeParUa() {
      return id => {
        if (id != null && id != "") {
           return this.gettersDossierMandat.filter(qtreel => this.idUa(qtreel.demande_engagement_id) == id && this.AfficheTypeProcedure(qtreel.demande_engagement_id)==7 && qtreel.decision_cf==9);
