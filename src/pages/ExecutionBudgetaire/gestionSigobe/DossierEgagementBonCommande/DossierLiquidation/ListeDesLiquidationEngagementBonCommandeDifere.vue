  ...
  <div>
   <div id="demandeVise12" class="modal hide tailgrand">
    ...
    <table class="table table-bordered table-striped">
                <thead>
                  <tr>
                  <th style="font-size:14px;font-weight:bold;background-color: #e6b637;color:#000">Année budgétaire</th>
                 <th style="font-size:14px;font-weight:bold;background-color: #e6b637;color:#000">N°demande</th>
                              <th style="font-size:14px;font-weight:bold;background-color: #e6b637;color:#000">Bon de commande</th>
                 <th style="font-size:14px;font-weight:bold;background-color: #e6b637;color:#000">N°Liquidation</th>
                 <th style="font-size:14px;font-weight:bold;background-color: #e6b637;color:#000">Date Liquidation</th>
                   <th style="font-size:14px;font-weight:bold;background-color: #e6b637;color:#000">Type Engagement </th>
                    ...
                    <th style="font-size:14px;font-weight:bold;background-color: #e6b637;color:#000">Montant Liquidé</th>
...
RecupererNiveau3StructureDecision() {
  ...
  NumeroBonCommande() {
     ...
     listeLiquidationParUa() {
      return id => {
        if (id != null && id != "") {
           return this.gettersDossierLiquidation.filter(qtreel => this.idUa(qtreel.dmd_engagement_id) == id &&  this.AfficheTypeProcedure(qtreel.dmd_engagement_id) == 7  && qtreel.decision_cf == 2);
