...
RecupererNiveau3StructureDecision() {
  ...
  NumeroBonCommande() {
     ...
     listeLiquidationParUa() {
      return id => {
        if (id != null && id != "") {
           return this.gettersDossierLiquidation.filter(qtreel => this.idUa(qtreel.dmd_engagement_id) == id &&  this.AfficheTypeProcedure(qtreel.dmd_engagement_id) == 7  && qtreel.decision_cf == 8);
