   ...
   <table>
            <tr>
              <h5 style="font-size:20px;text-transform: uppercase; text-align:center;text-decoration: underline;">
                Liste des Modalités d’exécution
                </h5>
            </tr>
          </table> 
          <br>
        <div align="right" style="cursor:pointer;">
            <button class="btn btn-success" @click.prevent="afficherModalajouterProcedureDerogatoire()">AJOUTER UNE MODALITE </button>
      </div>  
              ...
              <tbody>
                <tr class="odd gradeX" v-for="activites in partition (localisationsFiltre,size)[page]"
                 :key="activites.id">
                  ...
                  <td>     
                    <button @click.prevent="supprimerProcedureDerogatoire(activites.id)"  class="btn btn-danger ">
...
<!----- ajouter modal   ---->
 ...
 <div id="exampleModal" class="modal hide">
            ...
            <tr>
              ...
              <div class="controls">
                <input required type="text" v-model="formData.libelle" class="span5" placeholder="Saisir le libellé" />
              </div>
            </div>
              </td>
            </tr>
...
<!----- modifier modal debut  ---->
 ...
 <div id="modifierModal" class="modal hide">
            ...
            <tr>
              ...
              <div class="controls">
                <input type="text" v-model="editProcedureDroitCommun.libelle" class="span5" placeholder="" />
              </div>
            </div>
              </td>
            </tr>
           ...
           <div class="modal-footer"> 
             <button 
             @click.prevent="modifierBudgetaireLocal(editProcedureDroitCommun)" class="btn btn-primary"
...
<!-- <button style="display:none;" v-shortkey.once="['ctrl', 'f']"
  @shortkey="afficherModalajouterProcedureDerogatoire()">Open</button>

         <fab :actions="fabActions"
                main-icon="apps"
       @cache="afficherModalajouterProcedureDerogatoire"
        bg-color="green"
...
// methode pour maper notre guetter
   ...mapGetters('bienService', ['gettersProcedureDerogatoires']) ,
...
return this.gettersProcedureDerogatoires.filter((item) => {
    ...
    return item.libelle.toLowerCase().includes(searchTerm)
		...
		return this.gettersProcedureDerogatoires.length + 1
	}
  },

  methods: {
    // methode pour notre action
   ...mapActions('bienService', ['getStructureActivite', 'ajouterProcedureDerogatoire', 
   'modifierProcedureDerogatoire','supprimerProcedureDerogatoire']),  
  ...
  // doc.autoTable({ html: this.natures_sections })
   var data = this.gettersProcedureDerogatoires;
   doc.setFontSize(8)
...
getColumns() {
    ...
    afficherModalajouterProcedureDerogatoire(){
   ...
   // fonction pour vider l'input
    ajouterBudgetaireLocal () {
      ...
      this.ajouterProcedureDerogatoire(this.formData)
...
afficherModalModifierBudgetaire(id){
 ...
 this.$('#modifierModal').modal({
        ...
        this.editProcedureDroitCommun = this.gettersProcedureDerogatoires.find(item => item.id==id);
...
modifierBudgetaireLocal(){
  this.modifierProcedureDerogatoire(this.editProcedureDroitCommun)
