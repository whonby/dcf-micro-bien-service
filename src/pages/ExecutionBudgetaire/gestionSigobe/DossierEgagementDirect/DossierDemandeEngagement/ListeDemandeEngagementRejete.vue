    ...
    <table class="table table-bordered table-striped">
                <thead>
                 ...
                 <th style="font-size:14px;font-weight:bold;background-color: red;color:#000">N°demande</th>
                   <th style="font-size:14px;font-weight:bold;background-color: red;color:#000">Type Engagement </th>
                    ...
                    <th style="font-size:14px;font-weight:bold;background-color: red;color:#000">Tresor</th>
                    <th style="font-size:14px;font-weight:bold;background-color: red;color:#000">Don</th>
                    <th style="font-size:14px;font-weight:bold;background-color: red;color:#000">Emprunt</th>
                ...
                <tbody>
                  ...
                  <td >
                     ...
                     <td>
                      <router-link :to="{ name: 'Detailexecution', params: { id: type, id1:1 }}"
...
recupererLibelleTypeDepense() {
     ...
     listeDemandeParUa() {
      return id => {
        if (id != null && id != "") {
           return this.gettersDemandeEngagement.filter(qtreel => qtreel.ua_id == id && qtreel.type_procedure_id==1 && qtreel.decision_cf==3 );
