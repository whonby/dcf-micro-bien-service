...
<template>
  <div>
    <notifications/>
   <div id="validationOpDefinitifdefVise" class="modal hide tailgrand">
      ...
      <div class="modal-body">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="editMandatdefvise.decision_cf" class="span5">
                    <option value=""></option>
            ...
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="editMandatdefvise.famille_motif" class="span5">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="editMandatdefvise.motif" class="span5">
                    <option value="0"></option>
                    <option
                      v-for="varText in AffichierElementEnfant(
                        editMandatdefvise.famille_motif
                      )"
                      :key="varText.id"
                      :value="varText.id"
                    >
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="editMandatdefvise.autre_motif"
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input
                    type="date"
                    class="span5"
                    v-model="editMandatdefvise.date_decision_cf"
                  />
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="editMandatdefvise.observation"
                  >
                  </textarea>
                </div>
              </div>
                      ...
                      recupererNomDuControleurF(
                        recupererIdUser(
                          recupererIdServiceCF(
                            editMandatdefvise.unite_administrative_id
                          )
                        )
                      )
                    "
        ...
        <table
          ...
          v-if="editMandatdefvise.decision_cf == 2"
        >
          <div class="row-fluid">
            <div class="span6">
              <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                  <templete v-if="verifier(editMandatdefvise.id) == editMandatdefvise.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in listeOpdiffere(editMandatdefvise.id)"
                          :key="type.id"
                        >
                  ...
                  <templete v-if="verifier(editMandatdefvise.id) == editMandatdefvise.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in EurreurCorrige(editMandatdefvise.id)"
                          :key="type.id"
                        >
                          <td @dblclick="afficherModalModifierTypeTexte(index)">
                            {{
...
created() {
  ...
  computed: {
   ...
   listeOpdiffere() {
    ...
    griserAutreMotif() {
      return this.editMandatdefvise.motif != 237;
    },
    ...
    listeordrepaiementProvisoire() {
      return this.gettersgestionOrdrePaiement.filter(
        (qtreel) => qtreel.diff_op != null  && qtreel.unite_administrative_id == this.marcheid && qtreel.type_ordre_paiement==4 && qtreel.decision_cf == 8
      );
    },
...
afficherModalModifierTitre(id) {
   ...
   DetacheMotif(id) {
    ...
    modifierTypeTexteLocal() {
      var nouveauObjet = {
        decision_cf: this.editMandatdefvise.decision_cf,
        famille_motif: this.editMandatdefvise.famille_motif,
        motif: this.editMandatdefvise.motif,
        date_decision: this.editMandatdefvise.date_decision_cf,
        diff_decision: 0,
        id_op: this.editMandatdefvise.id,
      };
        var nouveauObjet1 = {
          ...this.editMandatdefvise,
        decision_cf: this.editMandatdefvise.decision_cf,
        famille_motif: this.editMandatdefvise.famille_motif,
        motif: this.editMandatdefvise.motif,
        date_decision_cf: this.editMandatdefvise.date_decision_cf,
        diff_op: 0,
        id: this.editMandatdefvise.id,
      };
      this.ajouterHistoriqueDecisionOp(nouveauObjet);
      this.modifierGestionOrdrePaiement(nouveauObjet1);
      this.$("#validationOpDefinitifdefVise").modal("hide");
    },
    ...
    apercuFacture0(id) {
      this.$("#validationOpDefinitifdefVise").modal({
        backdrop: "static",
        keyboard: false,
      });
      this.editMandatdefvise = this.gettersgestionOrdrePaiement.find(
        (item) => item.id == id
      );
    },
 pagePrecedent(){
