...
<template>
  <div>
    <notifications/>
   <div id="validationOpDefinitifAnnulationVisO" class="modal hide tailgrand">
      ...
      <div class="modal-body">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="OpAnnulationViseO.decision_cf" class="span5">
                    <option value=""></option>
            ...
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="OpAnnulationViseO.famille_motif" class="span5">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="OpAnnulationViseO.motif" class="span5">
                    <option value="0"></option>
                    <option
                      v-for="varText in AffichierElementEnfant(
                        OpAnnulationViseO.famille_motif
                      )"
                      :key="varText.id"
                      :value="varText.id"
                    >
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="OpAnnulationViseO.autre_motif"
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input
                    type="date"
                    class="span5"
                    v-model="OpAnnulationViseO.date_decision_cf"
                  />
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="OpAnnulationViseO.observation"
                  >
                  </textarea>
                </div>
              </div>
                      ...
                      recupererNomDuControleurF(
                        recupererIdUser(
                          recupererIdServiceCF(
                            OpAnnulationViseO.unite_administrative_id
                          )
                        )
                      )
                    "
        ...
        <table
          ...
          v-if="OpAnnulationViseO.decision_cf == 2"
        >
          <div class="row-fluid">
            <div class="span6">
              <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                  <templete v-if="verifier(OpAnnulationViseO.id) == OpAnnulationViseO.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in listeOpdiffere(OpAnnulationViseO.id)"
                          :key="type.id"
                        >
                  ...
                  <templete v-if="verifier(OpAnnulationViseO.id) == OpAnnulationViseO.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in EurreurCorrige(OpAnnulationViseO.id)"
                          :key="type.id"
                        >
                          <td @dblclick="afficherModalModifierTypeTexte(index)">
                            {{
...
created() {
  ...
  computed: {
   ...
   listeOpdiffere() {
    ...
    griserAutreMotif() {
      return this.OpAnnulationViseO.motif != 237;
    },
    ...
    listeordrepaiementProvisoire() {
      return this.gettersgestionOrdrePaiement.filter(
        (qtreel) => qtreel.diff_op != null  && qtreel.unite_administrative_id == this.marcheid && qtreel.type_ordre_paiement==3 && qtreel.decision_cf == 9
      );
    },
...
afficherModalModifierTitre(id) {
   ...
   DetacheMotif(id) {
    ...
    modifierTypeTexteLocal() {
      var nouveauObjet = {
        decision_cf: this.OpAnnulationViseO.decision_cf,
        famille_motif: this.OpAnnulationViseO.famille_motif,
        motif: this.OpAnnulationViseO.motif,
        date_decision: this.OpAnnulationViseO.date_decision_cf,
        diff_decision: 0,
        id_op: this.OpAnnulationViseO.id,
      };
        var nouveauObjet1 = {
          ...this.OpAnnulationViseO,
        decision_cf: this.OpAnnulationViseO.decision_cf,
        famille_motif: this.OpAnnulationViseO.famille_motif,
        motif: this.OpAnnulationViseO.motif,
        date_decision_cf: this.OpAnnulationViseO.date_decision_cf,
        diff_op: 0,
        id: this.OpAnnulationViseO.id,
      };
      this.ajouterHistoriqueDecisionOp(nouveauObjet);
      this.modifierGestionOrdrePaiement(nouveauObjet1);
      this.$("#validationOpDefinitifAnnulationVisO").modal("hide");
    },
    ...
    apercuFacture0(id) {
      this.$("#validationOpDefinitifAnnulationVisO").modal({
        backdrop: "static",
        keyboard: false,
      });
      this.OpAnnulationViseO = this.gettersgestionOrdrePaiement.find(
        (item) => item.id == id
      );
    },
 pagePrecedent(){
