...
<template>
  <div>
    <notifications/>
   <div id="validationOpDefinitifopAnnulationDif" class="modal hide tailgrand">
      ...
      <div class="modal-body">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="opAnnulationDif.decision_cf" class="span5">
                    <option value=""></option>
            ...
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="opAnnulationDif.famille_motif" class="span5">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="opAnnulationDif.motif" class="span5">
                    <option value="0"></option>
                    <option
                      v-for="varText in AffichierElementEnfant(
                        opAnnulationDif.famille_motif
                      )"
                      :key="varText.id"
                      :value="varText.id"
                    >
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="opAnnulationDif.autre_motif"
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input
                    type="date"
                    class="span5"
                    v-model="opAnnulationDif.date_decision_cf"
                  />
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="opAnnulationDif.observation"
                  >
                  </textarea>
                </div>
              </div>
                      ...
                      recupererNomDuControleurF(
                        recupererIdUser(
                          recupererIdServiceCF(
                            opAnnulationDif.unite_administrative_id
                          )
                        )
                      )
                    "
        ...
        <table
          ...
          v-if="opAnnulationDif.decision_cf == 2"
        >
          <div class="row-fluid">
            <div class="span6">
              <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                  <templete v-if="verifier(opAnnulationDif.id) == opAnnulationDif.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in listeOpdiffere(opAnnulationDif.id)"
                          :key="type.id"
                        >
                  ...
                  <templete v-if="verifier(opAnnulationDif.id) == opAnnulationDif.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in EurreurCorrige(opAnnulationDif.id)"
                          :key="type.id"
                        >
                          <td @dblclick="afficherModalModifierTypeTexte(index)">
                            {{
...
created() {
  ...
  computed: {
   ...
   listeOpdiffere() {
    ...
    griserAutreMotif() {
      return this.opAnnulationDif.motif != 237;
    },
    ...
    listeordrepaiementProvisoire() {
      return this.gettersgestionOrdrePaiement.filter(
        (qtreel) => qtreel.diff_op != null  && qtreel.unite_administrative_id == this.marcheid && qtreel.type_ordre_paiement==3 && qtreel.decision_cf == 2
      );
    },
...
afficherModalModifierTitre(id) {
   ...
   DetacheMotif(id) {
    ...
    modifierTypeTexteLocal() {
      var nouveauObjet = {
        decision_cf: this.opAnnulationDif.decision_cf,
        famille_motif: this.opAnnulationDif.famille_motif,
        motif: this.opAnnulationDif.motif,
        date_decision: this.opAnnulationDif.date_decision_cf,
        diff_decision: 0,
        id_op: this.opAnnulationDif.id,
      };
        var nouveauObjet1 = {
          ...this.opAnnulationDif,
        decision_cf: this.opAnnulationDif.decision_cf,
        famille_motif: this.opAnnulationDif.famille_motif,
        motif: this.opAnnulationDif.motif,
        date_decision_cf: this.opAnnulationDif.date_decision_cf,
        diff_op: 0,
        id: this.opAnnulationDif.id,
      };
      this.ajouterHistoriqueDecisionOp(nouveauObjet);
      this.modifierGestionOrdrePaiement(nouveauObjet1);
      this.$("#validationOpDefinitifopAnnulationDif").modal("hide");
    },
    ...
    apercuFacture0(id) {
      this.$("#validationOpDefinitifopAnnulationDif").modal({
        backdrop: "static",
        keyboard: false,
      });
      this.opAnnulationDif = this.gettersgestionOrdrePaiement.find(
        (item) => item.id == id
      );
    },
 pagePrecedent(){
