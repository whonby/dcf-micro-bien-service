            ...
            <table class="table table-bordered table-striped">
              <div class="widget-box">
                ...
                <div class="widget-content tab-content">
                  ...
                  <AjouterOpProvisoire></AjouterOpProvisoire>
                  </div>
                  <div id="ANNULATION" class="tab-pane active" v-if="formData.type_ordre_paiement==3">
                  
                  <AjoutOrdrePaiementRegieAnnulation></AjoutOrdrePaiementRegieAnnulation>
                  </div>
                  <div id="DEFINITIF" class="tab-pane active" v-if="formData.type_ordre_paiement==4">
                
                  <AjoutOrdrePaiementRegieDefinitive></AjoutOrdrePaiementRegieDefinitive>
                  </div>
                   <div id="DIRECT" class="tab-pane active" v-if="formData.type_ordre_paiement==1">
                <AjoutOrdrePaiementRegie :macheid="marcheid"></AjoutOrdrePaiementRegie>
                  </div>
                </div>
...
import AjouterOpProvisoire from "./AjouterOpProvisoire"
import AjoutOrdrePaiementRegie from "./AjoutOrdrePaiementRegie"
import AjoutOrdrePaiementRegieAnnulation from "./AjoutOrdrePaiementRegieAnnulation"
import AjoutOrdrePaiementRegieDefinitive from "./AjoutOrdrePaiementRegieDefinitive"
...
export default {
  components: {
      AjouterOpProvisoire,
      AjoutOrdrePaiementRegie,
      AjoutOrdrePaiementRegieAnnulation,
      AjoutOrdrePaiementRegieDefinitive
   // ModelListSelect,
    //  facture
  },
  data() {
