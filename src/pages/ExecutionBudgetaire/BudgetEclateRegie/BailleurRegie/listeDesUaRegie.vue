          ...
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                            <tr class="odd gradeX" v-for="(type) in afficheListeDesUaRegie" :key="type.id">
      ...
      <table class="table table-bordered table-striped">
        <tr>
           <td colspan="">
                ...
                <div class="controls">
                  <select v-model="formData.diff_id" class="span9">
                      <option value="1">Ua Projet</option>                     
                     <option value="2">Ua Régie</option>
                    </select>
                </div>
              </div>
                  </td>
