...
<template>
  <div>
    <notifications/>
   <div id="validationOpDefinitifopAnnulationAttente" class="modal hide tailgrand">
      ...
      <div class="modal-body">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="opAnnulationAttente.decision_cf" class="span5">
                    <option value=""></option>
            ...
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="opAnnulationAttente.famille_motif" class="span5">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="opAnnulationAttente.motif" class="span5">
                    <option value="0"></option>
                    <option
                      v-for="varText in AffichierElementEnfant(
                        opAnnulationAttente.famille_motif
                      )"
                      :key="varText.id"
                      :value="varText.id"
                    >
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="opAnnulationAttente.autre_motif"
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input
                    type="date"
                    class="span5"
                    v-model="opAnnulationAttente.date_decision_cf"
                  />
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="opAnnulationAttente.observation"
                  >
                  </textarea>
                </div>
              </div>
                      ...
                      recupererNomDuControleurF(
                        recupererIdUser(
                          recupererIdServiceCF(
                            opAnnulationAttente.unite_administrative_id
                          )
                        )
                      )
                    "
        ...
        <table
          ...
          v-if="opAnnulationAttente.decision_cf == 2"
        >
          <div class="row-fluid">
            <div class="span6">
              <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                  <templete v-if="verifier(opAnnulationAttente.id) == opAnnulationAttente.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in listeOpdiffere(opAnnulationAttente.id)"
                          :key="type.id"
                        >
                  ...
                  <templete v-if="verifier(opAnnulationAttente.id) == opAnnulationAttente.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in EurreurCorrige(opAnnulationAttente.id)"
                          :key="type.id"
                        >
                          <td @dblclick="afficherModalModifierTypeTexte(index)">
                            {{
...
created() {
  ...
  computed: {
   ...
   listeOpdiffere() {
    ...
    griserAutreMotif() {
      return this.opAnnulationAttente.motif != 237;
    },
    ...
    listeordrepaiementProvisoire() {
      return this.gettersgestionOrdrePaiement.filter(
        (qtreel) => qtreel.diff_op == null  && qtreel.unite_administrative_id == this.marcheid && qtreel.type_ordre_paiement==3 && qtreel.decision_cf == 0
      );
    },
...
afficherModalModifierTitre(id) {
   ...
   DetacheMotif(id) {
    ...
    modifierTypeTexteLocal() {
      var nouveauObjet = {
        decision_cf: this.opAnnulationAttente.decision_cf,
        famille_motif: this.opAnnulationAttente.famille_motif,
        motif: this.opAnnulationAttente.motif,
        date_decision: this.opAnnulationAttente.date_decision_cf,
        diff_decision: 0,
        id_op: this.opAnnulationAttente.id,
      };
        var nouveauObjet1 = {
          ...this.opAnnulationAttente,
        decision_cf: this.opAnnulationAttente.decision_cf,
        famille_motif: this.opAnnulationAttente.famille_motif,
        motif: this.opAnnulationAttente.motif,
        date_decision_cf: this.opAnnulationAttente.date_decision_cf,
        // diff_op: 0,
        id: this.opAnnulationAttente.id,
      };
      this.ajouterHistoriqueDecisionOp(nouveauObjet);
      this.modifierGestionOrdrePaiement(nouveauObjet1);
      this.$("#validationOpDefinitifopAnnulationAttente").modal("hide");
    },
    ...
    apercuFacture0(id) {
      this.$("#validationOpDefinitifopAnnulationAttente").modal({
        backdrop: "static",
        keyboard: false,
      });
      this.opAnnulationAttente = this.gettersgestionOrdrePaiement.find(
        (item) => item.id == id
      );
    },
 pagePrecedent(){
