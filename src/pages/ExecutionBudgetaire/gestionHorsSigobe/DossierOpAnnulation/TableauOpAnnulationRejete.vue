...
<template>
  <div>
    <notifications/>
   <div id="validationOpDefinitifAnnulationRejet" class="modal hide tailgrand">
      ...
      <div class="modal-body">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="editMandatAnnulationRej.decision_cf" class="span5">
                    <option value=""></option>
            ...
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="editMandatAnnulationRej.famille_motif" class="span5">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="editMandatAnnulationRej.motif" class="span5">
                    <option value="0"></option>
                    <option
                      v-for="varText in AffichierElementEnfant(
                        editMandatAnnulationRej.famille_motif
                      )"
                      :key="varText.id"
                      :value="varText.id"
                    >
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="editMandatAnnulationRej.autre_motif"
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input
                    type="date"
                    class="span5"
                    v-model="editMandatAnnulationRej.date_decision_cf"
                  />
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="editMandatAnnulationRej.observation"
                  >
                  </textarea>
                </div>
              </div>
                      ...
                      recupererNomDuControleurF(
                        recupererIdUser(
                          recupererIdServiceCF(
                            editMandatAnnulationRej.unite_administrative_id
                          )
                        )
                      )
                    "
        ...
        <table
          ...
          v-if="editMandatAnnulationRej.decision_cf == 2"
        >
          <div class="row-fluid">
            <div class="span6">
              <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                  <templete v-if="verifier(editMandatAnnulationRej.id) == editMandatAnnulationRej.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in listeOpdiffere(editMandatAnnulationRej.id)"
                          :key="type.id"
                        >
                  ...
                  <templete v-if="verifier(editMandatAnnulationRej.id) == editMandatAnnulationRej.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in EurreurCorrige(editMandatAnnulationRej.id)"
                          :key="type.id"
                        >
                          <td @dblclick="afficherModalModifierTypeTexte(index)">
                            {{
...
created() {
  ...
  computed: {
   ...
   listeOpdiffere() {
    ...
    griserAutreMotif() {
      return this.editMandatAnnulationRej.motif != 237;
    },
    ...
    listeordrepaiementProvisoire() {
      return this.gettersgestionOrdrePaiement.filter(
        (qtreel) => qtreel.diff_op == null  && qtreel.unite_administrative_id == this.marcheid && qtreel.type_ordre_paiement==3 && qtreel.decision_cf == 3
      );
    },
...
afficherModalModifierTitre(id) {
   ...
   DetacheMotif(id) {
    ...
    modifierTypeTexteLocal() {
      var nouveauObjet = {
        decision_cf: this.editMandatAnnulationRej.decision_cf,
        famille_motif: this.editMandatAnnulationRej.famille_motif,
        motif: this.editMandatAnnulationRej.motif,
        date_decision: this.editMandatAnnulationRej.date_decision_cf,
        diff_decision: 0,
        id_op: this.editMandatAnnulationRej.id,
      };
        var nouveauObjet1 = {
          ...this.editMandatAnnulationRej,
        decision_cf: this.editMandatAnnulationRej.decision_cf,
        famille_motif: this.editMandatAnnulationRej.famille_motif,
        motif: this.editMandatAnnulationRej.motif,
        date_decision_cf: this.editMandatAnnulationRej.date_decision_cf,
        // diff_op: 0,
        id: this.editMandatAnnulationRej.id,
      };
      this.ajouterHistoriqueDecisionOp(nouveauObjet);
      this.modifierGestionOrdrePaiement(nouveauObjet1);
      this.$("#validationOpDefinitifAnnulationRejet").modal("hide");
    },
    ...
    apercuFacture0(id) {
      this.$("#validationOpDefinitifAnnulationRejet").modal({
        backdrop: "static",
        keyboard: false,
      });
      this.editMandatAnnulationRej = this.gettersgestionOrdrePaiement.find(
        (item) => item.id == id
      );
    },
 pagePrecedent(){
