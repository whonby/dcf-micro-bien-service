...
<template>
  <div>
    <notifications/>
   <div id="validationOpDefinitifDirectViseOb" class="modal hide tailgrand">
      ...
      <div class="modal-body">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="DirectViseOb.decision_cf" class="span5">
                    <option value=""></option>
            ...
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="DirectViseOb.famille_motif" class="span5">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="DirectViseOb.motif" class="span5">
                    <option value="0"></option>
                    <option
                      v-for="varText in AffichierElementEnfant(
                        DirectViseOb.famille_motif
                      )"
                      :key="varText.id"
                      :value="varText.id"
                    >
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="DirectViseOb.autre_motif"
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input
                    type="date"
                    class="span5"
                    v-model="DirectViseOb.date_decision_cf"
                  />
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="DirectViseOb.observation"
                  >
                  </textarea>
                </div>
              </div>
                      ...
                      recupererNomDuControleurF(
                        recupererIdUser(
                          recupererIdServiceCF(
                            DirectViseOb.unite_administrative_id
                          )
                        )
                      )
                    "
        ...
        <table
          ...
          v-if="DirectViseOb.decision_cf == 2"
        >
          <div class="row-fluid">
            <div class="span6">
              <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                  <templete v-if="verifier(DirectViseOb.id) == DirectViseOb.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in listeOpdiffere(DirectViseOb.id)"
                          :key="type.id"
                        >
                  ...
                  <templete v-if="verifier(DirectViseOb.id) == DirectViseOb.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in EurreurCorrige(DirectViseOb.id)"
                          :key="type.id"
                        >
                          <td @dblclick="afficherModalModifierTypeTexte(index)">
                            {{
...
created() {
  ...
  computed: {
   ...
   listeOpdiffere() {
    ...
    griserAutreMotif() {
      return this.DirectViseOb.motif != 237;
    },
    ...
    listeordrepaiementProvisoire() {
      return this.gettersgestionOrdrePaiement.filter(
        (qtreel) => qtreel.diff_op == null  && qtreel.unite_administrative_id == this.marcheid && qtreel.type_ordre_paiement==1 && qtreel.decision_cf == 9
      );
    },
...
afficherModalModifierTitre(id) {
   ...
   DetacheMotif(id) {
    ...
    modifierTypeTexteLocal() {
      var nouveauObjet = {
        decision_cf: this.DirectViseOb.decision_cf,
        famille_motif: this.DirectViseOb.famille_motif,
        motif: this.DirectViseOb.motif,
        date_decision: this.DirectViseOb.date_decision_cf,
        diff_decision: 0,
        id_op: this.DirectViseOb.id,
      };
        var nouveauObjet1 = {
          ...this.DirectViseOb,
        decision_cf: this.DirectViseOb.decision_cf,
        famille_motif: this.DirectViseOb.famille_motif,
        motif: this.DirectViseOb.motif,
        date_decision_cf: this.DirectViseOb.date_decision_cf,
        // diff_op: 0,
        id: this.DirectViseOb.id,
      };
      this.ajouterHistoriqueDecisionOp(nouveauObjet);
      this.modifierGestionOrdrePaiement(nouveauObjet1);
      this.$("#validationOpDefinitifDirectViseOb").modal("hide");
    },
    ...
    apercuFacture0(id) {
      this.$("#validationOpDefinitifDirectViseOb").modal({
        backdrop: "static",
        keyboard: false,
      });
      this.DirectViseOb = this.gettersgestionOrdrePaiement.find(
        (item) => item.id == id
      );
    },
 pagePrecedent(){
