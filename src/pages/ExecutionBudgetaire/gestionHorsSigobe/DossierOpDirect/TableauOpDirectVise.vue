...
<template>
  <div>
    <notifications/>
   <div id="validationOpDefinitifDirectVise" class="modal hide tailgrand">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="DirectVise.decision_cf" class="span5">
                    <option value=""></option>
            ...
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="DirectVise.famille_motif" class="span5">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="DirectVise.motif" class="span5">
                    <option value="0"></option>
                    <option
                      v-for="varText in AffichierElementEnfant(
                        DirectVise.famille_motif
                      )"
                      :key="varText.id"
                      :value="varText.id"
                    >
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="DirectVise.autre_motif"
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input
                    type="date"
                    class="span5"
                    v-model="DirectVise.date_decision_cf"
                  />
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="DirectVise.observation"
                  >
                  </textarea>
                </div>
              </div>
                      ...
                      recupererNomDuControleurF(
                        recupererIdUser(
                          recupererIdServiceCF(
                            DirectVise.unite_administrative_id
                          )
                        )
                      )
                    "
            ...
            <div class="span6">
              <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                  <templete v-if="verifier(DirectVise.id) == DirectVise.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in listeOpdiffere(DirectVise.id)"
                          :key="type.id"
                        >
                  ...
                  <templete v-if="verifier(DirectVise.id) == DirectVise.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in EurreurCorrige(DirectVise.id)"
                          :key="type.id"
                        >
                          <td @dblclick="afficherModalModifierTypeTexte(index)">
                            {{
...
created() {
  ...
  computed: {
   ...
   listeOpdiffere() {
    ...
    griserAutreMotif() {
      return this.DirectVise.motif != 237;
    },
    ...
    listeordrepaiementProvisoire() {
      return this.gettersgestionOrdrePaiement.filter(
        (qtreel) => qtreel.diff_op == null  && qtreel.unite_administrative_id == this.marcheid && qtreel.type_ordre_paiement == 1 && qtreel.decision_cf == 8
      );
    },
...
afficherModalModifierTitre(id) {
   ...
   DetacheMotif(id) {
    ...
    modifierTypeTexteLocal() {
      var nouveauObjet = {
        decision_cf: this.DirectVise.decision_cf,
        famille_motif: this.DirectVise.famille_motif,
        motif: this.DirectVise.motif,
        date_decision: this.DirectVise.date_decision_cf,
        diff_decision: 0,
        id_op: this.DirectVise.id,
      };
        var nouveauObjet1 = {
          ...this.DirectVise,
        decision_cf: this.DirectVise.decision_cf,
        famille_motif: this.DirectVise.famille_motif,
        motif: this.DirectVise.motif,
        date_decision_cf: this.DirectVise.date_decision_cf,
        // diff_op: 0,
        id: this.DirectVise.id,
      };
      this.ajouterHistoriqueDecisionOp(nouveauObjet);
      this.modifierGestionOrdrePaiement(nouveauObjet1);
      this.$("#validationOpDefinitifDirectVise").modal("hide");
    },
    ...
    apercuFacture0(id) {
      this.$("#validationOpDefinitifDirectVise").modal({
        backdrop: "static",
        keyboard: false,
      });
      this.DirectVise = this.gettersgestionOrdrePaiement.find(
        (item) => item.id == id
      );
    },
 pagePrecedent(){
