...
<template>
  <div>
    <notifications/>
   <div id="validationOpDefinitif127" class="modal hide tailgrand">
      ...
      <div class="modal-body">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="editMandat01.decision_cf" class="span5">
                    <option value=""></option>
            ...
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="editMandat01.famille_motif" class="span5">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="editMandat01.motif" class="span5">
                    <option value="0"></option>
                    <option
                      v-for="varText in AffichierElementEnfant(
                        editMandat01.famille_motif
                      )"
                      :key="varText.id"
                      :value="varText.id"
                    >
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="editMandat01.autre_motif"
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input
                    type="date"
                    class="span5"
                    v-model="editMandat01.date_decision_cf"
                  />
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <textarea
                    class="span5"
                    row="6"
                    v-model="editMandat01.observation"
                  >
                  </textarea>
                </div>
              </div>
                      ...
                      recupererNomDuControleurF(
                        recupererIdUser(
                          recupererIdServiceCF(
                            editMandat01.unite_administrative_id
                          )
                        )
                      )
                    "
        ...
        <table
          ...
          v-if="editMandat01.decision_cf == 2"
        >
          <div class="row-fluid">
            <div class="span6">
              <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                  <templete v-if="verifier(editMandat01.id) == editMandat01.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in listeOpdiffere(editMandat01.id)"
                          :key="type.id"
                        >
                  ...
                  <templete v-if="verifier(editMandat01.id) == editMandat01.id">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr
                          class="odd gradeX"
                          v-for="type in EurreurCorrige(editMandat01.id)"
                          :key="type.id"
                        >
                          <td @dblclick="afficherModalModifierTypeTexte(index)">
                            {{
...
listeOpdiffere() {
    ...
    griserAutreMotif() {
      return this.editMandat01.motif != 237;
    },
    ...
    listeordrepaiementProvisoire() {
      return this.gettersgestionOrdrePaiement.filter(
        (qtreel) => qtreel.diff_op == null  && qtreel.unite_administrative_id == this.marcheid && qtreel.type_ordre_paiement==4 && qtreel.decision_cf == 3
      );
    },
...
afficherModalModifierTitre(id) {
   ...
   DetacheMotif(id) {
    ...
    modifierTypeTexteLocal() {
      var nouveauObjet = {
        decision_cf: this.editMandat01.decision_cf,
        famille_motif: this.editMandat01.famille_motif,
        motif: this.editMandat01.motif,
        date_decision: this.editMandat01.date_decision_cf,
        diff_decision: 0,
        id_op: this.editMandat01.id,
      };
        var nouveauObjet1 = {
          ...this.editMandat01,
        decision_cf: this.editMandat01.decision_cf,
        famille_motif: this.editMandat01.famille_motif,
        motif: this.editMandat01.motif,
        date_decision_cf: this.editMandat01.date_decision_cf,
        // diff_op: 0,
        id: this.editMandat01.id,
      };
      this.ajouterHistoriqueDecisionOp(nouveauObjet);
      this.modifierGestionOrdrePaiement(nouveauObjet1);
      this.$("#validationOpDefinitif127").modal("hide");
    },
    ...
    apercuFacture0(id) {
      this.$("#validationOpDefinitif127").modal({
        backdrop: "static",
        keyboard: false,
      });
      this.editMandat01 = this.gettersgestionOrdrePaiement.find(
        (item) => item.id == id
      );
    },
 pagePrecedent(){
