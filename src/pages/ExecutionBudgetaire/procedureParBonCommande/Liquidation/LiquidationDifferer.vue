...
<template>
   <div>
<div id="DossierLiquidationDifferer" class="modal hide tailgrand">
      ...
      <div class="modal-footer">
        ...
        <a data-dismiss="modal" class="btn" href="#">Fermer</a>
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr class="odd gradeX" v-for="(type) in listeDossierLiquidationDifferer(macheid)" :key="type.id">
...
ListePieceJustificative() {
   ...
   listeDossierLiquidationDifferer() {
      return id => {
        if (id != null && id != "") {
           return this.gettersDossierLiquidation.filter(qtreel => qtreel.dmd_engagement_id == id && this.typeProcedure(qtreel.dmd_engagement_id) == "Engagement par Bon de Commande" && qtreel.decision_cf==2);
...
this.$("#DossierLiquidation").modal('hide');
    ...
    afficheDecisionCf(id) {
      this.$("#DossierLiquidationDifferer").modal({
        backdrop: "static",
        keyboard: false
      });

       this.editDossierLiquidation = this.listeDossierLiquidationDifferer(this.macheid).find(item=>item.id==id);
    },
  }
};
</script>
