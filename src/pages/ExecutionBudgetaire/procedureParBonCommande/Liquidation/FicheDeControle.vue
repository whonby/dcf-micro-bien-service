    ...
    <div style="border: 2px double #000;text-align:center;font-size:25px;width:100%;height:80px;">
     <br>
      ...
      <tr>
          ...
          <td style="font-size:25px"> {{exercice(detailOp.dmd_engagement_id)}} </td>
     ...
     <br/>
          ...
          <tr>
                     <th style="width:25%;font-size:20px ;font-weight: bold;">PROJET OU ORGANISME :</th><td style="font-size:25px">{{infoLibelleUa(ua(detailOp.dmd_engagement_id))}}  </td>
                 ...
                 <br/>
                  ...
                  <tr>
                    <!-- <th rowspan="5" style="margin:0 auto">IMPUTATION BUDGETAIRE</th> -->
                     <th style="width:25%;font-size:20px;font-weight: bold; ">OBJET DE LA DEPENSE :</th>  <td style="font-size:25px"> {{objetDepense(detailOp.dmd_engagement_id)}} </td>
