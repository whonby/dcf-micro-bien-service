...
<template>
   <div>
<div id="DossierLiquidationRejetter" class="modal hide tailgrand">
      ...
      <div class="modal-footer">
        ...
        <a data-dismiss="modal" class="btn" href="#">Fermer</a>
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr class="odd gradeX" v-for="(type) in listeDossierLiquidationRejetter(macheid)" :key="type.id">
...
ListePieceJustificative() {
   ...
   listeDossierLiquidationRejetter() {
      return id => {
        if (id != null && id != "") {
           return this.gettersDossierLiquidation.filter(qtreel => this.ua(qtreel.dmd_engagement_id) == id && this.typeProcedure(qtreel.dmd_engagement_id) == "Engagement par Bien de Commande" && qtreel.decision_cf==3);
...
this.$("#DossierLiquidation").modal('hide');
    ...
    afficheDecisionCf(id) {
      this.$("#DossierLiquidationRejetter").modal({
        backdrop: "static",
        keyboard: false
      });

       this.editDossierLiquidation = this.listeDossierLiquidationRejetter(this.macheid).find(item=>item.id==id);
    },
  }
};
</script>
