...
<br/>
 ...
 <br/>
      ...
      <tr>
        <th style="width:25%;font-weight: bold; ">EXERCICE BUDGETAIRE :</th>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <td style="font-size:14px"> {{exercice(detailOp.dmd_engagement_id)}} </td>
    ...
    <br/>
          ...
          <tr>
                     ...
                     <td style="font-size:14px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{infoLibelleUa(ua(detailOp.dmd_engagement_id))}} </td>
    ...
    <br/>
                  ...
                  <tr>
                    <!-- <th rowspan="5" style="margin:0 auto">IMPUTATION BUDGETAIRE</th> -->
                     <th style="width:25% ;font-weight: bold;">OBJET DE LA DEPENSE :</th> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<td style="text-align:center;font-size:25px"> {{objetDepense(detailOp.dmd_engagement_id)}} </td> 
   ...
   <tr>
                     ...
                     <td style="font-size:14px"> {{fournisseur(detailOp.dmd_engagement_id)}} </td>
                 </tr>
                 <br/>
      <br/>
    <br/>
                 ...
                 <tr>
                     ...
                     <td style="font-size:14px"> {{fournisseurAdresse(detailOp.dmd_engagement_id)}} </td>
                 </tr>
                  <br/>
      <br/>
    <br/>
    ...
    <br/>
                 ...
                 <tr>
                     ...
                     <td style="font-size:14px"> {{imputationBudgetaire(ligne(detailOp.dmd_engagement_id))}} </td>
                 </tr>
                 <br/>
      <br/>
    <br/>
    ...
    <br/>
                 ...
                 <tr>
                     ...
                     <td style="font-size:14px"> {{formatageSomme(parseFloat(MontantLiquide(detailOp.dmd_engagement_id)))}} </td>
                 </tr>
                 <br/>
      <br/>
    <br/>
...
<br/>
Date : {{formaterDate(detailOp.date_motif)}}  <br/>
<br/>
Nom et Prénoms:  <br/>
<br/>
Signature et Cachet  
...
AfficheLogODCF() {
  ...
  afficherNomEntreprise() {
   ...
   this.detailOp = this.gettersDossierLiquidation.find(
