...
<template>
   <div>
<div id="DossierLiquidationVise" class="modal hide tailgrand">
      ...
      <div class="modal-footer">
        ...
        <a data-dismiss="modal" class="btn" href="#">Fermer</a>
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr class="odd gradeX" v-for="(type) in listeDossierLiquidationVise(macheid)" :key="type.id">
                ...
                class="btn btn-Success " title="">
                  <span class=""><i class="  icon-eye-open" style="font-weight: bold;"> Voir Détail</i></span>
                    ...
                    <td>
                      <router-link :to="{ name: 'FicheRealiteServiceFait', params: { id: type.id }}"
                class="btn btn-Success " title="">
...
ListePieceJustificative() {
   ...
   listeDossierLiquidationVise() {
      return id => {
        if (id != null && id != "") {
           return this.gettersDossierLiquidation.filter(qtreel => this.ua(qtreel.dmd_engagement_id) == id && this.typeProcedure(qtreel.dmd_engagement_id) == "Engagement par Bien de Commande" && qtreel.decision_cf==8);
...
this.$("#DossierLiquidation").modal('hide');
    ...
    afficheDecisionCf(id) {
      this.$("#DossierLiquidationVise").modal({
        backdrop: "static",
        keyboard: false
      });

       this.editDossierLiquidation = this.listeDossierLiquidationVise(this.macheid).find(item=>item.id==id);
    },
  }
};
</script>
