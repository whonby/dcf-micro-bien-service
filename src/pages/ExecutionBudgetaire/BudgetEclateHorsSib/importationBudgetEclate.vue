...
<template>
  <div>
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr
                v-for="passation in getBudgetEclateImporter"
                :key="passation.id"
              >
                ...
                <td>
                  <router-link
                    :to="{ name: 'DetailPPM', params: { id: passation.code } }"
                    class="btn btn-default"
                    title="Detail marches"
                  >
                    <span class=""
                      ><i class="icon-folder-open"></i> Voir PPM</span
                    >
                  </router-link>
                </td>
              </tr>
    ...
    <div id="exampleModal" class="modal hide taillemodal">
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <label for="">Unité Administrative</label>
                <model-list-select
            ...
            <tr>
              <td>
                  <label for="">Exercice Budgétaire</label>
      ...
      <div class="modal-footer">
        <a @click.prevent="ajouterFichier" class="btn btn-primary" href="#"  v-if="tableData.length"
          >Importer</a
        >
        <a data-dismiss="modal" class="btn" href="#">Fermer</a>
      </div>
    ...
    <fab
      :actions="fabActions"
      @cache="afficherModalAjouterStock"
      main-icon="apps"
      bg-color="green"
    ></fab>
...
ExporterEnExel(){
  ...
  methods: {
    ...
    ...mapActions("bienService", [
      "ajoutergetBudgetEclateImporter",
      "getPlanPassationMarche",
      "getMarche",
    ]),
    ...
    ajouterFichier() {
    //   let unite = this.uniteAdministratives.find(
    //     (item) => item.id == this.unite_administrative_id
    //   );
  let formData = {
        exercicebudget_id:this.anneeAmort,
        dataExcel: this.tableData,
        unite_administrative_id:this.unite_administrative_id
      };
