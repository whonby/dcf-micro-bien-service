...
<template>
   <div>
<div id="DossierMandatRejet" class="modal hide tailgrand">
...
ListePieceJustificative() {
   ...
   listeDossierMandat() {
      return id => {
        if (id != null && id != "") {
           return this.gettersDossierMandat.filter(qtreel => qtreel.demande_engagement_id == id && this.typeProcedure(qtreel.demande_engagement_id) == "Engagement direct" && qtreel.decision_cf==3);
...
this.$("#DossierMandatRejet").modal('hide');
