                                ...
                                <tr class="odd gradeX" v-for="item in titreFiltres" :key="item.id">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <button @click.prevent="supprimerServiceCF(item.id)"  class="btn btn-danger ">
...
// methode pour maper notre guetter
            ...mapGetters("Utilisateurs", ["getterServiceCF"]),
            ...mapGetters('gestionMarche', ['type_marches']),
            titreFiltres() {

                const searchTerm = this.search.toLowerCase();

                return this.getterServiceCF.filter((item) => {
        ...
        methods: {
            ...
            ...mapActions('gestionMarche', ['getTypeMarche',"ajouterTypeMarche","supprimerTypeMarche","modifierTypeMarche"]),
            ...mapActions('Utilisateurs', ['ajouterServiceCF',"supprimerServiceCF","modifierServiceCF"]),
            ...
            ajouterTitreLocal () {
                this.ajouterServiceCF(this.formData)
                this.formData = {
                    code: "",
                    libelle: ""
                }
...
// afficher modal
            afficherModalModifierTitre(index){
                ...
                this.editTitre = this.getterServiceCF.find(item=>item.id==index);

            },
            modifier(){
                this.modifierServiceCF(this.editTitre)
                //this.getFonctions()
            }
        }
    };
