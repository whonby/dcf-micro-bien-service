...
<template>
                  ...
                  <tr class="odd gradeX" v-if="article" @dblclick="$emit('modification', article)">
                   <td>{{article.libelle || 'Non renseigné'}}</td>
                    ...
                    <td>{{article.longitude|| 'Non renseigné'}}</td>
                    <td>{{article.latitude || 'Non renseigné'}}</td>
                    <td>{{article.telephone_cel || 'Non renseigné'}}</td>
                   
                      <td>{{article.adresse_postale || 'Non renseigné'}}</td>
                    <td>{{article.telephone_fixe || 'Non renseigné'}}</td>
                   <td>{{article.description_localisation || 'Non renseigné'}}</td>
                     <td>{{article.quartier || 'Non renseigné'}}</td>
