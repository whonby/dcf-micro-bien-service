        ...
        <div class="span12">
          ...
          <div class="widget-box">
            ...
            <div class="widget-content nopadding" v-if="uniteAdministratives.length" >
              <grpeBudgetProgrammeItemComponent v-for="equipement in uniteAdministratives"
               :key="equipement.id"
                :groupe="equipement"
              
                >
              </grpeBudgetProgrammeItemComponent>
...
import grpeBudgetProgrammeItemComponent from './grpeBudgetProgrammeItemComponent'
