...
<div>
<div id="validationOpProvisoire" class="modal hide tailgrand">
      ...
      <div class="modal-footer">
        ...
        <td >{{Manda.numero_op_provisoire || 'Non renseigné'}}</td>
                    ...
                    <td >{{afficheNumeroFacture(Manda.facture_id) || 'Non renseigné'}}</td>
                     <td >{{formaterDate(afficheDateFacture(Manda.facture_id)) || 'Non renseigné'}}</td> 
...
...mapActions("horSib", ['ajouterRealiteServiceHors','modifierOpProvisoire','supprimerRealiteServiceHors']),
   ...mapActions("bienService", [
      ...
      this.$("#validationOpProvisoire").modal({
        backdrop: "static",
        keyboard: false
      });
...
this.$("#validationOpProvisoire").modal('hide');
