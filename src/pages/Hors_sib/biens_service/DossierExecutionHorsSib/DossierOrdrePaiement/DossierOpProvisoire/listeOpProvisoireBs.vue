...
<div>
         ...
         <div id="DecisionServiceBeneficiaireOpProvisoire" class="modal hide">
                     ...
                     <table class="table table-bordered table-striped" v-if="macheid">
                                ...
                                <th>Action</th>
                                    ...
                                    <tbody>
                                     <tr
                    class="odd gradeX"
                    v-for="realiteService in afficheOpProvisoireBs(macheid)"
                    :key="realiteService.id"
                  >
        <td >{{realiteService.exercice_budget || 'Non renseigné'}}</td>
         <td >{{realiteService.numero_op_provisoire || 'Non renseigné'}}</td>
                    ...
                    <td>
                      ...
                      <button  class="btn btn-danger" @click="supprimerOpProvisoire(realiteService.id)">
                        <span>
...
return 1
  ...
  return 2
      ...
      methods:{ 
 ...mapActions("horSib", ['supprimerOpProvisoire','modifierOpProvisoire']),
...
afficherModalObservationServiceBeneficiaire(id) {
      this.$("#DecisionServiceBeneficiaireOpProvisoire").modal({
        backdrop: "static",
        keyboard: false
      });

       this.editOpDefinitif = this.afficheOpProvisoireBs(this.macheid).find(item=>item.id==id);
    },
...
this.$("#DecisionServiceBeneficiaireOpProvisoire").modal('hide');
