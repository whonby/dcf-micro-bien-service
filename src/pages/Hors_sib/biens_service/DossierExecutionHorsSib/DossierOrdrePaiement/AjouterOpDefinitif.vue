...
ajouterMandatFactureDefinitive(){
   ...
   budget_general_id :this.afficherInputationBudgetaire(this.afficherIdParent(this.detail_ServiceRealite.marche_id)),
         marche_id : this.detail_ServiceRealite.marche_id,
         montant_a_paye: this.restePayeMarche,
        //  montant_cumul:this.montantCumuler,
       ligne_id:this.afficherIdLigneBudgetaire(this.afficherIdParent(this.detail_ServiceRealite.marche_id)),
