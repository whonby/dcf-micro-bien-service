...
<div id="decisionServiceRealiteopProvisoire" class="modal hide tailgrand">
            ...
            <td>
             ...
             <td>
                    <div class="control-group">
                            ...
                            <div class="controls">
                               <select v-model="editServiceRealite.motifcf" class="span" :readOnLy="verouillerMotif">
                                 <option value=""></option>
               ...
               <tr>
                 <td>
                    <div class="control-group">
                            ...
                            <div class="controls">
                               <select v-model="editServiceRealite.motif_controleur" class="span" :readOnLy="verouillerMotif">
                                 <option value=""></option>
                   ...
                   <tr>
                     <td colspan="">
                        <div class="control-group">
                            ...
                            <div class="controls">
                              <textarea  class="span" row = "6" v-model="editServiceRealite.observation_controleur_financier" :readOnLy="verouillerMotif">
                              </textarea>
                            </div>
                          </div>
                       </td>
      ...
      <div class="modal-footer">
        ...
        <a data-dismiss="modal" class="btn" href="#">Fermer</a>
                  ...
                  >
        <td @dblclick="afficherModifierServiceRealite(realiteService.id)">{{realiteService.exercice_budget || 'Non renseigné'}}</td>
                    ...
                    <!-- <td >{{detail_marche.imputation  || 'Non renseigné'}}</td> -->
                     ...
                     <td @dblclick="afficherModifierServiceRealite(realiteService.id)">{{(formaterDate(realiteService.date_service_beneficiaire)) || 'Non renseigné'}}</td>
                      <td @dblclick="afficherModifierServiceRealite(realiteService.id)">{{(formaterDate(realiteService.date_controleur_financier)) || 'Non renseigné'}}</td>
                    <td v-if="realiteService.decision_service_beneficiaire == 1">
                      ...
                      <button v-else-if="realiteService.decision_controleur_financier == 9" class="btn  btn-success" @click="afficherModalObservationControlleurFinancier(realiteService.id)" >                        
...
verouillerMotif(){
  return this.editServiceRealite.decision_controleur_financier != 9
},
