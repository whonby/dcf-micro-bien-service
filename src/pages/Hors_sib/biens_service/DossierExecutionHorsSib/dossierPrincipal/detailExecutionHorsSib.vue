          ...
          <div class="widget-box">
            <div class="widget-content">
              <div class="widget-content nopadding">
                ...
                >
                  Lot{{ NumeroDuLot(detail_marche.id) }} :
                  {{ detail_marche.objet }}
                </h4>
                <table
                ...
                >
                  ...
                  <tbody>
                    <tr>
                      ...
                      >
                        {{ afficheNumeroMarche(detail_marche.id) }}
                      </td>
                      ...
                      >
                        {{
                          LibelleActivite(detail_marche.activite_id) ||
                          "Non renseigné"
                        }}
                      </td>
                      <td
                        ...
                        {{
                          afficherInputationBudgetaire(
                            afficherIdLigneBudgetaire(
                              afficherIdParent(detail_marche.id)
                            )
                          ) || "Non renseigné"
                        }}
                      </td>
                      ...
                      >
                        {{
                          formatageSomme(
                            parseFloat(
                              afficheMontantReelMarche(detail_marche.id)
                            )
                          )
                        }}
                      </td>
                          ...
                          <div class="widget-box">
                            <div class="widget-title">
                              <ul class="nav nav-tabs">
                                ...
                                <li>
                                  <a data-toggle="tab" href="#tab45785"
                                    >Décompte</a
                                  >
                                </li>
                            ...
                            <div class="widget-content tab-content">
                              ...
                              <div id="tab100" class="tab-pane">
                                <facture :macheid="detail_marche.id"></facture>
                              </div>
                              <div id="tab45785" class="tab-pane">
                                <decompte
                                  :macheid="detail_marche.id"
                                ></decompte>
                              </div>
                              <div id="HistoriqueDecompte" class="tab-pane">
...
export default {
  ...
  computed: {
    ...
    afficherTypeFacture() {
      return (id) => {
        if (id != null && id != "") {
          const qtereel = this.getFacturePersonnaliser.find(
            (qtreel) => qtreel.id == id
          );
    ...
    affichierMontantAvenantTTCModifier() {
      const val =
        parseFloat(this.affichierMontantTVA) +
        parseFloat(this.editAvenant.montant_ht);
    ...
    affichierMontantTVAModifier() {
      const val =
        parseFloat(this.editAvenant.montant_ht) * parseFloat(this.tauxArrondit);
    ...
    affichierMontantAvenantTTC() {
      const val =
        parseFloat(this.affichierMontantTVA) +
        parseFloat(this.formData.montant_ht);
    ...
    affichierMontantTVA() {
      const val =
        parseFloat(this.formData.montant_ht) * parseFloat(this.tauxArrondit);
      ...
      return (id) => {
        if (id != "") {
          return this.getMandatPersonnaliserVise
            .filter((element) => element.marche_id == id)
            .reduce(
              (prec, cur) => parseFloat(prec) + parseFloat(cur.montant_tresor),
              0
            )
            .toFixed(0);
        }
      ...
      return (id) => {
        if (id != "") {
          return this.getMandatPersonnaliserVise
            .filter((element) => element.marche_id == id)
            .reduce(
              (prec, cur) => parseFloat(prec) + parseFloat(cur.montant_don),
              0
            )
            .toFixed(0);
        }
      ...
      return (id) => {
        if (id != "") {
          return this.getMandatPersonnaliserVise
            .filter((element) => element.marche_id == id)
            .reduce(
              (prec, cur) => parseFloat(prec) + parseFloat(cur.montant_emprunt),
              0
            )
            .toFixed(0);
        }
    ...
    montantTotalDonEtEmprunt() {
      const val =
        parseFloat(this.partEmpruntBailleur(this.detail_marche.id)) +
        parseFloat(this.partDonBailleur(this.detail_marche.id));
    ...
    afficheidFour() {
      return (id) => {
        if (id != null && id != "") {
          const qtereel = this.engagements.find(
            (qtreel) => qtreel.marche_id == id
          );
    ...
    validationRealiteServiceFait() {
      return (id) => {
        if (id != null && id != "") {
          const qtereel = this.realiteServiceFait.find(
            (qtreel) => qtreel.marche_id == id
          );
    ...
    afficheNumeroMarche() {
      return (id) => {
        if (id != null && id != "") {
          const qtereel = this.getterActeEffetFinanciers.find(
            (qtreel) => qtreel.marche_id == id
          );
    ...
    afficheModePassation() {
      return (id) => {
        if (id != null && id != "") {
          const qtereel = this.procedurePassations.find(
            (qtreel) => qtreel.id == id
          );
      ...
      return (id) => {
        if (id != null && id != "") {
          const qtereel = this.marches.find(
            (qtreel) => qtreel.imputation == this.detail_marche.imputation
          );
    ...
    afficheActionLibelle() {
      return (id) => {
        if (id != null && id != "") {
          const qtereel = this.afficheNiveauAction.find(
            (qtreel) => qtreel.id == id
          );
      ...
      return (id) => {
        if (id != "") {
          return this.comptes.filter(
            (normeEquipe) => normeEquipe.entrepse_id == id
          );
        }
      };
    },
      ...
      return (id) => {
        if (id != "") {
          ...
          return this.avenants
            .filter(
              (normeEquipe) => normeEquipe.marche_id == this.detail_marche.id
            )
    ...
    montantFactureParMarche: function () {
      return (id) => {
        if (id != "") {
          let valInite = 0;
          return this.getFacturePersonnaliser
            .filter(
              (normeEquipe) => normeEquipe.marche_id == this.detail_marche.id
            )
            .reduce(function (total, currentVal) {
    ...
    tauxFacturation() {
      const val =
        (parseFloat(this.montantCredite(this.detail_marche.id)) /
          parseFloat(this.montantMarcheAvecAvenant)) *
        100;
    ...
    affichierNombreAvenant() {
      return (id) => {
        if (id != "") {
          return this.avenants.filter((element) => element.marche_id == id)
            .length;
        }
      };
    },
    ...
    montantMarcheAvecAvenant() {
      const val =
        parseFloat(this.afficheMontantReelMarche(this.detail_marche.id)) +
        parseFloat(this.affichierMontantAvenant(this.detail_marche.id));
      return parseFloat(val).toFixed(0);
    },
    ...
    afficheTypeActeFinancier() {
      return (id) => {
        if (id != null && id != "") {
          const qtereel = this.typeActeEffetFinanciers.find(
            (qtreel) => qtreel.id == id
          );
    ...
    afficherObjetEngagement1() {
      const norme = this.getFacturePersonnaliser.find(
        (normeEquipe) => normeEquipe.id == this.editEngagement.facture_id
      );
    ...
    afficherObjetMandat() {
      const norme = this.getFacturePersonnaliser.find(
        (normeEquipe) => normeEquipe.id == this.editMandat.facture_id
      );
    ...
    afficherObjetFacture() {
      const norme = this.getFacturePersonnaliser.find(
        (normeEquipe) => normeEquipe.id == this.formDataFacture.id
      );
    ...
    dotationDisponibleAnterieureDirect() {
      const val =
        parseFloat(
          this.dotationInite(this.detail_marche.imputation).Dotation_Initiale
        ) - parseFloat(this.sommeEgagementLigne(this.detail_marche.imputation));
    ...
    dotationDisponibleAnterieure() {
      const val =
        parseFloat(
          this.dotationInite(this.detail_marche.imputation).Dotation_Initiale
        ) - parseFloat(this.montantCumulerLiquidationMandat);
    ...
    montantCumulerMandatEngagement() {
      const val =
        parseFloat(this.sommeEgagementLigne(this.detail_marche.id)) +
        parseFloat(this.sommeMontantEngagement);
    ...
    montantCumulerEngagementMandat() {
      const val =
        parseFloat(this.sommeEgagementLigne(this.detail_marche.id)) +
        parseFloat(this.editEngagement.total_general);
    ...
    montantCumulerLiquidationMandat() {
      const val =
        parseFloat(this.sommeEgagementLigne(this.detail_marche.id)) +
        parseFloat(
          this.afficheMontantFaacture(
            this.afficheIdFacture(this.editLiquidation.marche_id)
          )
        );
    ...
    montantCumulerLiquidationMandatModifer() {
      const val =
        ...
        parseFloat(
          this.afficheMontantFaacture(
            this.afficheIdFacture(this.editMandat.marche_id)
          )
        );
    ...
    montantMarcheDisponible() {
      const val =
        parseFloat(this.montantMarcheAvecAvenant) -
        parseFloat(this.montantCumulerMandat);
    ...
    afficherObjectFacture() {
      const norme = this.getFacturePersonnaliser.find(
        (normeEquipe) => normeEquipe.numero_facture == this.afficherNumeroFcture
      );
    ...
    afficherSecti() {
      const norme = this.getPersonnaliseBudgetGeneralParBienService.find(
        (normeEquipe) =>
          normeEquipe.ua_id == this.detail_marche.unite_administrative_id
      );

      if (norme) {
        return norme.afficheSection.code_section.concat(
          "  ",
          norme.afficheSection.nom_section
        );
      }
      return "";
    },
    ...
    montantTvaModifier() {
      const val =
        parseFloat(this.montantHTModifier) * parseFloat(this.tauxArrondit);
    ...
    montantHTtModifier() {
      const val =
        parseFloat(this.montantHTModifier) +
    ...
    dateReceptionModifier() {
      const norme = this.getEngagementPersonnaliser1.find(
        (normeEquipe) => normeEquipe.id == this.editMandat.num_engagement
      );
    ...
    AfficherSectionModifier() {
      ...
      if (norme) {
        return (
          norme.afficheSection.code_section + norme.afficheSection.nom_section
        );
      }
      return "";
    },
    ...
    dateReception() {
      const norme = this.getEngagementPersonnaliser1.find(
        (normeEquipe) => normeEquipe.id == this.formData.num_engagement
      );
    ...
    montantDisponibleAutreligne() {
      const val =
        parseFloat(this.sommeMontantAutreLigne) +
        parseFloat(this.afficheRecupere);
      return parseFloat(val).toFixed(0);
    },
    ...
    montantDisponible() {
      const val =
        parseFloat(this.montantCumulerModifier) +
        parseFloat(this.afficheRecupere);
      return parseFloat(val).toFixed(0);
    },
    montantCumuler() {
    ...
    montantResteApaye() {
      const val =
        parseFloat(this.MontantMarche) - parseFloat(this.sommeMontant);
      return parseFloat(val).toFixed(2);
    },
    montantResteApayeModifier() {
      const val =
        parseFloat(this.MontantMarche) - parseFloat(this.montantDisponible);
      return parseFloat(val).toFixed(2);
    },
    sommeMontantEngagement() {
      const val =
        parseFloat(this.editEngagement.montant_tresor) +
        parseFloat(this.editEngagement.montant_don) +
        parseFloat(this.editEngagement.montant_emprunt);
      return parseFloat(val).toFixed(2);
    },
    sommeMontantMandat() {
      const val =
        parseFloat(this.editMandat.montant_tresor) +
        parseFloat(this.editMandat.montant_don) +
        parseFloat(this.editMandat.montant_emprunt);
      return parseFloat(val).toFixed(2);
    },
    sommeMontant() {
      const val =
    ...
    sommeMontantModifier() {
      const val =
        parseFloat(this.affichetresor) +
        parseFloat(this.afficheDon) +
        parseFloat(this.afficheEmprunt);
      return parseFloat(val).toFixed(2);
    },
    sommeMontantAutreLigne() {
      const val =
        parseFloat(this.affichetresor2) +
        parseFloat(this.afficheDon2) +
        parseFloat(this.afficheEmprunt2);
      return parseFloat(val).toFixed(2);
    },
    programmeDynamiques() {
      return (id) => {
    ...
    afficherSect() {
      return (id) => {
        if (id != null && id != "") {
          const qtereel = this.getPersonnaliseBudgetGeneralParBienService.find(
            (qtreel) =>
              qtreel.ua_id == this.detail_marche.unite_administrative_id
          );
    ...
    afficherAct() {
      return (id) => {
        if (id != null && id != "") {
          const qtereel = this.getPersonnaliseBudgetGeneralParBienService.find(
            (qtreel) => qtreel.activite_id == this.detail_marche.activite_id
          );
    ...
    NumeroFournisseur() {
      const norme = this.getActeEffetFinancierPersonnaliser.find(
        (normeEquipe) => normeEquipe.marche_id == this.detail_marche.id
      );
    ...
    AfficherFournisseur_id() {
      const norme = this.acteEffetFinanciers.find(
        (normeEquipe) => normeEquipe.marche_id == this.detail_marche.id
      );
    ...
    afficherligneEconomiqueBudgetaire() {
      const norme = this.marches.find(
        (normeEquipe) => normeEquipe.id == this.detail_marche.id
      );
    ...
    afficheligneEconomiqueBudgetaire() {
      return (id) => {
        if (id != null && id != "") {
          const qtereel = this.derniereNivoPlanBudgetaire.find(
            (qtreel) => qtreel.id == id
          );
    ...
    sommeEngagement() {
      return (id) => {
        if (id != "") {
          return this.mandats
            .filter((element) => element.marche_id == this.detail_marche.id)
            .reduce(
    ...
    restePayeMarche() {
      const val =
        parseFloat(this.montantMarcheAvecAvenant) -
        parseFloat(this.sommeEngagementTableau(this.detail_marche.id));
      return parseFloat(val).toFixed(0);
    },
    restePayeMarcheMandat() {
      const val =
    ...
    MontantBudgetaire() {
      const norme = this.getPersonnaliseBudgetGeneralParBienService.find(
        (normeEquipe) =>
          normeEquipe.economique_id == this.formData.ligne_budgetaire_id
      );
    ...
    idBudgetaire() {
      const norme = this.getPersonnaliseBudgetGeneralParBienService.find(
        (normeEquipe) =>
          normeEquipe.economique_id == this.detail_marche.economique_id
      );
    ...
    dotationInite: function () {
      return (imputation) => {
        if (imputation != "") {
          return this.getPersonnaliseBudgetGeneralParBienService.find(
            (normeEquipe) => normeEquipe.codebudget == imputation
          );
        }
      };
    },
    ...
    montantDisponibleBudgetMandatEngagement() {
      const val =
        parseFloat(this.dotationDisponibleAnterieure) -
        parseFloat(this.sommeMontantEngagement);
    ...
    montantDisponibleBudgetMandatDirect() {
      const val =
        parseFloat(this.dotationDisponibleAnterieureDirect) -
        parseFloat(this.sommeMontantMandat);
    ...
    recupererTypeProcedure() {
      const norme = this.choixprocedure.find(
        (normeEquipe) => normeEquipe.marche_id == this.detail_marche.id
      );
    ...
    recupererUniteAdministrative() {
      const norme = this.getPersonnaliseBudgetGeneralParBienService.find(
        (normeEquipe) =>
          normeEquipe.ua_id == this.detail_marche.objetUniteAdministrative.id
      );
