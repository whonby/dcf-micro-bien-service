         ...
         <div >
           ...
           <table class="table table-bordered table-striped" id="app1" >
                 ...
                 <thead style="border:5px">
                   ...
                   <tr >
                      <td colspan="4">
                        <div align="center"> <h4>ORDRE DE PAIEMENT PROVISOIRE</h4> </div>
                      </td>
                   </tr>
                 <tr>
                     <th style="width:16% ">EXERCICE</th>
                     <td> {{detailOpProvisoire.exercice_budget}} </td>
                 ...
                 <tr>
                    <!-- <th rowspan="5" style="margin:0 auto">IMPUTATION BUDGETAIRE</th> -->
                     ...
                     <td colspan="3">{{afficherSection(detailOpProvisoire.section_id)}} </td>
                 </tr>
                 <tr>
                   
                     <th style="width:16%">PROGRAMME/DOTATION</th>
                     <td colspan="3">{{afficherLibelleProgramme(detailOpProvisoire.programme_id)}} </td>
                 </tr>
                 <tr>
                   
                     <th style="width:16%">ACTION</th>
                     <td colspan="3"> {{afficherLibelleAction(detailOpProvisoire.action_id)}} </td>
                 </tr>
                 <tr>
                   
                     <th style="width:16%">ACTIVITE</th>
                     <td colspan="3">{{afficherLibelleActivite(detailOpProvisoire.activite_id)}} </td>
                 </tr>
                 <tr>
                   
                     <th style="width:16%">CLASSIFICATION ECONOMIQUE</th>
                     <td colspan="3">{{afficherLibellePlanEconomique(detailOpProvisoire.ligne_id)}} </td>
                 </tr>
                 </thead>
