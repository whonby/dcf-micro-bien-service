              ...
              <div id="tout_decompte" class="tab-pane active">
                  <table class="table table-bordered table-striped" v-if="macheid">
                      ...
                      <tr>
                          ...
                          <th style="text-align:center;font-size:12px" colspan="3">Action </th>
                      </tr>
