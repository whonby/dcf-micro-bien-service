    ...
    ...mapActions("personnelUA", [
     ...
     AjouterDecompte() {
      ...
      var nouvelObjet = {
        ...
        numero_decompte:this.formData.numero_decompte,
          date_decompte:this.formData.date_decompte,
          retenu_avance:this.formData.retenu_avance,
          retenu_garantie:this.formData.retenu_garantie,
          retenu_penalite:this.formData.retenu_penalite,
          nethtva:this.formData.nethtva,
          netttc:this.formData.netttc,
          parts_etat:this.formData.parts_etat,
          parts_bailleur:this.formData.parts_bailleur,
          dif_decompte:1,
