<template>
                  ...
                  <tr class="odd gradeX" v-if="article" @dblclick="$emit('modification', article)">
                    ...
                    <td> {{article.fonction_id || 'Non renseigné'}}</td>
                    
                   <td> {{article.famil_id || 'Non renseigné'}}</td>
                   
                   <td> {{article.montant_ttc || 'Non renseigné'}}</td>
                    <td> {{article.quantite || 'Non renseigné'}}</td>
