  ...
  <button @click.prevent="BoutonDeSuppensionMarche(index)"  class="btn btn-danger"  title="Suspendre le marché">
        <span class=""><i class="icon-ban-circle" ></i></span></button>
                      ...
                      <td  style="text-align: center;color:red;font-weight:bold;">
                           {{formatageSomme(parseFloat(montantMarcheContraHorSib6))}}
...
...mapGetters("parametreGenerauxBudgetaire",["plans_budgetaires","derniereNivoPlanBudgetaire"]),
 ...
 ListeMarcheInfrastructureNiveau1() {
  ...
  montantMarcheContraHorSib6(){
  return this.ListeMarcheInfrastructureNiveau1.filter(element => element.attribue == 1 && this.recupererCodeTypeMarche(element.type_marche_id) == 3 && element.parent_id == null && element.sib==1 && this.InfastructureNiveau1(element.infrastructure_id)==6).reduce((prec, cur) => parseFloat(prec) + parseFloat(cur.montant_marche), 0)
},
  ...
  afficherListeMarcheHorsSib() {
       // const st = this.search.toLowerCase();
        if (this.noDCfNoAdmin){
            ...
            return colect.filter(element => element.attribue == 1 && this.recupererCodeTypeMarche(element.type_marche_id) == 3 && element.parent_id == null && element.sib==1 && this.InfastructureNiveau1(element.infrastructure_id)==6)
        ...
        return this.gettersMarcheHorsib.filter(element => element.attribue == 1 && this.recupererCodeTypeMarche(element.type_marche_id) == 3 && element.parent_id == null && element.sib==1 && this.InfastructureNiveau1(element.infrastructure_id)==6)
            // return (
            //     items.secti.nom_section.toLowerCase().includes(st) ||
            //     items.libelle.toLowerCase().includes(st)
            // );
