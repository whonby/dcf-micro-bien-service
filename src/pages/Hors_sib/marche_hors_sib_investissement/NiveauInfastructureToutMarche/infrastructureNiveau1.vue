...
InfastructureLibelleNiveau1() {
    ...
    marcheHorSibFiltre() {
        ...
        if (this.noDCfNoAdmin){
            ...
            return colect.filter(element => element.gdenature_id == 7 && element.sib==1 && element.parent_id == null && this.InfastructureNiveau1(element.infrastructure_id)==1)
         
        }

            return this.gettersMarcheHorsib.filter(element => element.gdenature_id == 7 && element.sib==1 && element.parent_id == null && this.InfastructureNiveau1(element.infrastructure_id)==1)
