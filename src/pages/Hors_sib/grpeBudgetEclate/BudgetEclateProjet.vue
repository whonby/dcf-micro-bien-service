          ...
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered table-striped">
                ...
                <td>
                     <button  @click.prevent="afficherModalModifierExerciceBudgetaire(type[0].unitezone_id)"
                        class="btn  btn-success">
                <span title="Ajouter budget eclate">A</span>
                     </button>
               
                   </td>
                   <td>
                    <router-link :to="{ name: 'ListeBudgeteclate', params: { id: type[0].unitezone_id }}"
                class="btn btn-default " title="Lieste des budget eclate par Ua">
...
UniteAdministrative() {
 ...
 this.$('#exampleModal').modal({
        ...
        this.formData = this.transferts.find(item =>item.id==id);
