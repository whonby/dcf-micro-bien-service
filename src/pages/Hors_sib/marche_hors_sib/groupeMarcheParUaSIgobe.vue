...
<template>
 ...
 <div  align="left" style="cursor:pointer;">
    <button class="btn btn-danger" @click.prevent="pagePrecedent">Page Précédente</button>
          ...
          <h2 style="text-align:center;font-size:25px">VOIR LES MARCHES PAR UNITE ADMINISTRATIVE</h2>
...
<td style="font-size:16px;color:#000;text-align:center">{{libelleProgramme(idProgramme(type[0].unite_administrative_id)) || 'Non renseigné'}}</td>
                   ...
                   <td v-if="type[0].unite_zone == 0">
                      <router-link :to="{ name: 'PagePrincipalMarcheSigobe', params: { id: type[0].unite_administrative_id }}"
