  ...
  <div>
    ...
    <div id="exampleModal" class="modal hide">
      <div class="modal-header">
        ...
        <h3>Ajouter l'Etat d'immobilisation</h3>
      </div>
    ...
    <div class="container-fluid">
      ...
      <div class="row-fluid">
        <div class="span12">
          ...
          <div align="right" style="cursor:pointer;">
           <button class="btn btn-success" @click.prevent="afficherModalAjouterService()">AJOUTER</button>
          </div><br>
           <h3 align="center">Liste des Etats des Immobilisations</h3>
            ...
            <div class="widget-content nopadding">
              ...
              <button  @click.prevent="afficherModalModifierService(service.id)"  class="btn btn-info " >
                <span class=""><i class="icon-edit"> Modifier</i></span></button>
                  ...
                  <td>
              <button @click.prevent="supprimerEtatImmo(service.id)"  class="btn btn-danger ">
...
partition:partition,
  ...
  getDataPaginate(index){
    ...
    afficherModalModifierService(id) {
      ...
      this.editService = this.EtatImmobilisations.find(item=> item.id==id);
    },
