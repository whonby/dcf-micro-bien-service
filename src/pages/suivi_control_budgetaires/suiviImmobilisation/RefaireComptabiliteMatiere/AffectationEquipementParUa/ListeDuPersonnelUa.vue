...
<template>
    ...
    <div >
                ...
                <div class="widget-box">
                  <div class="widget-title">
                    <ul class="nav nav-tabs">
                       ...
                       <li class="active">
                        <a data-toggle="tab" href="#tab78965">Liste du Personnel non Equipées  </a>
                      </li>
                      <li class="">
                        <a data-toggle="tab" href="#tab47581">Equipements Non Couverts   </a>
                      </li>
                       <li class="">
          ...
          <div id="tab78965" class="tab-pane active"><listeDuPersonnelParUa></listeDuPersonnelParUa> </div>
          <div id="tab47581" class="tab-pane ">test2 </div>
...
import listeDuPersonnelParUa from '../../../suiviImmobilisation/RefaireComptabiliteMatiere/AffectationEquipementParUa/DossierAffectation/listeDuPersonnelParUa'
