<template>
 ...
 <div class="table-responsive text-nowrap">
          ...
          <div class="table-responsive text-nowrap">
            ...
            <div class="widget-title" style="background-color: Purple; color: white;">
            <span class="icon">
              <i class="icon-th"></i>
            </span>
            <h5 style="color: #fff;">INFO SUR L'INVENTAIRE DU VEHICULE</h5>
          </div>
          <div class="table-responsive text-nowrap">
            <table class="table table-bordered table-striped">
              <thead>
              ...
              <tbody>
                <tr 
                  class="odd gradeX"
                    >
                  <td>{{detail_Vehicule.date_inventaire || 'Non renseigné'}}</td>
                  <td>{{detail_Vehicule.bien_physique || 'Non renseigné'}}</td> 
                  <td>{{detail_Vehicule.etat_bien || 'Non renseigné'}}</td>  
                     <td>{{detail_Vehicule.quantite_vue || 'Non renseigné'}}</td>
                      <td>{{detail_Vehicule.nom_agent || 'Non renseigné'}}</td>
