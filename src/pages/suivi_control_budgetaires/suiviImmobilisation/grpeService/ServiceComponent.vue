            ...
            <div class="accordion-heading">
              <div @click="toggle()" class="widget-title"> <a data-parent="#collapse-group" href="#collapseGOne" data-toggle="collapse"> 
                ...
                <h5>{{groupe.libelle}}</h5>
                 ...
                 <span class="badge badge-inverse" >{{nombreDeFonction}}</span>     <span class="badge badge-inverse" >{{nombreAffecter}}</span>
...
nombreAffecter() {
         ...
         const qtereel = this.groupe.relation_service.filter(element => element.normeequipement == 0).length;
         if(qtereel) return qtereel
        return '0'
    },
nombreDeFonction() {
