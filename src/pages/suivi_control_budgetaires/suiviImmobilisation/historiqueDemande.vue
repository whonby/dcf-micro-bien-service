            ...
            <div class="widget-content nopadding" >
              <table class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th>Fonction</th>
                     ...
                     <th>Famille</th>
                    <th>Article</th>
                    <th title="Quantité demande">Qté demande</th>
                      <th title="Quantité non couverte">Qté non couverte</th>
                    <th title="Quantité Couverte">Qté Couverte</th>
                ...
                <tbody>
                  <tr
                    class="odd gradeX"
                    v-for="BesoinImmo in historiqueDemande"
                    :key="BesoinImmo.id"
                  >
                   <td
                   ...
                   <!-- <td 
                    ...
                    >{{formatageSomme(parseFloat(BesoinImmo.totalrealise)) || 0}} </td>
                    <td
                 ...
                 <tr
                  ...
                  <td ></td>
                   <td ></td>
                    ...
                    <td style="text-align: center;color:red;font-weight:bold;">{{nbreQuantiteDemande || 0}}</td>
                     <td style="text-align: center;color:red;font-weight:bold;">{{nbreQuantiteNonCouvert || 0}}</td>
                    <td style="text-align: center;color:red;font-weight:bold;">{{nbreQuantiteCouvert || 0}}</td>
                     <td></td>
