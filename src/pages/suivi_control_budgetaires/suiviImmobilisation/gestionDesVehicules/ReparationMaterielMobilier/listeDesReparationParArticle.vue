...
export default {
  ...
  created() {
   ...
   this.detail_vehicule = this.immobilisations.find(
       idmarche => idmarche.id == this.$route.params.id
         )
      
},
   computed: {
     ...mapGetters("SuiviImmobilisation", ["immobilisations","Appreciations","EtatImmobilisations","TypeEnergie","marqueVehicules","ModeleVehicules","TypeEntretien","TypeVehicule","TypeReparation","Transmissions"]),  
