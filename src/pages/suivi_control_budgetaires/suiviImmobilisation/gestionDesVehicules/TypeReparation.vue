...
<template>
  <div>
    ...
    <div id="modificationModal" class="modal hide">
      <div class="modal-header">
        <button data-dismiss="modal" class="close" type="button">×</button>
        <h3>Modifier type réparation</h3>
      </div>
      <div class="modal-body">
     <table class="table table-bordered table-striped">
              ...
              <table class="table table-bordered table-striped" id="printMe">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td>
                      <button class="btn btn-danger" @click="supprimerTypeReparation(service.id)">
                        <span>
...
json_fields: {
  ...
  computed: {
    ...mapGetters("SuiviImmobilisation", ["TypeReparation"]),
    filtre_service() {
      const st = this.search.toLowerCase();
      return this.TypeReparation.filter(type => {
        return (
  ...
  methods: {
    ...mapActions("SuiviImmobilisation", [
      ...
      "ajouterTypeReparation",
      "modifierTypeReparation",
      "supprimerTypeReparation"
    ]),
              // pagination
   partition:partition,
...
getColumns() {
    ...
    ajouteMarqueVehicule() {
      this.ajouterTypeReparation(this.formData);
    ...
    afficherModalModifierService(id) {
      ...
      this.editService = this.TypeReparation.find(item=>item.id==id);
    },
    // fonction pour vider l'input modification
    modifierServiceLocal() {
      this.modifierTypeReparation(this.editService);
