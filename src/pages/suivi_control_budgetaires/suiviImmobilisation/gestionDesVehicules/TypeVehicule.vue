              ...
              <table class="table table-bordered table-striped" id="printMe">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td>
                      <button class="btn btn-danger" @click="supprimerTypeVehicule(service.id)">
                        <span>
...
json_fields: {
  ...
  computed: {
    ...mapGetters("SuiviImmobilisation", ["TypeVehicule"]),
    filtre_service() {
      const st = this.search.toLowerCase();
      return this.TypeVehicule.filter(type => {
        return (
...
getColumns() {
    ...
    ajouteMarqueVehicule() {
      this.ajouterTypeVehicule(this.formData);
    ...
    afficherModalModifierService(id) {
      ...
      this.editService = this.TypeVehicule.find(item=>item.id==id);
    },
    // fonction pour vider l'input modification
    modifierServiceLocal() {
      this.modifierTypeVehicule(this.editService);
