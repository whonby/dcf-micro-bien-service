...
<template>
      ...
      <div class="accordion" >
          <div class="accordion-group widget-box" v-if="ListeDesVehiculeParUa(getterUa_idImo).length > 0 ">
            ...
            <div class="collapse in accordion-body"  v-if="isFolder && isOpen">
              <div class="widget-content"> 
                ...
                <tbody>
                   <VehiculeItem
                        class="item"
                        v-for="groupeElement in ListeDesVehiculeParUa(getterUa_idImo)"
  ...
  ListeDesVehiculeParUa() {
    ...
    iconClasses() {
      return {
        ...
        //    'icon-folder-close': !this.isOpen && this.ListeDesVehiculeParUa(getterUa_idImo).length,
        // 'icon-folder-open': this.isOpen && this.ListeDesVehiculeParUa(getterUa_idImo).length
      }
    },
