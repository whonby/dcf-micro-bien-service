              ...
              <table class="table table-bordered table-striped" id="printMe">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td>
                      <button class="btn btn-danger" @click="supprimerTypeEntretien(service.id)">
                        <span>
...
json_fields: {
  ...
  computed: {
    ...mapGetters("SuiviImmobilisation", ["TypeEntretien"]),
    filtre_service() {
      const st = this.search.toLowerCase();
      return this.TypeEntretien.filter(type => {
        return (
...
getColumns() {
    ...
    ajouteMarqueVehicule() {
      this.ajouterTypeEntretien(this.formData);
    ...
    afficherModalModifierService(id) {
      ...
      this.editService = this.TypeEntretien.find(item=>item.id==id);
    },
    // fonction pour vider l'input modification
    modifierServiceLocal() {
      this.modifierTypeEntretien(this.editService);
