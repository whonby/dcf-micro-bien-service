              ...
              <div class="widget-box">
                <div class="widget-title">
                  <ul class="nav nav-tabs">
                    ...
                    <li>
                      <a data-toggle="tab" href="#tab040"
                        >EVOLUTION DES MARCHES</a
                      >
                    </li>
                    <li>
                      <a data-toggle="tab" href="#tab041"
                        >SITUATION DES MARCHE</a
                      >
                    </li>
                    <li>
                ...
                <div class="widget-content tab-content">
                  ...
                  <div id="tab22" class="tab-pane">RECHERCHE PAR UA</div>

                  <div id="tab03" class="tab-pane">
                    RECHERCHE PAR ANNEE ET UA ET VEHICULE
                  </div>
