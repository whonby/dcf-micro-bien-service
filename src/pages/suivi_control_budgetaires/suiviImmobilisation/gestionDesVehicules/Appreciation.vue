              ...
              <table class="table table-bordered table-striped" id="printMe">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td>
                      <button class="btn btn-danger" @click="supprimerAppreciation(service.id)">
                        <span>
...
json_fields: {
  ...
  computed: {
    ...mapGetters("SuiviImmobilisation", ["Appreciations"]),
    filtre_service() {
      const st = this.search.toLowerCase();
      return this.Appreciations.filter(type => {
        return (
...
getColumns() {
    ...
    ajouteMarqueVehicule() {
      this.ajouterAppreciation(this.formData);
    ...
    afficherModalModifierService(id) {
      ...
      this.editService = this.Appreciations.find(item=>item.id==id);
    },
    // fonction pour vider l'input modification
    modifierServiceLocal() {
      this.modifierAppreciation(this.editService);
