<template>
                  ...
                  <tr class="odd gradeX" v-if="article" >
                    ...
                    <td style="font-size:14px" @dblclick="afficherModalModifierTitre(article.id)"> {{article.panne_signale || 'Non renseigné'}}</td>
                    ...
                    <td style="font-size:14px" @dblclick="afficherModalModifierTitre(article.id)"> {{article.entreprise_id || 'Non renseigné'}}</td>
                    <td style="font-size:14px" @dblclick="afficherModalModifierTitre(article.id)"> {{formaterDate(article.date_retour) || 'Non renseigné'}}</td>
                    <td style="font-size:14px" @dblclick="afficherModalModifierTitre(article.id)"> {{formatageSomme(parseFloat(article.cout_reparation)) || 'Non renseigné'}}</td>
