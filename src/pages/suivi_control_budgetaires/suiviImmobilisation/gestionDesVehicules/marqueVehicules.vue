...
json_fields: {
  ...
  computed: {
    ...mapGetters("SuiviImmobilisation", ["marqueVehicules"]),
    filtre_service() {
      const st = this.search.toLowerCase();
      return this.marqueVehicules.filter(type => {
        return (
  ...
  methods: {
    ...mapActions("SuiviImmobilisation", [
      ...
      "ajouterMarqueVehicule",
      "modifierMarqueVehicule",
      "supprimerMarqueVehicule"
    ]),
              // pagination
   partition:partition,
...
getColumns() {
    ...
    ajouteMarqueVehicule() {
      this.ajouterMarqueVehicule(this.formData);
    ...
    afficherModalModifierService(id) {
      ...
      this.editService = this.marqueVehicules.find(item=>item.id==id);
    },
    // fonction pour vider l'input modification
    modifierServiceLocal() {
      this.modifierMarqueVehicule(this.editService);
