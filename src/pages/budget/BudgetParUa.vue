                ...
                <div class="widget-content nopadding" >
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th style="background: deepskyblue; color:#fff">Reste à consommé</th>
                        ...
                        <tr v-for="unite in uniteAdministratives" :key="unite.id">
                            ...
                            <td style="font-weight:bold;font-size:15px">{{formatageSomme(budgetPersonnel(unite.id))}}</td>
                            <td style="font-weight:bold;font-size:15px">{{formatageSomme(budgetBienService(unite.id))}}</td>
                            <td style="font-weight:bold;font-size:15px">{{formatageSomme(budgetInverstisement(unite.id))}}</td>
                            <td style="font-weight:bold;font-size:15px">{{formatageSomme(budgetTranfert(unite.id))}}</td>
                            
                            <td style="background: forestgreen; color:#fff"></td>
                            <td style="background: deepskyblue; color:#fff"></td>
                            <td style="background: orangered;color:#fff"></td>
                        </tr>


                          <tr>
                          <td style="background: orangered;color:#fff"> Total Budget par UA
                             </td>
                           ...
                           {{formatageSomme(parseFloat(afficherTotalBudgetModulePersonnel))}} 
                            ...
                            <td  style="text-align: center;color:red;font-weight:bold;">
                           {{formatageSomme(parseFloat(afficherTotalBudgetModuleBienService))}}
                           
                           </td>

                           <td  style="text-align: center;color:red;font-weight:bold;">
                           {{formatageSomme(parseFloat(afficherTotalBudgetModuleInvestissement))}}
                           
                           </td>
                           
                            <td  style="text-align: center;color:red;font-weight:bold;">
                           {{formatageSomme(parseFloat(afficherTotalBudgetModuleTransfert))}}
