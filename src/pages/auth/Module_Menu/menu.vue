       ...
       <option value="100">100</option>
           ...
           <div class="widget-content nopadding">
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                <tr class="odd gradeX" v-for="activites  in gettersMenu"
                 :key="activites.id">
              ...
              <div class="btn-group">
              <button @click.prevent="supprimerMenu(activites.id)"  class="btn btn-danger ">
...
<!----- ajouter modal   ---->
 ...
 <div id="exampleModal" class="modal hide">
            ...
            <option v-for="resultat in gettersModule" :key="resultat.id" 
            ...
            <div class="control-group">
              <label class="control-label">Code:</label>
              <div class="controls">
                <input type="text" v-model="formData.code" class="span" placeholder="Saisir le libellé" />
              </div>
            </div>
...
// methode pour maper notre guetter
   //...mapGetters('suivi_controle_budgetaire', ['gettersMenu']) ,
    ...mapGetters('Utilisateurs', ['gettersMenu','gettersModule']),
...
// return this.gettersMenu.filter((item) => {
...
//    }
  ...
  methods: {
   ...
   ...mapActions('Utilisateurs', [ 'ajouterMenu', 
   'modifierMenu','supprimerMenu']),

    //                genererEnPdf(){
    //      var doc = new jsPDF()
    //     // doc.autoTable({ html: this.natures_sections })
    //     var data = this.gettersMenu;
    //      doc.setFontSize(8)
...
//     },
   // fonction pour vider l'input
     ...
     this.ajouterMenu(this.formData)
...
afficherModalModifierBudgetaire(id){
 ...
 this.$('#modifierModal').modal({
        ...
        this.editBudgetaire = this.gettersMenu.find(item => item.id==id);
...
modifierBudgetaireLocal(){
  this.modifierMenu(this.editBudgetaire)
