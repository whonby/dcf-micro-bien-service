                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr class="odd gradeX" v-for="(item, index) in partition (titreFiltres,size)[page]" :key="item.id">
                                    <td @dblclick="afficherModalModifierTitre(index)">{{item.nom_groupe || 'Non renseigné'}}</td>
                                    <!--<td @dblclick="afficherModalModifierTitre(index)">{{item.libelle || 'Non renseigné'}}</td>-->
                                    <td>
                                        <div class="btn-group">
                                            <button @click.prevent="supprimerTypeSalarie(item.id)"  class="btn btn-info ">
                                                <span class=""><i class="icon-folder-open"></i></span></button>
                                            <button @click.prevent="supprimerTypeSalarie(item.id)"  class="btn btn-warning ">
