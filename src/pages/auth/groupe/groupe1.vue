             ...
             <tbody>
               <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                                            <h5>PARAMETRES GENERAUX </h5>
                                             ...
                                             <span>coché:{{attribue}}</span>
                                                        <tr class="odd gradeX">
                                                            <td>Exercices </td>
                                                            <td style="text-align: center"><p-check class="p-default p-curve" color="success" off-color="" toggle style="transform: scale(0.9) translate(-10%, -95%);  " v-model="attribue" value="exercice" >
                                                        ...
                                                        <tr class="even gradeC">
                                                            ...
                                                            <td style="text-align: center"><p-check class="p-default p-curve" color="success" off-color="" toggle style="transform: scale(0.9) translate(-10%, -95%);  " v-model="attribue" >
                                                                <!--<img slot="extra"  class="image" src="../../../assets/004.png">-->
                                                        ...
                                                        <tr class="even gradeA">
                                                         ...
                                                         <tr class="odd gradeX">
                                                         <td>Service gestionnaire de credit </td>
                                                            <td style="text-align: center"><p-check class="p-default p-curve" color="success" off-color="" toggle style="transform: scale(0.9) translate(-10%, -95%);  "  v-model="attribue" >
                                                                <!--<img slot="extra"  class="image" src="../../../assets/004.png">-->
                                                                <label slot="off-label"></label>
                                                            </p-check></td>
                                                         ...
                                                         <tr class="odd gradeX">
                                                         <td>Classification grade && emploi </td>
                                                            <td style="text-align: center"><p-check class="p-default p-curve" color="success" off-color="" toggle style="transform: scale(0.9) translate(-10%, -95%);  "  v-model="attribue" >
                                                                <!--<img slot="extra"  class="image" src="../../../assets/004.png">-->
                                                                <label slot="off-label"></label>
                                                            </p-check></td>
             ...
             <tbody>
               <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
                                            <h5>PARAMETRES GENERAUX</h5>
                                                        ...
                                                        <tr class="odd gradeX">
                                                            <td>Exercices </td>
                                                            <td style="text-align: center"><p-check class="p-default p-curve" color="success" off-color="" toggle style="transform: scale(0.9) translate(-10%, -95%);  "  v-model="attribue" value="CODE" >
                                                                <!--<img slot="extra"  class="image" src="../../../assets/004.png">-->
                                                                <label slot="off-label"></label>
                                                            </p-check></td>
                                           ...
                                           <tr class="odd gradeX">
                                                         ...
                                                         <td>Budget importé </td>
                                                          ...
                                                          <tr class="odd gradeX">
                                                         <td>Importation du budget </td>
                                                            <td style="text-align: center"><p-check class="p-default p-curve" color="success" off-color="" toggle style="transform: scale(0.9) translate(-10%, -95%);  "   >
                                                                <!--<img slot="extra"  class="image" src="../../../assets/004.png">-->
                                                                <label slot="off-label"></label>
                                                            </p-check></td>
                                                         </tr>
...
//      return item.nom_groupe.toLowerCase().includes(searchTerm) 
  ...
  afficherCodeMenu(){
    return id =>{
      if(id!=null && id!=""){
        let answer = this.gettersMenu.find(item => item.groupe_id==id)
