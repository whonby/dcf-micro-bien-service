...
<div align="right" style="cursor: pointer">
 ...
 <tr>
                          ...
                          <select v-model="formCotation.entreprise_id" class="span10">
                                <option v-for="varText in gettersEntreprisePreselectionner" :key="varText.id"
                                        :value="varText.id">{{afficherLibelleEntreprise(varText.entreprise_id)}}</option>
                            </select>
 ...
 <tr>
                          ...
                          <select v-model="editCotation.entreprise_id" class="span">
                                <option v-for="varText in gettersEntreprisePreselectionner" :key="varText.id"
                                        :value="varText.id">{{varText.entreprise_id}}</option>
                            </select>
                            <!-- <div class="span" align="left" >
...
export default {
 ...
 components:{
    ...
    computed: {
            ...
            ...mapGetters("bienService", ["gettersCotations","appelOffres",
             "gettersCotationPersonnaliser" ,"gettersCotations","gettersEntreprisePreselectionner"]),
