              ...
              <span class="icon">
                ...
                <div class="widget-content nopadding" >
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                      <tr v-for="passation in getterPlanPassationMarche" :key="passation.id">
    ...
    export default {
        ...
        methods: {
            ...
            ...mapActions("bienService", [
                'ajouterPlanPassationMarche',"getPlanPassationMarche","getMarche"
            ]),
            OnchangeFichier(e) {
            ...
            ajouterFichier(){
                ...
                this.ajouterPlanPassationMarche(formData,config).then(data=>{
                    console.log(data)
