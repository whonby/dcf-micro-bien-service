...
return this.getActeEffetFinancierPersonnaliser45.filter(element => element.marche.attribue == 3 && this.afficheCodeTypeMarche(element.marche.type_marche_id) == 4 || this.afficheCodeTypeMarche(element.marche.type_marche_id) == 1)
},
    nbreMarcheExecuter(){
  return this.getActeEffetFinancierPersonnaliser45.filter(recuper => recuper.marche.attribue == 2 && this.afficheCodeTypeMarche(recuper.marche.type_marche_id) == 4 || this.afficheCodeTypeMarche(recuper.marche.type_marche_id) == 1).length
},
