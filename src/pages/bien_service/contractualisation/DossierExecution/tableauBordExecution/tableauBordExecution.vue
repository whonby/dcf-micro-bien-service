    ...
    <tr>
     ...
     <tr>
        <td>
         ...
         <td>
            <ul class="quick-actions" style="margin: 0px !important;"> 
   <li class="bg_lb span"> <a href="#" style="color:#FFFFFF;"><h4>DISPONIBLE  </h4> <i class="icon-dashboard"></i> <span class="label label-important" style="font-size:15px">{{formatageSomme(parseFloat(afficherMontantBudgetaireInitial(afficherInputationBudgetaire(macheid))))}}</span><h4>BUDGETAIRE</h4></a> </li>
            </ul>
