        ...
        <table class="table table-bordered table-striped">
          ...
          <tr>
            <td>
              <div class="control-group">
                <label class="control-label"
                  >Date ordre de service demarrage</label
                >
                <div class="controls">
                  <input
                    type="date"
            ...
            <ul class="nav nav-tabs">
              <li class="active">
                <a data-toggle="tab" href="#tab2078"
                  >Tous les marchés
                  <span class="badge badge">{{ nombreDeMarche }}</span></a
                >
              </li>
              ...
              <li>
                <a data-toggle="tab" href="#tab20789"
                  >Suspendus
                  <span class="badge badge">
                    {{ nombreDeMarcheSuspendu }}</span
                  ></a
                >
              </li>
              <li>
                <a data-toggle="tab" href="#tab2000256">
                  Terminé
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td
                      ...
                      "
                    >
                      {{ ELibelle(marche.type_marche_id) || "Non renseigné" }}
                    </td>
                    <td
                      @dblclick="
                        afficherModalModifierMarcgeContratualisation(index)
                  ...
                  {{marche.afficheEconomique.code || 'Non renseigné'}}- {{marche.afficheEconomique.libelle || 'Non renseigné'}}</td> -->
                   ...
                   {{marche.numero_marche || 'Non renseigné'}}</td> -->
                    ...
                    <td>
                      <button
                        v-if="marche.attribue == 7"
                        class="btn btn"
                        title="MARCHE SUSPENDU"
                      >
                        <span>SU</span>
                      </button>
                    </td>
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td>
                      {{ ELibelle(E(marche.marche_id)) || "Non renseigné" }}
                    </td>
                    <!-- <td>
                  ...
                  <span class=""><i class=" icon-folder-open"></i></span>
                    ...
                    <td>
                      <button
                        ...
                        "
                        class="btn btn-info"
                        title="Basculer en Exécution"
                      >
                        <span class=""><i class="icon-undo"></i></span>
                      </button>
                    </td>
                    <td>
                      <button
                        @click.prevent="BoutonDeSuppensionMarche(index)"
                ...
                <tbody>
                  ...
                  {{marche.afficheEconomique.code || 'Non renseigné'}}- {{marche.afficheEconomique.libelle || 'Non renseigné'}}</td> -->
                    ...
                    <td>
                      <span
                        v-if="
                          marche.economique_id ==
                          CodeExempte(marche.economique_id)
                        "
                        >Exemptée procdure</span
                      >
                   ...
                   {{marche.numero_marche || 'Non renseigné'}}</td> -->
                    ...
                    <td>
                      {{
                        formatageSomme(
                          parseFloat(recupererMontantReel(marche.id))
                        ) || "Non renseigné"
                      }}
                    </td>
                    <td @dblclick="afficherModalModifierTypePrestation(index)">
                    ...
                    <td>
                      <router-link
                        ...
                        class="btn btn-default"
                        title="Historique des exécutions Marché"
                      >
                    ...
                    <td>
                      ...
                      >
                        <span class=""
                          ><i class="icon-trash"></i> Supprimer</span
                        >
                      </button>
                    </td>
                ...
                <tbody>
                  ...
                  >
                    <template
                      v-if="
                        afficherCodeTypeMarche(
                          afficherDifferentTypeMarche(marche.marche_id)
                        ) == 4 ||
                        afficherCodeTypeMarche(
                          afficherDifferentTypeMarche(marche.marche_id)
                        ) == 1
                    ...
                    >
                      <td>
                        {{
                          afficherAnneeBudget(marche.marche_id) ||
                          "Non renseigné"
                        }}
                      </td>
                      <td>
                  ...
                  {{marche.afficheEconomique.code || 'Non renseigné'}}- {{marche.afficheEconomique.libelle || 'Non renseigné'}}</td> -->
                      <td>
                        {{
                          afficherObjetMarche(marche.marche_id) ||
                          "Non renseigné"
                        }}
                      </td>
                      <!-- <td>
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  {{marche.afficheEconomique.code || 'Non renseigné'}}- {{marche.afficheEconomique.libelle || 'Non renseigné'}}</td> -->
                   ...
                   {{marche.numero_marche || 'Non renseigné'}}</td> -->
                    <td
                      @dblclick="afficherModalModifierMarcgePlanifier(index)"
                      style="text-align: center"
                    >
                      {{
                        formatageSomme(parseFloat(marche.montant_marche)) ||
...
export default {
  ...
  computed: {
    ...
    filtre_unite_admin() {
      ...
      if (this.noDCfNoAdmin) {
        ...
        return colect.filter(
          (element) =>
            (this.recupererCodeTypeMarche(element.type_marche_id) == 4 &&
        ...
        return colect.filter(
          (element) =>
            (this.recupererCodeTypeMarche(element.type_marche_id) == 4 &&
              ...
              element.parent_id == null &&
              element.sib == 0 &&
              element.difference_personnel_bienService == 2 &&
              element.sib == 0) ||
            (this.recupererCodeTypeMarche(element.type_marche_id) == 1 &&
              element.parent_id == null &&
              element.sib == 0 &&
        ...
        return colect.filter(
          (element) =>
            ...
            (this.recupererCodeTypeMarche(element.type_marche_id) == 1 &&
              ...
              element.parent_id == null &&
              element.sib == 0 &&
              element.difference_personnel_bienService == null)
        );
      }
    ...
    afficherLaListeDesMarche() {
      return this.printMarcheNonAttribue.filter(
        (element) => element.gdenature_id == 5 && element.sib == 0
      );
    },
    ...
    montantMarche() {
      return this.filtre_unite_admin.reduce(
    ...
    afficheractiviteBienService() {
      return (id) => {
        if (id != null && id != "") {
          ...
          if (qtereel) {
            return qtereel.afficheActivite.code.concat(
              "  ",
              qtereel.afficheActivite.libelle
            );
          }
          return 0;
        }
    ...
    ImputationBudgetModifier() {
      const norme = this.getPersonnaliseBudgetGeneralParBienService.find(
        (normeEquipe) =>
          normeEquipe.afficheEconomique.id == this.editMarche.economique_id
      );
      ...
      return this.getActeEffetFinancierPersonnaliser45.filter(
        (element) =>
          (this.afficherAttributMarche(element.marche_id) == 2 &&
            this.affichertypeMarcheEx(element.marche.type_marche_id) == 4 &&
            element.difference_personnel_bienService == 2) ||
          (this.afficherAttributMarche(element.marche_id) == 2 &&
            this.affichertypeMarcheEx(element.marche.type_marche_id) == 1 &&
            element.difference_personnel_bienService == 2)
      );
    },
    ...
    montantEnSolde() {
      return this.afficherMarcherTerminerParUA.reduce(
        (prec, cur) => parseFloat(prec) + parseFloat(cur.montant_marche),
        0
      );
    },
    ...
    afficheMarcheEnCoursContratualisation() {
      return this.afficherLaListeDesMarche.filter(
        (element) =>
          (element.attribue == 1 && element.gdenature_id == 5) ||
          (element.attribue == 1 &&
            this.recupererCodeTypeMarche(element.type_marche_id) == 4)
      );
    },
    afficheMarcheSuspendu() {
      return this.afficherLaListeDesMarche.filter(
        (element) => element.attribue == 7 && element.gdenature_id == 5
      );
    },
    ...
    montantSuspendu() {
      return this.afficheMarcheSuspendu.reduce(
        (prec, cur) => parseFloat(prec) + parseFloat(cur.montant_marche),
        0
      );
    },
    ...
    montantEnContratualisation() {
      return this.afficherContratualisationParUA.reduce(
        (prec, cur) => parseFloat(prec) + parseFloat(cur.montant_marche),
        0
      );
    },
    ...
    afficheMarcheEnPlanification() {
      return this.afficherLaListeDesMarche.filter(
        (element) =>
          element.attribue == 0 && element.gdenature_id == 5 && element.sib == 0
      );
    },
    ...
    montantEnPlanification() {
      return this.afficherPlanificationPA.reduce(
        (prec, cur) => parseFloat(prec) + parseFloat(cur.montant_marche),
        0
      );
    },
    ...
    NombreExecute() {
      return this.getActeEffetFinancierPersonnaliser45.filter(
        (element) =>
          element.date_odre_service == this.nombreJourTraitementCalucle
      ).length;
    },
  ...
  methods: {
    ...
    modifierModalActeEffetFinancierLocal2(index) {
      if (
        confirm(
          "Avez-vous terminé les etapes avant de migrer en execution svp ?"
        )
      ) {
        ...
        if (
          this.recupererDateMiseService(this.editActeEffetFinancier.id) ==
            null ||
          this.recupererDateMiseService(this.editActeEffetFinancier.id) == ""
        ) {
    ...
    BoutonDeSuppensionMarche(index) {
      if (confirm("Etes-vous sur de suspendre le marché ?")) {
        ...
        let marcheObjet = this.marches.find(
          (marche) => marche.id == this.editMarche.id
        );
