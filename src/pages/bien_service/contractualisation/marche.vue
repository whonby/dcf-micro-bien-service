...
<template>
    ...
    <tr>
       <td>
            ...
            <div class="controls">
              <input
                type="text"
                :value="afficherNumeroMarche(editMarche.marche_id)"
                class="span4"
                readonly
            ...
            <div class="controls">
              <textarea name="" id="" cols="2" rows="2"  readonly class="span6" :value="afficherObjetMarche(editMarche.marche_id)"></textarea>
    ...
    <tr>
            ...
            <div class="controls">
            <textarea name="" id="" cols="2" rows="2" class="span10" v-model="editMarche.cause_resiliation"></textarea>
            </div>
          </div>
              </td>
       ...
       <td>
            ...
            <div class="controls">
              <input
                type="text"
                :value="afficherEntreprise(editMarche.entreprise_id)"
                class="span4"
 readonly
            ...
            <div class="controls">
              <input
                type="date"
               v-model="editMarche.date_resiliation"
                class="span3"
      ...
      <div class="modal-footer">
        <a
          @click.prevent="modifierModalResiliation(editMarche)"
                    ...
                    <div class="widget-box">
                        <div class="widget-title">
                            <ul class="nav nav-tabs">
                               <li class="active"><a data-toggle="tab" href="#tab2078">Toutes les marches    <span class="badge badge-inverse" >{{nombreMarche}}</span></a></li>
                               
                               <li ><a data-toggle="tab" href="#tab100">Marchés Planifiés        <span class="badge badge-important" >    {{nombreMarchePlanifier}}</span></a></li>
                ...
                typePrestationFiltre"
                 :key="marche.id">
                  ...
                  <td @dblclick="afficherModalModifierTypePrestation(index)">
                   {{marche.AfficheMarche.exo_id || 'Non renseigné'}}</td>
                 <td @dblclick="afficherModalModifierTypePrestation(index)">
                 ...
                 <td @dblclick="afficherModalModifierTypePrestation(index)" style="text-align: center">
                  ...
                  <td @dblclick="afficherModalModifierTypePrestation(index)">
                   {{afficheractivite(marche.AfficheMarche.activite_id )|| 'Non renseigné'}}</td>
                    <td @dblclick="afficherModalModifierTypePrestation(index)">
                   {{marche.AfficheMarche.imputation || 'Non renseigné'}}</td>
                    <!-- <td @dblclick="afficherModalModifierTypePrestation(index)">
                  {{marche.afficheEconomique.code || 'Non renseigné'}}- {{marche.afficheEconomique.libelle || 'Non renseigné'}}</td> -->
                     <td @dblclick="afficherModalModifierTypePrestation(index)">
                   {{marche.AfficheMarche.objet || 'Non renseigné'}}</td>
                     <td @dblclick="afficherModalModifierTypePrestation(index)">
                   {{marche.AfficheMarche.reference_marche || 'Non renseigné'}}</td>
                   <!-- <td @dblclick="afficherModalModifierTypePrestation(index)">
                   {{marche.numero_marche || 'Non renseigné'}}</td> -->
                     <td @dblclick="afficherModalModifierTypePrestation(index)" style="text-align: center;">
                   {{formatageSomme(parseFloat(marche.AfficheMarche.montant_marche)) || 'Non renseigné'}}</td>
                  
<td>
                     <button 
                      v-if="marche.AfficheMarche.attribue == 1"  class="btn  btn-success">
                <span >OUI</span>
  ...
  <!-- <router-link :to="{ name: 'Engagement', params: { id: marche.id }}"
                class="btn btn-default " title="Detail Engagement">
                  <span class=""><i class=" icon-folder-close"></i></span>
                   ...
                   <button   class="btn btn-danger " title="aller
                    en contratualisation" @click="afficherModalModifierActeEffetFinancier(index)">
                ...
                <span class=""><i class="icon-trash"></i></span></button>
                      ...
                      <td>
                       ...
                       <td  style="text-align: center;color:red;font-weight:bold;">
                           ...
                           {{formatageSomme(parseFloat(montantMarche1))}}
...
<td>
                     <button 
                      ...
                      v-if="marche.marche_id == 1"  class="btn  btn-warning">
...
<div id="tab100" class="tab-pane ">
              ...
              <!-- <div align="right">
                ...
                <tbody>
                   <tr class="odd gradeX" v-for="(marche, index) in afficherMarchePlanifier"
                ...
                <span class=""><i class="icon-trash"></i></span></button>
                      ...
                      <td>
                       ...
                       <td  style="text-align: center;color:red;font-weight:bold;">
                           ...
                           {{formatageSomme(parseFloat(montantMarchePlanifier))}}
...
export default {
  ...
  computed: {
     ...mapGetters("bienService", ['mandats','getMandatPersonnaliserVise','getActeEffetFinancierPersonnaliser45','getActeEffetFinancierPersonnaliser','acteEffetFinanciers','montantPlanifier','montantContratualisation','afficheContratualisation','affichePlanifier','nombremarchesExecute',
     'afficheMarchePlanifier','afficheMarcheContratualisation','AfficheMarcheAttribue','AfficheMarcheNonAttribue','nombreTotalMarche','marches','typeMarches', 'getMarchePersonnaliser',

     "montantMarche", "gettersMarcherPersonnaliser","typeActeEffetFinanciers","text_juridiques",
     "procedurePassations","typeTypeProcedures","printMarcheNonAttribue"]),
...
//     return this.gettersMarcherPersonnaliser.filter(element => element.type_marche.libelle == "Prestations Intellectuelles")
//     },
...
// return this.gettersMarcherPersonnaliser.filter((item) => {
...
// afficher la liste de marche
afficherListeMarche(){
return this.gettersMarcherPersonnaliser.filter(element => element.type_marche.code_type_marche == 4)
},
// le nombre de marche
nombreMarche(){
  return this.afficherListeMarche.length
},
// le montant du marche
 montantMarche1(){
return this.afficherListeMarche.reduce((prec, cur)=> parseFloat(prec) + parseFloat(cur.montant_marche),0)
 },

 // afficher la liste du marche planifier
 afficherMarchePlanifier(){
   return this.affichePlanifier.filter( element => element.type_marche.code_type_marche == 4)
 },

// affiche le nombre de marche planifier
nombreMarchePlanifier(){
  return this.afficherMarchePlanifier.length
},

// afficher le montant du marche planifier

montantMarchePlanifier(){
  return this.afficherMarchePlanifier.reduce((prec, cur)=> parseFloat(prec) + parseFloat(cur.montant_marche),0)
},
