         ...
         <div id="infoPV" class="modal hide grdirModalActeEffet">
                  ...
                  <div class="modal-body" v-if="resultaAnalysePv">
                      ...
                      <h4> super, le classement effectué avec success
                               donc nous  passerons à l'attribution du marché en choisisant le moins disant mercie!</h4>
                  </div>
                  <div class="modal-footer">
...
export default {
 name:'compte',
    ...
    computed: {
            ...
            "gettersCotations","rapportDocuments", 'listeJugementPersonnel','getterAnalyseDossiers']),
...
//             },
 listeRapport() {
     ...
     // afficher le classement du candidat dans le bien service

    //  afficherClassementCandidat(){
    //      let varObjet= this.getterAnalyseDossiers.filter(
    //          comparer => comparer.difference_personnel_bienService=="bienservice"
    //      )
    //      return varObjet;
    //  }
        ...
        'ajouterRapportJugement','modifierRapportJugement']),
         ...
         afficherModalRapportJugement(index){
           ...
           infoPVAffiche(ref){
                ...
                let resulta=this.getterAnalyseDossiers.filter(item=>item.reference_pv==ref && item.difference_personnel_bienService=="bienservice");
