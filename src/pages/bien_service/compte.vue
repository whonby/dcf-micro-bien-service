        ...
        <table class="table table-bordered table-striped">
          <tr>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <select v-model="formData.fournisseur_id" >
            ...
            <td>
             ...
             <td>
              <div class="control-group">
                <label class="control-label">Nature Compte</label>
                <div class="controls">
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <input
                   ...
                   v-model="formData.numero_compte"
                    class="span"
              ...
              <td>
              <div class="control-group">
                <label class="control-label">date_ouverture_compte</label>
                <div class="controls">
                  <input
                    type="date"
                    
                   v-model="formData.date_ouverture_compte"
                    class="span"
             ...
             <td>
              <div class="control-group">
                <label class="control-label">signataire_compte</label>
                <div class="controls">
                  <input
                    type="text"
                    
                   v-model="formData.signataire_compte"
                    class="span"
          ...
          <tr>
               <td>
              <div class="control-group">
                <label class="control-label">numero_agence</label>
                <div class="controls">
                  <input
                    type="text"
                    
                   v-model="formData.numero_agence"
                    class="span"
            ...
            <td>
             ...
             <td>
              <div class="control-group">
                <label class="control-label">situation_geo_agence</label>
                <div class="controls">
                  <input
                    type="text"
                    v-model="formData.situation_geo_agence"
              ...
              <table class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th>id_banque</th>
                    <th>date_ouverture_compte</th>
                    <th>signataire_compte</th>
                     <th>nature_compte</th>
                    <th>agence</th>
                    <th>situation_geo_agence</th>
                    <th>numero_agence</th>
