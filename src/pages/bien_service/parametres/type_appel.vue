...
export default {
  ...
  computed: {
     ...mapGetters("bienService", ['typeAppelOffre']),
    filtre_equipement() {
      const st = this.search.toLowerCase();
      return this.typeAppelOffre.filter(type => {
        return (
  ...
  methods: {
    ...
    afficherModalAjouterTitre() {
     ...
     this.ajouterTypeAppel(this.formData)
  ...
  this.modifierTypeAppel(this.editTypeAppel)
