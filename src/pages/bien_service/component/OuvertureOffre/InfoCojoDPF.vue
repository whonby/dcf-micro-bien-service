...
<hr>
    <StructureDAODP :macheid="macheid"></StructureDAODP>
            ...
            <table class="table">
              ...
              <tr>
                <td>
                  ...
                  >
                   <input type="hidden" v-model="diff"/>
                  </model-list-select>
...
import StructureDAODP from "./StructureDAODP";
import {  ModelListSelect } from 'vue-search-select'
import 'vue-search-select/dist/VueSearchSelect.css'
import {noDCfNoAdmin} from "../../../../Repositories/Auth"
export default {
name: "InfoCojo",
  components: {StructureDAODP,ModelListSelect,},
  props:["macheid"],
