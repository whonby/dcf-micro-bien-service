      ...
      <table class="table table-bordered table-striped" v-if="macheid">
        ...
        <tr class="odd gradeX" >
          ...
          <td @click="afficherModalModifierActeEffetFinancier(effetFinancier.id)"  style="text-align:center;font-size:14px;background: green;color: white">
            ...
            <td @click="afficherModalModifierActeEffetFinancier(effetFinancier.id)" v-if="effetFinancier.observation==1" style="background: green;color: white">CONFORME </td>
          <td @click="afficherModalModifierActeEffetFinancier(effetFinancier.id)" v-else-if="effetFinancier.observation==''" style="background: blue;color: white"> En attente d'analyse</td>
          <td @click="afficherModalModifierActeEffetFinancier(effetFinancier.id)" v-else  style="background: red;color: white" >NON CONFORME {{effetFinancier.observation}}</td>
