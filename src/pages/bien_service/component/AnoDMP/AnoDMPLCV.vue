...
<td @click="afficheDemandeDAO(demande.id)">
  ...
  <div id="ajouterAvisDmpLCV" class="modal hide grdirModalActeEffet" >
...
<form class="form-horizontal">
        <div class="control-group">
          ...
          <div class="controls">
            ...
            <input
                type="text"
                :value="affichierReferenceAppelOffre1(macheid)"
                class="span"
                readonly
            />
          </div>
        ...
        <div class="control-group">
          <label class="control-label">Ref facture proforma</label>
          <div class="controls">
...
affichierPvMarche() {
    ...
    affichierReferenceAppelOffre() {
     ...
     affichierReferenceAppelOffre1() {
      return id => {
        if (id != null && id != "") {
          const qtereel = this.appelOffres.find(qtreel => qtreel.marche_id == id && qtreel.ref_sigva!=null);

          if (qtereel) {
            return qtereel.ref_facture_proformat;
          }
          return 0
        }
      };
...
afficheDemandeDAO(index){
      ...
      this.edite_demande_dao=this.getterDemandeAno.find(demandeAno =>demandeAno.id == index)
