<template>
  <div>
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td @dblclick="editeMarcheLot(marche.id)">
                      {{
                        afficherLibelleLocalisationGeographie(
                          marche.localisation_geographie_id
                        ) || "Non renseigné"
                      }}
                    </td>
                    <td @dblclick="editeMarcheLot(marche.id)">
                    ...
                    <td
                      @dblclick="editeMarcheLot(marche.id)"
                      style="
                        text-align: center;
                        color: #000000;
                        font-weight: bold;
                  ...
                  <tr>
                    ...
                    >
                      {{ formatageSomme(parseFloat(SommeDesLots(macheid))) }}
                    </td>
                    <td></td>
                  </tr>
                </tbody>
          ...
          <tr>
            ...
            <td colspan="2">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" v-model="formData.objet" class="span12" />
                </div>
              </div>
            </td>
          </tr>
          <tr>
            <td>
              <div class="control-group">
                ...
                <code
                  v-if="
                    sommeMontant(formData.montant_marche) >
                ...
                <code
                  ...
                  "
                >
                  Car le montant total des lots est supperieur
                </code>
                <code
                  v-if="
                    sommeMontant(formData.montant_marche) >
                ...
                <table
                  ...
                  v-if="formData.montant_marche != 0"
                >
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        {{
                          formatageSomme(
                            parseFloat(detail_marche.montant_marche)
                          )
                        }}
                      </td>
                      <td>
                        {{
                          formatageSomme(
                            parseFloat(sommeMontant(formData.montant_marche))
                          )
                        }}
                      </td>
                    </tr>
            ...
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select
                    v-model="formData.localisation_geographie_id"
                    class="span"
                  >
                    <option
                      v-for="plans in afficherCodeStructureLibelle(
                        recupererLataille
                      )"
                      :key="plans.id"
                      :value="plans.id"
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <select
                    ...
                    class="span"
                    :readOnly="deveroiullage"
                  >
                    <option
                      v-for="plans in recupererParentId(
                        formData.localisation_geographie_id
                      )"
                      :key="plans.id"
                      :value="plans.id"
                    >
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select
                    v-model="formData.sous_prefecture_id"
                    class="span"
                    :readOnly="deveroiullageSousprefecture"
                  >
                    <option
                      v-for="plans in recupererParentId(
            ...
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" v-model="formData.latitude" class="span" />
                </div>
              </div>
            </td>
            <td>
          ...
          <tr>
            ...
            <td colspan="2">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" v-model="formData.livrable" class="span" />
                </div>
              </div>
            </td>
          </tr>
    ...
    <div
      id="editBailleuMarche"
      class="modal hide grdirModalActeEffet78"
      aria-hidden="true"
      style="display: none"
    >
      <div class="modal-header">
          ...
          <tr>
            ...
            <td colspan="2">
              <div class="control-group">
                <label class="control-label">Objet du lot</label>
                <div class="controls">
                  <input type="text" v-model="editor.objet" class="span" />
                </div>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select
                    v-model="editor.localisation_geographie_id"
                    class="span"
                  >
                    <option
                      v-for="plans in afficherCodeStructureLibelle(
            ...
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select
                    v-model="editor.departement_id"
                    class="span"
                    :readOnly="deveroiullage"
                  >
                    <option
                      v-for="plans in recupererParentId(
                        editor.localisation_geographie_id
                      )"
                      :key="plans.id"
                      :value="plans.id"
                    >
          ...
          <tr>
            <td>
              <div class="control-group">
                ...
                <div class="controls">
                  <select
                    v-model="editor.sous_prefecture_id"
                    class="span"
                    :readOnly="deveroiullageSousprefecture"
                  >
                    <option
                      v-for="plans in recupererParentId(editor.departement_id)"
                      :key="plans.id"
                      :value="plans.id"
                    >
                      {{ plans.libelle }}
            ...
            <td>
              <div class="control-group">
                <label class="control-label">Latitude</label>
                <div class="controls">
                  <input type="text" v-model="editor.latitude" class="span" />
                </div>
              </div>
            </td>
            <td>
              <div class="control-group">
                <label class="control-label">Longitude</label>
                <div class="controls">
                  <input type="text" v-model="editor.longitude" class="span" />
                </div>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="2">
              <div class="control-group">
                <label class="control-label">Livrables</label>
                <div class="controls">
                  <input type="text" v-model="editor.livrable" class="span" />
                </div>
              </div>
            </td>
          </tr>
      ...
      <div class="modal-footer">
        <a @click.prevent="modification()" class="btn btn-primary" href="#"
          >Modification</a
        >
        <a data-dismiss="modal" class="btn" href="#">Fermer</a>
      </div>
...
export default {
  ...
  computed: {
    ...
    SommeDesLots() {
      return (id) => {
        if (id != null && id != "") {
          return this.getMarchePersonnaliser
  ...
  methods: {
    ...
    ajouter() {
      ...
      this.formData = {
        ...
        date_transmission_dao_dmp_prevu: this.detail_marche
          .date_transmission_dao_dmp_prevu,
        ...
        date_lettre_invitation_prevu: this.detail_marche
          .date_lettre_invitation_prevu,
        date_reception_offre_prevu: this.detail_marche
          .date_reception_offre_prevu,
        date_ouverture_offre_technique_prevu: this.detail_marche
          .date_ouverture_offre_technique_prevu,
        date_rapport_ouverture_prevu: this.detail_marche
          .date_rapport_ouverture_prevu,
        date_ouverture_offre_finnancier_prevu: this.detail_marche
          .date_ouverture_offre_finnancier_prevu,
        date_jugement_offre_prevu: this.detail_marche.date_jugement_offre_prevu,
        date_rapport_evaluation_combine_prevue: this.detail_marche
          .date_rapport_evaluation_combine_prevue,
        date_demande_ano_dmp_prevue: this.detail_marche
          .date_demande_ano_dmp_prevue,
        date_ano_dmp_attribution_prevue: this.detail_marche
          .date_ano_dmp_attribution_prevue,
        date_negociation_prevue: this.detail_marche.date_negociation_prevue,
        date_signature_attributaire_prevue: this.detail_marche
          .date_signature_attributaire_prevue,
        date_signature_autorite_contractante_prevue: this.detail_marche
          .date_signature_autorite_contractante_prevue,
        date_approbation_marche_prevue: this.detail_marche
          .date_approbation_marche_prevue,
        date_execution_marche_debut_prevue: this.detail_marche
          .date_execution_marche_debut_prevue,
    ...
    editeMarcheLot(index) {
      ...
      this.editor = this.getMarchePersonnaliser.find(
        (item) => item.id == index
      );
    },
    modification() {
