...
<template>
    <div>
                ...
                <div class="span12">
                    <div class="widget-box">
                        <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
                            <h5>Liste des modes passations</h5>
                            <div align="right">
                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr class="odd gradeX" v-for="(item, index) in titreFiltres" :key="item.id">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button @click.prevent="supprimerModePassation(item.id)"  class="btn btn-danger ">
        ...
        <fab :actions="fabActions"
             ...
             bg-color="green"
             main-icon="apps"
             v-shortkey="['ctrl', 'alt', 'o']" @shortkey="theAction()"
        ></fab>
...
// methode pour maper notre guetter
            ...mapGetters('gestionMarche', ['mode_passations']),
            titreFiltres() {

                const searchTerm = this.search.toLowerCase();

                return this.mode_passations.filter((item) => {
        ...
        methods: {
            ...
            ...mapActions('gestionMarche', ['getModePassation',"ajouterModePassation","supprimerModePassation","modifierModePassation"]),
...
// afficher modal
            afficherModalModifierTitre(index){
                ...
                this.editTitre = this.mode_passations[index];

            },
            modifier(){
                this.modifierModePassation(this.editTitre)
                //this.getFonctions()
            }
        }
    };
