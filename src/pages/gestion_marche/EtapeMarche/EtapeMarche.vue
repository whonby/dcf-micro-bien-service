                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr class="odd gradeX" v-for="(item, index) in titreFiltres" :key="item.id">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button @click.prevent="supprimerEtapeMarche(item.id)"  class="btn btn-danger ">
...
// methode pour maper notre guetter
            ...mapGetters('gestionMarche', ['etape_marches']),
            titreFiltres() {

                const searchTerm = this.search.toLowerCase();

                return this.etape_marches.filter((item) => {
        ...
        methods: {
            ...
            ...mapActions('gestionMarche', ['getEtapeMarche',"ajouterEtapeMarche","supprimerEtapeMarche","modifierEtapeMarche"]),
            ...
            ajouterTitreLocal () {
                this.ajouterEtapeMarche(this.formData)
                this.formData = {
                    code: "",
                    libelle: ""
                }
...
// afficher modal
            afficherModalModifierTitre(index){
                ...
                this.editTitre = this.etape_marches[index];

            },
            modifier(){
                this.modifierEtapeMarche(this.editTitre)
                //this.getFonctions()
            }
        }
    };
