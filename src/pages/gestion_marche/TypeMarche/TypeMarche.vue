                        ...
                        <div class="widget-content nopadding">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr class="odd gradeX" v-for="(item, index) in titreFiltres" :key="item.id">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button @click.prevent="supprimerTypeMarche(item.id)"  class="btn btn-danger ">
...
// methode pour maper notre guetter
            ...
            titreFiltres() {
                ...
                return this.type_marches.filter((item) => {
...
// afficher modal
            afficherModalModifierTitre(index){
                ...
                this.editTitre = this.type_marches[index];

            },
            modifier(){
                this.modifierTypeMarche(this.editTitre)
                //this.getFonctions()
            }
        }
    };
