      ...
      <div class="span12">
                                        ...
                                        <download-excel
                                            ...
                                            style="cursor:pointer;"
                                              :fields = "json_fields"
                                              title="Liste plan des Actes "
                                              name ="Liste plan des Actes"
                                              worksheet = "plan des Actes"
        ...
        Rechercher: <input type="text" v-model="search">
           ...
           <div class="widget-content ">
            <!-- <table class="table table-bordered table-striped">
              ...
              <div class="btn-group">
              <button @click.prevent="supprimerPlanActe(plan_fonctionnel.id)"  class="btn btn-danger ">
...
<!----- ajouter modal   ---->
 ...
 <div id="exampleModal" class="modal hide">
           ...
           <div class="modal-footer"> 
             <button v-show="formData.structure_Acte_id && 
 ...
 <div id="modalAjouterElementEnfant" class="modal hide">
             ...
             <div class="control-group">
              ...
              <select v-model="nouvelElementEnfant.structure_Acte_id" >
                <option v-for="structure in structureActe " :key="structure.id" 
           ...
           <div class="modal-footer"> 
             ...
             nouvelElementEnfant.structure_Acte_id"
...
<!----- modifier modal debut  ---->
 ...
 <div id="modifierModal" class="modal hide">
             ...
             <button data-dismiss="modal" class="close" type="button">×</button>
              ...
              <label class="control-label">Structure des Actes:</label>
              <div class="controls">
                <select  v-model="editTitre.structure_Acte_id">
            <option v-for="plan in structureActe" :key="plan.id" 
            :value="plan.id">{{plan.libelle}}</option>
                </select>
              </div>
           ...
           <div class="modal-footer"> 
             <button v-show="editTitre.structure_Acte_id && editTitre.code.length && 
...
// methode pour maper notre guetter
  ...
  'planActe']),
   ...
   lesPlansParents(){
     return this.planActe.filter(plan => plan.parent == null)
   },
...
return this.planActe.filter((item) => {
...
getColumns() {
    return [
      ...
      this.ajouterPlanActe(this.nouvelElementEnfant)
    ...
    supprimerPlanProgrammeLocal(item){
      this.supprimerPlanActe(item.id)
    },
// afficher modal

 //afficher modal pour ajouter element enfant
	 ajouterElementEnfant(item) {
    this.parentDossier = this.planActe.find(plan => plan.id == item.id)
 ...
 // fin
    ...
    'ajouterPlanActe','supprimerPlanActe', 'modifierPlanActe']),     
   ...
   // fonction pour vider l'input
    ajouterTitreLocal () {
      this.ajouterPlanActe(this.formData)
...
this.editTitre = this.planActe.find(plan => plan.id == item.id);

        
 },
modifierLocalisationLocal(){
  this.modifierPlanActe(this.editTitre)
