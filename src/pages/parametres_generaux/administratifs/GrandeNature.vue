...
<template>
  <div>
        ...
        <div class="span12">
          <div>
            ...
            <h5
              ...
              "
            >
              Liste des grandes natures de dépenses
            </h5>

            <div align="right" style="cursor: pointer">
              <button
                class="btn btn-success"
                @click.prevent="afficherModalAjouterGrandeNature()"
              >
                AJOUTER
              </button>
            </div>
            ...
            <div class="widget-content nopadding">
              ...
              >
                ...
                <tbody>
                  <tr
                    class="odd gradeX"
                    v-for="grande_nature in partition(titreFiltres, size)[page]"
                    :key="grande_nature.id"
                  >
                    <td
                      @dblclick="afficherModalModifierGrande(grande_nature.id)"
                    >
                      {{ grande_nature.code || "Non renseigné" }}
                    </td>
                    <td
                      @dblclick="afficherModalModifierGrande(grande_nature.id)"
                    >
                      {{ grande_nature.libelle || "Non renseigné" }}
                    </td>
                    <td>
                      <button
                        @click.prevent="
                          afficherModalModifierGrande(grande_nature.id)
                        "
                        class="btn btn-info"
                      >
                    ...
                    <td>
                      <button
                        @click.prevent="supprimerGrandeNature(grande_nature.id)"
              ...
              <div v-if="titreFiltres.length"></div>
              <div v-else>
                <div align="center">
                  <h6 style="color: red">
                    Aucune grande nature de dépense enregistrée
                  </h6>
                </div>
              </div>
            </div>
          ...
          <div class="pagination alternate">
            <ul>
              ...
              <li
                v-for="(titre, index) in partition(titreFiltres, size).length"
                :key="index"
              ...
              <li
                :class="{
                  disabled: page == partition(titreFiltres, size).length - 1,
                }"
              >
    ...
    <div id="modifierModal" class="modal hide">
      ...
      <div class="modal-footer">
        <button
          @click.prevent="modifierGrandeNatureLocal(editTitre)"
          class="btn btn-primary"
          href="#"
        >
          Modifier
    ...
    <button
      ...
      @shortkey="afficherModalAjouterGrandeNature()"
    >
      Open
    </button>
...
export default {
  ...
  computed: {
    ...
    verifcode() {
      if (this.formData.code == "") {
        ...
        let Objet = this.grandes_natures.filter(
  ...
  methods: {
    ...
    ...mapActions("parametreGenerauxAdministratif", [
      "getGrandeNature",
      "ajouterGrandeNature",
      "supprimerGrandeNature",
      "modifierGrandeNature",
    ]),
