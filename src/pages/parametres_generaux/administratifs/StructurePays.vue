      ...
      <div class="span12">
                                        ...
                                        <download-excel
                                            ...
                                            style="cursor:pointer;"
                                              :fields = "json_fields"
                                              title="Liste structure pays "
                                              name ="Liste structure pays"
                                              worksheet = "structure pays"
        ...
        Rechercher: <input type="text" v-model="search">
           ...
           <div class="widget-content nopadding">
            ...
            <div v-else>
              <div align="center">
              <h4 style="color:red;">Aucune structure pays trouvée</h4>
              </div>
          </div>
           </div>
        </div>
...
<!----- modifier modal debut  ---->
 ...
 <div id="modifierModal" class="modal hide">
           ...
           <div class="modal-footer"> 
             <button
              @click.prevent="modifierModalStructurepaysLocal(editpays)" class="btn btn-primary"
              >Modifier</button>
...
return this.getterstructures_pays.filter((item) => {
  ...
  methods: {
   ...
   'ajouterStructurePays','modifierStructurePays','supprimerStructurePays']), 
  ...
  // doc.autoTable({ html: this.natures_sections })
   var data = this.getterstructures_pays;
    doc.text(98,10,"Liste strucres pays")
...
getColumns() {
    ...
    afficherModalajouterStructurePays(){
...
afficherModalModifierStructure(index){
 ...
 modifierModalStructurepaysLocal(){
   this.modifierStructurePays(this.editpays)
