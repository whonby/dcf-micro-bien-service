    ...
    <div class="row-fluid">
      <div class="span12">
           ...
           <button class="btn btn-info" @click.prevent="genererEnPdf()">Exporter en PDF</button>
                                     ...
                                     <table>
                                       <tr>
                                         <h5 style="font-size:20px;text-transform: uppercase; text-align:center;text-decoration: underline;">Liste des structures géographiques</h5>
                                       </tr>
                                     </table> 
                                     <div align="right" style="cursor:pointer;">
           <button class="btn btn-success" @click.prevent="afficherModalAjouterStructureGeographique()">AJOUTER STRUCTURE</button>
          </div>       
          ...
          <!-- <div class="span4">
           ...
           <div class="widget-content nopadding">
            <table class="table table-bordered table-striped">
              ...
              <button  @click.prevent="afficherModalModifierService(structure_geographique.id)"  class="btn btn-info " >
