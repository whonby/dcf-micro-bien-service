  ...
  <div>
        ...
        <div class="span12">
          <div>
            ...
            <h5
              ...
              "
            >
              Liste des types d'unité administrative
            </h5>
            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr
                    class="odd gradeX"
                    v-for="titre in partition(
                      typeUniteAdminitrativeFiltre,
                      size
                    )[page]"
                    :key="titre.id"
                  >
                    <td @dblclick="afficherModalModifierTitre(titre.id)">
                      {{ titre.libelle || "Non renseigné" }}
                    </td>
                    <td>
                      <button
                        @click.prevent="afficherModalModifierTitre(titre.id)"
                        class="btn btn-info"
                      >
                        <span class>
                    ...
                    <td>
                      <button
                        @click.prevent="
                          supprimerTypeUniteAdministrative(titre.id)
                        "
          ...
          <div class="pagination alternate">
            <ul>
              ...
              <li
                v-for="(titre, index) in partition(
                  typeUniteAdminitrativeFiltre,
                  size
                ).length"
                :key="index"
              ...
              <li
                :class="{
                  disabled:
                    page ==
                    partition(typeUniteAdminitrativeFiltre, size).length - 1,
                }"
              >
    ...
    <div id="exampleModal" class="modal hide">
      ...
      <div class="modal-footer">
        <button
          v-show="formData.libelle.length > 2"
    ...
    <div id="modifierModal" class="modal hide">
      ...
      <div class="modal-footer">
        <a
          @click.prevent="modifierTitreLocal(editTitre)"
          class="btn btn-primary"
          href="#"
          >Modifier</a
        >
...
export default {
  ...
  methods: {
    ...
    getColspan() {
      return [{ title: "LIBELLE", dataKey: "libelle" }];
    },
