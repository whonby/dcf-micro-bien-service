  ...
  <div>
          ...
          <div>
            ...
            <div align="right" style="cursor: pointer">
              <button
                ...
                @click.prevent="afficherModalAjouterTypeFinancement()"
              >
                AJOUTER
              </button>
            </div>
            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered table-striped" id="type_fin">
                ...
                <tbody>
                  <tr
                    class="odd gradeX"
                    v-for="types in partition(localisationsFiltre, size)[page]"
                    :key="types.id"
                  >
                    <td
                      @dblclick="afficherModalModifierTypefinancement(types.id)"
                    >
                      {{ types.code || "Non renseigné" }}
                    </td>
                    <td
                      @dblclick="afficherModalModifierTypefinancement(types.id)"
                    >
                      {{ types.libelle || "Non renseigné" }}
                    </td>
                    ...
                    <td>
                      <button
                        @click.prevent="
                          afficherModalModifierTypefinancement(types.id)
                        "
                        class="btn btn-info"
                      >
                    ...
                    <td>
                      <button
                        @click.prevent="supprimerTypeFinancement(types.id)"
    ...
    <div id="exampleModal" class="modal hide">
      ...
      <div class="modal-footer">
        <button
          v-show="formData.code.length && formData.libelle.length > 2"
    ...
    <div id="modifierModal" class="modal hide">
      ...
      <div class="modal-footer">
        <button
          @click.prevent="modifierLocalisationLocal(editTitre)"
          class="btn btn-primary"
        >
          Modifier
        </button>
        <button data-dismiss="modal" class="btn">Fermer</button>
      </div>
    </div>
    ...
    <button
      ...
      @shortkey="afficherModalAjouterTypeFinancement()"
    >
      Open
    </button>
  ...
  computed: {
    ...
    localisationsFiltre() {
      ...
      if (this.formData.code == "") {
        ...
        let Objet = this.types_financements.filter(
