...
<div id="ajouterLettreInvitationP" class="modal hide grdirModalActeEffet">
                    ...
                    <table class="table table-bordered table-striped">
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            />
                            <input type="hidden" v-model="formLettre.difference_personnel_bienService"/>
                        </div>
                    </div>
                        </td>
                        <td >
                ...
                <table class="table table-bordered table-striped">
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <td >
                          <div class="control-group">
                        <label class="control-label">Référence lettre</label>
                        <div class="controls">
                            <input
                                    type="text"
                        ...
                        <div class="controls">
                            <input
                                    ...
                                    placeholder="Saisir email bailleur"
                            />
                            <input type="hidden" v-model="edite_Lettre_invitation.difference_personnel_bienService"/>
                        </div>
                    </div>
                        </td>
                        <td >
    ...
    created(){},
       ...
       computed: {
            ...
            ...mapGetters("bienService", [ "typeTypeProcedures","typeCandidat",'acteDepense',"getMarchePersonnaliser","appelOffres","lots",
                "modePassations", "procedurePassations","getterDossierCandidats","marches","getterLettreInvitation",
                "getterOffreFinanciers","gettersOffreTechniques","listeLettreInvitationPersonnel",
