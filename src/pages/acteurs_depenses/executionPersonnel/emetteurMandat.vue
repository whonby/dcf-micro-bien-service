...
<template>
    <div>
<div id="modalMandatPrso" class="modal hide">
        ...
        <form class="form-horizontal" >
          <!-- <div class="control-group">
                            ...
                            <div class="controls">
                              ...
                              <option value="2017">Vis&eacute;</option>
                             <option value="2117">Diff&eacute;r&eacute;</option>
                             <option value="2217">R&eacute;jet&eacute;</option>
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <textarea  class="span" row = "6" v-model="editMandatPerso.observation_emetteur">
                              </textarea>
                            </div>
                          </div>
                           <div class="control-group">
                            ...
                            <div class="controls">
                              <input type="date" class="span"  v-model="editMandatPerso.date_decision_emetteur"/>
                ...
                <tbody>
                   <tr class="odd gradeX" v-for="(item,index) in listeMandatPerso(PaiementPersoid)" :key="item.id">
                      ...
                      <span    >Vis&eacute;</span>
                       ...
                       <button v-else-if="item.decision_emetteur == 2117" class="btn  btn-warning" @click="afficheMandatPerso(index)">                        
                       ...
                       <span  >Diff&eacute;r&eacute;</span>
                        ...
                        <button v-else-if="item.decision_emetteur == 2217" class="btn  btn-danger" @click="afficheMandatPerso(index)">                        
                     ...
                     <button v-else class="btn  btn-info" @click="afficheMandatPerso(index)" >                        
...
afficheMandatPerso(index) {
      this.$("#modalMandatPrso").modal({
        backdrop: "static",
        keyboard: false
      })
