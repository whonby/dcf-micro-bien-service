...
<div id="modalDecisionEmetteur" class="modal hide">
      <div class="modal-header">
        ...
        <h3>Ajouter Observation Emetteur</h3>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" >
          <!-- <div class="control-group">
                            ...
                            <div class="controls">
                              <select v-model="editLiquidationEmetteur.decision_emetteur">
                                <option value="0">Attente</option>
                              <option value="201">Vis&eacute;</option>
                             <option value="211">Diff&eacute;r&eacute;</option>
                             <option value="221">R&eacute;jet&eacute;</option>
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <textarea  class="span" row = "6" v-model="editLiquidationEmetteur.observation_emetteur">
                              </textarea>
                            </div>
                          </div>
                           <div class="control-group">
                            ...
                            <div class="controls">
                              <input type="date" class="span"  v-model="editLiquidationEmetteur.date_emetteur"/>
      ...
      <div class="modal-footer">
        <a
          @click.prevent="modifierLiquidationPerso(editLiquidationEmetteur)"
                ...
                <tbody>
                   <tr class="odd gradeX" v-for="(item,index) in listeLiquidationPerso(PaiementPersoid)" :key="item.id">
                    ...
                    <td>{{formaterDate(item.date_emetteur) || 'Non renseign&eacute;'}}</td>
                                    <td>
                                      <button  class="btn  btn-success" @click="afficherModalObservationEmetteur(index)">
                        <span>
...
afficherModalObservationEmetteur(index) {
      this.$("#modalDecisionEmetteur").modal({
        backdrop: "static",
        keyboard: false
      })
      this.editLiquidationEmetteur = this.listeLiquidationPerso(this.PaiementPersoid)[index];
  ...
  ligne_id:"",
     ...
     modifierLiquidationPerso() {
      ...
      var objetLiquidation = {
          ...this.editLiquidationEmetteur,
         numero_demande : this.editLiquidationEmetteur.numero_engage,
...
activite_id:this.afficherIdActivite(this.PaiementPersoid),
  ua_id:this.afficherIdUa(this.PaiementPersoid),
decision_emetteur:this.editLiquidationEmetteur.decision_emetteur,
...
marchetype:this.editLiquidationEmetteur.marchetype,
	paiementperso_id:this.PaiementPersoid,
       };
