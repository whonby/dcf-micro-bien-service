             ...
             <table class="card">
                     <tbody>
                                <tr  v-for="uabysection in ListeUniteAdminBySection" :key="uabysection.id" style="display: inline-block;">
                                        ...
                                        <div class="card" :title="uabysection.libelle" >
                                                    ...
                                                    <img :src="url_test_plein" alt="" sizes="5px;" srcset="" style="width:200px; height:200px; margin-left: 30px; margin-right:30px;">
                                                  <br>
                                        ...
                                        <div class="card" :title="uabysection.libelle" >
                                                    <!-- <li class="icon-folder-close" style="font-size: 55px !important;margin-right:35px;margin-left:35px;">{{nombremarcheByua(uabysection.id)}}</li> -->
                                                    <img :src="url_test_vide" alt="" sizes="5px;" srcset="" style="width:200px; height:200px; margin-left: 30px; margin-right:30px;">
                                                  <br>
                                                  <p :title="uabysection.libelle" style="margin-left:35px;margin-right:35px;">{{uabysection.libelle.substr(0, 30)+'...'}}</p>  
                                                         <br>
                                                       <br>
        ...
        data() {
            return{
               ...
               url_test_vide:'data:image/jpeg;base64,',
                ...
                url1:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJi8L-m3hgnw8xbMY93159m81pP9bvjWLINQ&usqp=CAU',
                isLoading: false,
                fullPage: false,
                search:"",
                controlleur_fin:"",
