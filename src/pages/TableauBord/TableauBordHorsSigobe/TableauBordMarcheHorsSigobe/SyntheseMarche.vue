                ...
                <th
                  ...
                  >
                   ...
                   <th
                    ...
                    "
                  >
                    {{recupereIDactivite}}TAUX D’EXECUTION PHYSIQUE {{afficheAnnee}}
                  </th>
                </tr>
              </thead>
       <tbody>
                ...
                <td style="" v-bind:class="recupereIDactivite==GroupeSection.id ? 'graybg' : 'whitebg'"  colspan="4">{{libelleUniteAdministrative(GroupeSection.id)}}</td>
