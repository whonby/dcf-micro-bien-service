...
<template>
 ...
 <label
        ...
        <div id="printMe3">
          <h1 style="text-align:center;text-decoration: underline overline #000;">LISTES DES OP DEFINITIF DIFFERES</h1>
   ...
   listeOpdiffere() {
    ...
    listeordrepaiementProvisoire() {
      return this.gettersgestionOrdrePaiement.filter(
        (qtreel) => qtreel.diff_op == null && qtreel.unite_administrative_id == this.marcheid &&  qtreel.type_ordre_paiement==4 && qtreel.decision_cf ==2   && qtreel.exercice==this.anneeAmort
      );
    },
