   ...
   listeOpdiffere() {
    ...
    listeordrepaiementProvisoire() {
      return this.gettersgestionOrdrePaiement.filter(
        (qtreel) => qtreel.diff_op == null && qtreel.unite_administrative_id == this.marcheid &&  qtreel.type_ordre_paiement==3 && qtreel.decision_cf == 3  && qtreel.exercice==this.anneeAmort
      );
    },
