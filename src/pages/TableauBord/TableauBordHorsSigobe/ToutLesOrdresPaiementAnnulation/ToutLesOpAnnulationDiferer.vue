...
<template>
 ...
 <label
        ...
        <div id="printMe3">
          <h1 style="text-align:center;text-decoration: underline overline #000;">LISTES DES OP D'ANNULATION DIFERES</h1>
   ...
   listeOpdiffere() {
    ...
    listeordrepaiementProvisoire() {
      return this.gettersgestionOrdrePaiement.filter(
        (qtreel) => qtreel.diff_op == null  &&  qtreel.type_ordre_paiement==3 && qtreel.decision_cf == 2  && qtreel.exercice==this.anneeAmort
      );
    },
