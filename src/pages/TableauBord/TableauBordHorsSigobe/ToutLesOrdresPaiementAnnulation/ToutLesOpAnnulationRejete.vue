...
<template>
 ...
 <label
        ...
        <div id="printMe3">
          <h1 style="text-align:center;text-decoration: underline overline #000;">LISTES DES OP D'ANNULATIONS REJETES</h1>
        
    <table class="table table-bordered table-striped">
                <thead>
                  <tr>
                  <th style="font-size:14px;font-weight:bold;background-color: red;color:#fff">Execice</th>
                       <th style="font-size:14px;font-weight:bold;background-color: red;color:#fff">Ua</th>
                       <th style="font-size:14px;font-weight:bold;background-color: red;color:#fff">Grande Nature</th>
                   <th style="font-size:14px;font-weight:bold;background-color: red;color:#fff">N°Ordre paiement</th>
                   <th style="font-size:14px;font-weight:bold;background-color: red;color:#fff">Objet ordre de paiement </th>
                    <th style="font-size:14px;font-weight:bold;background-color: red;color:#fff">Montant Engagé(FCFA)</th>
                    <th style="font-size:14px;font-weight:bold;background-color: red;color:#fff">Détail</th>
                   
                     <th style="font-size:14px;font-weight:bold;background-color: red;color:#fff">Decision CF</th>
                     <th style="font-size:14px;font-weight:bold;background-color: red;color:#fff" colspan="2">Action</th>
                  </tr>
                </thead>
                <tbody>
                   <tr
   ...
   listeOpdiffere() {
    ...
    listeordrepaiementProvisoire() {
      return this.gettersgestionOrdrePaiement.filter(
        (qtreel) => qtreel.diff_op == null  &&  qtreel.type_ordre_paiement==3 && qtreel.decision_cf == 3  && qtreel.exercice==this.anneeAmort
      );
    },
