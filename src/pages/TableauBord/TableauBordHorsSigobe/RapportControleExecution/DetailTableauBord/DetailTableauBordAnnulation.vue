              ...
              <div class="widget-box">
                ...
                <div class="widget-content tab-content">
                  ...
                  <div id="DEMANDE" class="tab-pane active" >
                    <h3 style="text-align:center">DETAIL OP ANNULATION : {{libelleUa(marcheid)}}</h3>
...
<!--                                              <div class="timeline-icon"><i class="fa fa-desktop" aria-hidden="true"></i></div>-->
           ...
           v-if="marcheid==0"   >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                    ...
                    <router-link :to="{ name: 'TableauOpAnnulation', params: { id: marcheid }}"
           v-if="marcheid!=0"     >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
           ...
           v-if="marcheid==0"   >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                    ...
                    <router-link :to="{ name: 'TableauOpAnnulationDiffere', params: { id: marcheid }}"
           v-if="marcheid!=0"     >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                                              </div>
 ...
 <div class="span3"  >
           ...
           v-if="marcheid==0"   >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                    ...
                    <router-link :to="{ name: 'TableauOpAnnulationRejete', params: { id: marcheid }}"
           v-if="marcheid!=0"     >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                                              </div>
           ...
           v-if="marcheid==0"   >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                    ...
                    <router-link :to="{ name: 'TableauOpAnnulationVise', params: { id: marcheid }}"
           v-if="marcheid!=0"     >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                                              </div>
           ...
           v-if="marcheid==0"   >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                    ...
                    <router-link :to="{ name: 'TableauOpAnnulationViseO', params: { id: marcheid }}"
           v-if="marcheid!=0"     >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                                              </div>
...
TauxOpProvisoireEnDiferer() {
    ...
    return val;
     ...
     NombreOpProvisoireEnAttend() {
      ...
      return (id) => {
        if (id != null && id != "") {
         return this.gettersgestionOrdrePaiement.filter(
            (qtreel) => qtreel.unite_administrative_id == id  && qtreel.exercice==this.anneeAmort && qtreel.type_ordre_paiement==3  && qtreel.diff_op == null && qtreel.decision_cf == 3).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
        }
        return this.gettersgestionOrdrePaiement.filter(qtreel =>  qtreel.type_ordre_paiement==3  && qtreel.exercice==this.anneeAmort && qtreel.diff_op == null && qtreel.decision_cf == 3).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
    ...
    MontantOpAnnulationRejete() {
      return (id) => {
        if (id != null && id != "") {
         return this.gettersgestionOrdrePaiement.filter(
            (qtreel) => qtreel.unite_administrative_id == id  && qtreel.exercice==this.anneeAmort && qtreel.type_ordre_paiement==3  && qtreel.diff_op == null && qtreel.decision_cf == 2).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
        }
        return this.gettersgestionOrdrePaiement.filter(qtreel =>  qtreel.type_ordre_paiement==3  && qtreel.exercice==this.anneeAmort && qtreel.diff_op == null && qtreel.decision_cf == 2).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
    ...
    MontantOpAnnulationVise() {
      return (id) => {
        if (id != null && id != "") {
         return this.gettersgestionOrdrePaiement.filter(
            (qtreel) => qtreel.unite_administrative_id == id  && qtreel.exercice==this.anneeAmort && qtreel.type_ordre_paiement==3  && qtreel.diff_op == null && qtreel.decision_cf == 8).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
        }
        return this.gettersgestionOrdrePaiement.filter(qtreel =>  qtreel.type_ordre_paiement==3  && qtreel.exercice==this.anneeAmort && qtreel.diff_op == null && qtreel.decision_cf == 8).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
    ...
    MontantOpAnnulationViseO() {
      return (id) => {
        if (id != null && id != "") {
         return this.gettersgestionOrdrePaiement.filter(
            (qtreel) => qtreel.unite_administrative_id == id  && qtreel.exercice==this.anneeAmort && qtreel.type_ordre_paiement==3  && qtreel.diff_op == null && qtreel.decision_cf == 9).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
        }
        return this.gettersgestionOrdrePaiement.filter(qtreel =>  qtreel.type_ordre_paiement==3  && qtreel.exercice==this.anneeAmort && qtreel.diff_op == null && qtreel.decision_cf == 9).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
    ...
    MontantOpProvisoireEnAttend() {
      return (id) => {
        if (id != null && id != "") {
         return this.gettersgestionOrdrePaiement.filter(
            (qtreel) => qtreel.unite_administrative_id == id  && qtreel.exercice==this.anneeAmort && qtreel.type_ordre_paiement==3  && qtreel.diff_op == null && qtreel.decision_cf == 0).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
        }
        return this.gettersgestionOrdrePaiement.filter(qtreel =>  qtreel.type_ordre_paiement==3  && qtreel.exercice==this.anneeAmort && qtreel.diff_op == null && qtreel.decision_cf == 0).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
