              ...
              <div class="widget-box">
                ...
                <div class="widget-content tab-content">
                  ...
                  <div id="DEMANDE" class="tab-pane active" >
                    <h3 style="text-align:center">DETAIL OP PROVISOIRE : {{libelleUa(marcheid)}}</h3>
...
<!--                                              <div class="timeline-icon"><i class="fa fa-desktop" aria-hidden="true"></i></div>-->
           ...
           v-if="marcheid==0"   >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                    ...
                    <router-link :to="{ name: 'TableauOpProvisoire', params: { id: marcheid }}"
           v-if="marcheid!=0"     >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                                      ...
                                      <div class="span3" >
                                          <div  class="single-timeline-content d-flex wow fadeInLeft" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInLeft; ">
                                               ...
                                               <div class="timeline-text">
                                                 ...
                                                 <br>
                                                  <p style="text-align:right;font-size:20px">Montant: {{formatageSomme(parseFloat(MontantOpProvisoireDiffere(marcheid)))}}</p>
                                                    <router-link :to="{ name: 'ToutLesOpProvisoireDiferer', params: {}}"
           v-if="marcheid==0"   >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                    <router-link :to="{ name: 'TableauOpProvisoireDiffere', params: { id: marcheid }}"
           v-if="marcheid!=0"     >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                                              </div>
                                          ...
                                          <div class="single-timeline-content d-flex wow fadeInLeft" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInLeft;">
                                             ...
                                             <div class="timeline-text">
                                                  ...
                                                  <br>
                                                   ...
                                                   <br>
                                                  <p style="text-align:right;font-size:20px">Montant: {{formatageSomme(parseFloat(MontantOpProvisoireRejete(marcheid)))}}</p>
                                                    <router-link :to="{ name: 'ToutLesOpProvisoireRejete', params: {}}"
           v-if="marcheid==0"   >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                    <router-link :to="{ name: 'TableauOpProvisoireRejete', params: { id: marcheid }}"
           v-if="marcheid!=0"     >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                                              </div>
                                            ...
                                            <div class="timeline-text">
                                               ...
                                               <p style="text-align:right;font-size:20px">Nombres: {{NombreOpProvisoireEnVise(marcheid)}}</p>
                                                  <br>
                                                   ...
                                                   <br>
                                                  <p style="text-align:right;font-size:20px">Montant: {{formatageSomme(parseFloat(MontantOpProvisoireVise(marcheid)))}}</p>
                                                   <router-link :to="{ name: 'ToutLesOpProvisoireVise', params: {}}"
           v-if="marcheid==0"   >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                    <router-link :to="{ name: 'TableauOpProvisoireVise', params: { id: marcheid }}"
           v-if="marcheid!=0"     >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                                              </div>
                                            ...
                                            <div class="timeline-text">
                                                ...
                                                <p style="text-align:right;font-size:20px">Nombres: {{NombreOpProvisoireEnViseO(marcheid)}}</p>
                                                  <br>
                                                   ...
                                                   <br>
                                                  <p style="text-align:right;font-size:20px">Montant: {{formatageSomme(parseFloat(MontantOpProvisoireViseO(marcheid)))}}</p>
                                                  <router-link :to="{ name: 'ToutLesOpProvisoireViseO', params: {}}"
           v-if="marcheid==0"   >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                    <router-link :to="{ name: 'TableauOpProvisoireViseO', params: { id: marcheid }}"
           v-if="marcheid!=0"     >
                  <button   class="btn  btn-danger" style="font-size:20px;text-align:right;" ><span class="" style="font-weight: bold;text-align:right;font-size:20px"> Voir Listes</span></button>
                   </router-link> 
                                              </div>
...
TauxOpProvisoireEnDiferer() {
    ...
    return val;
     ...
     NombreOpProvisoireEnAttend() {
      return (id) => {
       ...
       MontantOpProvisoireDiffere() {
      return (id) => {
        if (id != null && id != "") {
         return this.gettersgestionOrdrePaiement.filter(
            (qtreel) => qtreel.unite_administrative_id == id  && qtreel.exercice==this.anneeAmort && qtreel.type_ordre_paiement==2  && qtreel.diff_op == null && qtreel.decision_cf == 3).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
        }
        return this.gettersgestionOrdrePaiement.filter(qtreel =>  qtreel.type_ordre_paiement==2  && qtreel.exercice==this.anneeAmort && qtreel.diff_op == null && qtreel.decision_cf == 3).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
  
      };
    },
    MontantOpProvisoireRejete() {
      return (id) => {
        if (id != null && id != "") {
         return this.gettersgestionOrdrePaiement.filter(
            (qtreel) => qtreel.unite_administrative_id == id  && qtreel.exercice==this.anneeAmort && qtreel.type_ordre_paiement==2  && qtreel.diff_op == null && qtreel.decision_cf == 2).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
        }
        return this.gettersgestionOrdrePaiement.filter(qtreel =>  qtreel.type_ordre_paiement==2  && qtreel.exercice==this.anneeAmort && qtreel.diff_op == null && qtreel.decision_cf == 2).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
    ...
    MontantOpProvisoireVise() {
      return (id) => {
        if (id != null && id != "") {
         return this.gettersgestionOrdrePaiement.filter(
            (qtreel) => qtreel.unite_administrative_id == id  && qtreel.exercice==this.anneeAmort && qtreel.type_ordre_paiement==2  && qtreel.diff_op == null && qtreel.decision_cf == 8).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
        }
        return this.gettersgestionOrdrePaiement.filter(qtreel =>  qtreel.type_ordre_paiement==2  && qtreel.exercice==this.anneeAmort && qtreel.diff_op == null && qtreel.decision_cf == 8).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
  
      };
    },
    MontantOpProvisoireViseO() {
      return (id) => {
        if (id != null && id != "") {
         return this.gettersgestionOrdrePaiement.filter(
            (qtreel) => qtreel.unite_administrative_id == id  && qtreel.exercice==this.anneeAmort && qtreel.type_ordre_paiement==2  && qtreel.diff_op == null && qtreel.decision_cf == 9).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
        }
        return this.gettersgestionOrdrePaiement.filter(qtreel =>  qtreel.type_ordre_paiement==2  && qtreel.exercice==this.anneeAmort && qtreel.diff_op == null && qtreel.decision_cf == 9).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
    ...
    MontantOpProvisoireEnAttend() {
      return (id) => {
        if (id != null && id != "") {
         return this.gettersgestionOrdrePaiement.filter(
            (qtreel) => qtreel.unite_administrative_id == id  && qtreel.exercice==this.anneeAmort && qtreel.type_ordre_paiement==2  && qtreel.diff_op == null && qtreel.decision_cf == 0).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
        }
        return this.gettersgestionOrdrePaiement.filter(qtreel =>  qtreel.type_ordre_paiement==2  && qtreel.exercice==this.anneeAmort && qtreel.diff_op == null && qtreel.decision_cf == 0).reduce((prec,cur) => parseFloat(prec) + parseFloat(cur.montant_ordre_paiement), 0).toFixed(0); 
