      ...
      <div class="widget-box">
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            <tr
              class="odd gradeX"
              v-for="activites in partition(marcheSibFiltre, size)[page]"
              :key="activites.id"
            >
              ...
              <td @dblclick="afficherModifierMarcheHorSib(activites.id)">
                {{
                  afficherLibelleLocalisationGeographie(
                    afficheLocalisation(activites.id)
                  ) || "Non renseigné"
                }}
              </td>
              <td @dblclick="afficherModifierMarcheHorSib(activites.id)">
              ...
              <td>
                <button v-if="activites.attribue == 2" class="btn btn-warning">
              ...
              <td>
                <router-link
                  :to="{ name: 'CycleDeVie', params: { id: activites.id } }"
                  class="btn btn-inverse"
        ...
        <div class="pagination alternate">
          <ul>
            ...
            <li
              v-for="(titre, index) in partition(marcheSibFiltre, size).length"
              :key="index"
            ...
            <li
              :class="{
                disabled: page == partition(marcheSibFiltre, size).length - 1,
              }"
            >
...
export default {
  ...
  computed: {
    ...
    montantMarche() {
      return this.afficherListeMrcheSib.reduce(
