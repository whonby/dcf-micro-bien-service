...
<div>
        <div class="container-fluid">
            ...
            <hr /> -->
<div align="right">
                <a data-dismiss="modal" class="btn btn-danger" @click.prevent="retourListeEntreprise" href="#">Retour</a>
              </div>
...
<script>
    ...
    import componentCotation from '../../../src/pages/bien_service/dossierDetailMarchePs/dossierComponentPs/componentCotation';
    
     //import componentEtat from '../dossierDetailMarchePs/dossierComponentEtat/componentEtat';
     import componentOuverture from '../../../src/pages/bien_service/dossierDetailMarchePs/dossierComponentOuverture/componentOuverture';  
   import componentActe from '../../../src/pages/bien_service/dossierDetailMarchePs/dossierComponentActe/componentActe' ;
    import publicationOffre from '../../../src/pages/bien_service/DossierPso/publicationOffre/publicationOffre';
    import addLot from '../../../src/pages/bien_service/dossierLot/addLot';
        import invitationCf from '../../../src/pages/bien_service/DossierPso/lettreInvitation/invitationCf';
 import mandateBs from '../../../src/pages/bien_service/DossierPso/mandaté/mandateBs';
 import componentOuverture1 from '../../../src/pages/bien_service/dossierDetailMarcheProcedureSimplifierAvecComite/dossierComponentOuverture/componentOuverture';
import dossierCandidat from '../../../src/pages/bien_service/DossierPso/dossierCandidat/dossierCandidat'
    import componentOuvertureMembre from '../../../src/pages/bien_service/dossierDetailMarcheProcedureSimplifierAvecComite/dossierComponentOuvertureCojoMembre/componentOuvertureMembre';
    import componentAnalyse from '../../../src/pages/bien_service/dossierDetailMarcheProcedureSimplifierAvecComite/dossierComponentAnalyse/componentAnalyse';
     import componentPv from '../../../src/pages/bien_service/dossierDetailMarcheProcedureSimplifierAvecComite/dossierComponentPv/componentPv';
import rapportOuverture from '../../../src/pages/bien_service/dossierDetailMarcheProcedureSimplifierAvecComite/dossierRappportOuverture/rapportOuverture';
     
   import componentBailleur from '../../../src/pages/bien_service/dossierDetailMarchePs/dossierBailleur/componentBailleur';
//      import componentEtat from '../dossierDetailMarchePs/dossierComponentEtat/componentEtat';
...
//       import componentAnalyse from '../dossierDetailMarcheProcedureSimplifierAvecComite/dossierComponentAnalyse/componentAnalyse';
    ...
    //  import componentActe from '../dossierDetailMarchePs/dossierComponentActe/componentActe' ;
     ...
     import componentTransmissionDao from '../../../src/pages/bien_service/dossierDetailMarcheAOI_AON/dossierTransmission/componentTransmissionD';
      import componentAvis from '../../../src/pages/bien_service/dossierDetailMarcheAOI_AON/dossierDemandeAno/componentAvis';
      import executionLigneExempte from '../../../src/pages/bien_service/executionLigneExempte/executionLigneExempte';
///////////////////////////////////////////////

     
        // import publicationOffre from '../../../src/pages/bien_service/DossierPso/publicationOffre/publicationOffre';
        import componentDemandeAno from '../../../src/pages/bien_service/dossierDetailMarcheAOI_AON/dossierDemande_ano_cf/componentDemandeAno'; 
         import componentAvisBailleurSurTransmision from '../../../src/pages/bien_service/dossierDetailMarcheAOI_AON/dossierAvisBailleurSurTransmission/componentAvisBailleurSurTransmision';
        import componentAvisAnoCf from '../../../src/pages/bien_service/dossierDetailMarcheAOI_AON/dossierAvisAnoCf/componentAvisAnoCf';
         import componentAvisBailleurCf from '../../../src/pages/bien_service/dossierDetailMarcheAOI_AON/dossierAvisBailleurAvecCf/componentAvisBailleurCf'
