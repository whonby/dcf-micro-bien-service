                    ...
                    <div class="widget-box">
                        <!-- <div class="widget-title">
                            <ul class="nav nav-tabs">
                               <li class="active"><a data-toggle="tab" href="#tab2078"><span class="badge badge-inverse" ></span></a></li> -->
              ...
              <!-- <div align="right">
               ...
               <table class="table table-bordered table-striped">
                ...
                listeContratEnContratualisation"
                 :key="marche.id">
                  <!-- <td @dblclick="afficherModalModificationContrat(index)">
              ...
              <table class="table table-bordered table-striped">
                ...
                afficherLaListeDesContratsDuPersonnel"
                 ...
                 <td @dblclick="afficherModalModificationContrat(index)">
                   ...
                   <td @dblclick="afficherModalModificationContrat(index)">
                   {{marche.type_marche.libelle || 'Non renseigné'}}</td>
                 <td @dblclick="afficherModalModificationContrat(index)" style="text-align: center">
                   {{marche.procedure_passation.code || 'Non renseigné'}}</td>
                  <td @dblclick="afficherModalModificationContrat(index)">
                   {{marche.afficheActivite.libelle || 'Non renseigné'}}</td>
                    <td @dblclick="afficherModalModificationContrat(index)">
...
<div class="modal-footer">
        ...
        <a data-dismiss="modal" class="btn btn-danger" @click.prevent="" href="#">Voir Tableau</a>
         ...
         <!--///////////////////////////////////////// debut modal d ajout //////////////////////////////-->
    <div id="contratModal" class="modal hide taillModalMarche">
      <div class="modal-header">
        <button data-dismiss="modal" class="close" type="button">×</button>
    ...
    <tr>
     ...
     <div class="controls">
      <select v-model="formData.type_marche_id" class="span4">
       ...
       <td colspan="">
     <div class="control-group">
      <label class="control-label">Objet du contrat</label>
      <div class="controls">
        <textarea
 ...
 <!--///////////////////////////////////////// debut modal de modification //////////////////////////////-->
    ...
    <div id="modifierModalContrat" class="modal hide taillModalMarche">
      <div class="modal-header">
        <button data-dismiss="modal" class="close" type="button">×</button>
        <h3>Modification du contrat</h3>
      </div>
      <div class="modal-body">
  <table class="table table-bordered table-striped">
     <tr>
    ...
    <fab :actions="fabActions" @cache="afficherModalAjouterContrat" main-icon="apps" bg-color="green"></fab>
 <button style="display:none;" v-shortkey.once="['ctrl', 'f']" @shortkey="afficherModalAjouterContrat()">Open</button>
...
// }
  ...
  methods: {
    ...
    afficherModalAjouterContrat() {
      this.$("#contratModal").modal({
        backdrop: "static",
        keyboard: false
      });
    },
...
this.formData = {
    ...
    afficherModalModificationContrat(index) {
      this.$("#modifierModalContrat").modal({
        backdrop: "static",
        keyboard: false
      });
    ...
    modifierModalTypeprestationLocal(){
      ...
      this.$('#modifierModalContrat').modal('hide');
    },
