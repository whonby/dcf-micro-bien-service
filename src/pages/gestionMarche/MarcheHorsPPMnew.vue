            ...
            <div class="widget-content nopadding">
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  <tr
                    class="odd gradeX"
                    v-for="marche in partition(marcheHorSibFiltre, size)[page]"
                    :key="marche.id"
                  >
                  ...
                  {{marche.afficheEconomique.code || 'Non renseigné'}}- {{marche.afficheEconomique.libelle || 'Non renseigné'}}</td> -->
                   ...
                   {{marche.numero_marche || 'Non renseigné'}}</td> -->
                    ...
                    <td>
                      <div class="btn-group">
                        <button
                          @click.prevent="BasculerMarcheRegulation(marche.id)"
                          class="btn btn-info"
                        >
                          <span class=""
                            ><i class=""> Régulariser</i></span
                          >
                        </button>
                      </div>
                    </td>
              ...
              <div class="pagination alternate">
                <ul>
                  ...
                  <li
                    v-for="(titre, index) in partition(marcheHorSibFiltre, size)
                      .length"
                    :key="index"
                  ...
                  <li
                    :class="{
                      disabled:
                        page == partition(marcheHorSibFiltre, size).length - 1,
                    }"
                  >
...
editMarche123:{},
  ...
  computed: {
    ...
    marcheHorSibFiltre() {
      ...
      if (this.noDCfNoAdmin) {
        ...
        return colect.filter(items=>items.regularisation==1 && items.sib==1);
      }
      return this.afficheMarcheParUa(this.marcheid).filter(items=>items.regularisation==1 && items.sib==1);
    },
  ...
  methods: {
    ...
    //   this.editMarche45 = this.marcheHorSibFiltre.find(item=>item.id==id);
    // },
