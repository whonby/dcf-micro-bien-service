...
listeDesLotExecution() {
       // const st = this.search.toLowerCase();
        ...
        if (id != null && id != "") {
          return this.colect.filter(
            element => element.parent_id == id  && element.attribue == 2 && this.afficherCodetypeMarche(element.type_marche_id) == 3 || this.afficherCodetypeMarche(element.type_marche_id) == 1 && element.parent_id == id  && element.attribue == 2 || element.parent_id == id  && element.attribue == 2 && this.afficherCodetypeMarche(element.type_marche_id) == 4
          );
        }
      };
