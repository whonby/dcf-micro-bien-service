    ...
    <div class="container-fluid">
      ...
      <div class="row-fluid">
        <div class="span12">
          ...
          <br />
          <template
            v-if="affichertypeMarcheEx(detail_marche.type_marche_id) == 3"
          >
            <!-- <afficheMarcheGeneral v-if="afficherStatusSib(detail_marche.id)==0"></afficheMarcheGeneral>  -->

            <table
              class="table table-bordered table-striped"
              v-if="afficherStatusSib(detail_marche.id) == 0"
            >
              <thead>
                <tr>
                  <th>Année</th>
              ...
              <tbody>
                <tr class="odd gradeX">
                  <td @dblclick="afficherModalModifierTypePrestation(index)">
                    {{ detail_marche.exo_id || "Non renseigné" }}
                  </td>
                  <td @dblclick="afficherModalModifierTypePrestation(index)">
                    {{
                  ...
                  >
                    {{
                      detail_marche.procedure_passation.code || "Non renseigné"
                    }}
                  </td>
                  <td @dblclick="afficherModalModifierTypePrestation(index)">
                    {{
                      afficheractivite(detail_marche.activite_id) ||
                      "Non renseigné"
                    }}
                  </td>
                  <td @dblclick="afficherModalModifierTypePrestation(index)">
                    {{ detail_marche.imputation || "Non renseigné" }}
                  </td>
                  <!-- <td @dblclick="afficherModalModifierTypePrestation(index)">
                  {{marche.afficheEconomique.code || 'Non renseigné'}}- {{marche.afficheEconomique.libelle || 'Non renseigné'}}</td> -->
                  <td @dblclick="afficherModalModifierTypePrestation(index)">
                    {{ detail_marche.objet || "Non renseigné" }}
                  </td>
                  <td @dblclick="afficherModalModifierTypePrestation(index)">
                    {{ detail_marche.reference_marche || "Non renseigné" }}
                  </td>
                  <!-- <td @dblclick="afficherModalModifierTypePrestation(index)">
            ...
            <table
              class="table table-bordered table-striped"
              v-if="afficherStatusSib(detail_marche.id) == 1"
            >
              <thead>
                <tr>
                  <th>Année</th>
          ...
          <template
            v-if="
              affichertypeMarcheEx(detail_marche.type_marche_id) == 1 ||
              affichertypeMarcheEx(detail_marche.type_marche_id) == 4
            "
          >
            <table
              class="table table-bordered table-striped"
          ...
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              ...
              <table
                class="table table-bordered table-striped"
                v-if="
                  this.detail_marche.economique_id !=
                  this.CodeExempte(this.detail_marche.economique_id)
                "
              >
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr
                    class="odd gradeX"
                    v-for="marche in listeDesLotExecution(detail_marche.id)"
                    :key="marche.id"
                  >
                    <td>
                    ...
                    <td>
                      {{
                        afficherlibelleUa(marche.unite_administrative_id) ||
                        "Non renseigné"
                      }}
                    </td>
                    ...
                    <td>
                      {{
                        affichertypeMarche(marche.type_marche_id) ||
                        "Non renseigné"
                      }}
                    </td>
                    <td>
                      {{
                        afficherlibelleActivite(marche.activite_id) ||
                        "Non renseigné"
                      }}
                    </td>
                    <td>
                    ...
                    >
                      <router-link
                        ...
                        title="Detail execution Marche Gestion Hors Sib"
                      >
                        <span class=""
                          ><i class="icon-random"></i> Détail exécution</span
                        >
                      </router-link>
                      ...
                      <router-link
                        ...
                        title="Voir Tâche Prévue"
                      >
                        <span class=""
                          ><i class="icon-eye-open"></i> Voir Tâche Prévue</span
                        >
                      </router-link>
                      <button
                        @click.prevent="supprimerMarche(marche.id)"
                  ...
                  <tr>
                    ...
                    >
                      {{
                        formatageSommeSansFCFA(
                          parseFloat(
                            afficherSommeMarcheExecution(detail_marche.id)
                          )
                        )
                      }}
                    </td>
              ...
              <table class="table table-bordered table-striped" v-else>
                ...
                <tbody>
                  <tr
                    class="odd gradeX"
                    v-for="marche in listeDesLotExecutionLigneExempte(
                      detail_marche.id
                    )"
                    :key="marche.id"
                  >
      ...
      return (id) => {
        if (id != null && id != "") {
          return this.acteEffetFinanciers
            .filter((qtreel) => qtreel.marchegeneral_id == id)
            .reduce(
          ...
          if (id != null && id != "") {
            return this.colect.filter(
              (element) =>
                (element.id == id &&
                  element.attribue == 2 &&
                  element.type_marche_id == 5) ||
                (element.type_marche_id == 1 &&
                  element.id == id &&
                  element.attribue == 2) ||
                (element.type_marche_id == 6 &&
                  element.id == id &&
                  element.attribue == 2)
            );
          }
            ...
            return this.colect.filter(
              (element) =>
                (element.parent_id == id &&
                  element.attribue == 2 &&
                  this.afficherCodetypeMarche(element.type_marche_id) == 3) ||
                (element.type_marche_id == 1 &&
                  element.parent_id == id &&
                  element.attribue == 2) ||
                (element.parent_id == id &&
