            ...
            <div class="widget-box">
                <div class="widget-content">
                    <div class="widget-content nopadding">
                       <h4 v-if="detail_marche">Detail Marche pour l'investissement : {{detail_marche.objet}} </h4>
...
<!--///////////////////////////////////////// debut modal d ajout //////////////////////////////-->
    <div id="exampleModalMandatEngagement" class="modal hide taillemodal6">
      <div class="modal-header">
        <button data-dismiss="modal" class="close" type="button">×</button>
        <h3>Ajouter Mandat</h3>
      </div>
              ...
              <table class="table table-bordered table-striped ">
                <div class="widget-box">
                  <div class="widget-title">
                    <ul class="nav nav-tabs">
                      <li class="active">
                        <a data-toggle="tab" href="#tab89">INFORMATION</a>
                      </li>
                      <!-- <li>
                        <a data-toggle="tab" href="#tab2">TYPE ENGAGEMENT </a>
                      </li> -->
                      ...
                      <li>
                        <a data-toggle="tab" href="#tab56">INFO FOURNISSEUR / IMPUTATION BUDGETAIRE</a>
                      </li>
                      <!-- <li>
                        <a data-toggle="tab" href="#tab32">IMPUTATION BUDGETAIRE</a>
                      </li> -->
                  ...
                  <div class="widget-content tab-content tailfenet">
                    <!--ongle identification-->
                    <div id="tab89" class="tab-pane active">
                      <tr>
                        <td>
                          <div class="control-group">
                            <label class="control-label">Exercice Budgetaire</label>
                      ...
                      <tr>
                       ...
                       <td>
                          <div class="control-group">
                            <label class="control-label">Numéro Facture</label>
                            <div class="controls">
                              <input type="text" class="span4" v-model="affichiernumEngagement" readonly/>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="control-group">
                            <label class="control-label">Montant Facture</label>
                            <div class="controls">
                              <input type="text" class="span4" v-model="afficherMontantEngagement" readonly/>
                            </div>
                          </div>
                        </td>
...
created() {
 ...
 ...mapGetters('parametreGenerauxActivite', ['structures_activites', 
  ...
  ...mapGetters("uniteadministrative", [
      ...
      "groupUa",
      "getPersonnaliserBudgetGeneralParInvestissement"
...
afficherUniteAdmin() {
    ...
    afficherSecti() {
       ...
       const norme = this.getPersonnaliserBudgetGeneralParInvestissement.find(normeEquipe => normeEquipe.ua_id == this.detail_marche.unite_administrative_id);
...
sommeMontantAutreLigne() { 
  ...
  programmeDynamiques() {
      return id => {
        if (id != null && id != "") {
          return this.getPersonnaliserBudgetGeneralParInvestissement.filter(
...
afficherSect() {
      return id => {
        if (id != null && id != "") {
           const qtereel = this.getPersonnaliserBudgetGeneralParInvestissement.find(qtreel => qtreel.ua_id == this.detail_marche.unite_administrative_id);
    ...
    afficherAct() {
      return id => {
        if (id != null && id != "") {
           const qtereel = this.getPersonnaliserBudgetGeneralParInvestissement.find(qtreel => qtreel.activite_id == this.detail_marche.activite_id);
...
//       const norme = this.getPersonnaliserBudgetGeneralParInvestissement.find(normeEquipe => normeEquipe.economique_id == this.formData.ligne_budgetaire_id);
...
idBudgetaire() {
      ...
      const norme = this.getPersonnaliserBudgetGeneralParInvestissement.find(normeEquipe => normeEquipe.economique_id == this.detail_marche.economique_id);
 ...
 dotationInite: function () {
                return imputation => {
                    if (imputation != "") {
                        return  this.getPersonnaliserBudgetGeneralParInvestissement.find(normeEquipe => normeEquipe.codebudget == imputation);
                    }
                }
            },
...
recupererTypeProcedure() {
    ...
    recupererUniteAdministrative() {
      ...
      const norme = this.getPersonnaliserBudgetGeneralParInvestissement.find(normeEquipe => normeEquipe.ua_id == this.detail_marche.objetUniteAdministrative.id);
...
afficherModalAjouterMandatDirect(id) {
 ...
 afficherModalAjouterMandat(index) {
  ...
  retourListeEntreprise(){
                 this.$router.push({ name: 'marcheEnExecutionPourInvestissement' })
            },
