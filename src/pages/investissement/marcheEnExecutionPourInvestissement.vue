...
<template>
 ...
 <router-link :to="{ name: 'DetailEgagementInvestissement', params: { id: marche.id }}"
                ...
                <span class=""><i class="icon-trash"></i></span></button>
                      ...
                      <td>
                       ...
                       <td  style="text-align: center;color:red;font-weight:bold;">
                           {{formatageSomme(parseFloat(resultatMontantReelActeEffet))}}
...
export default {
  ...
  computed: {
      ...mapGetters("bienService", ['acteEffetFinanciers','marches','typeMarches', 'afficherTableauInvestissement',
     "montantMarche", "printMarcheNonAttribue","procedurePassations","typeTypeProcedures",
     "resultatMontantReelActeEffet"]),
...
return this. marcherAttribuer.filter((item) => {
  ...
  // afficherMotantInvestissement(){

   
  //     return this.afficherTableauInvestissement.reduce((prec, cur) =>parseFloat(prec) + parseFloat(cur.montant_act), 0)
  //   },
  ...
  //   return id => {
  //     if(id !==""){
  //       let montant = this.acteEffetFinanciers.filter(item => item.id == marche_id)
  //        return montant
  //     } else {
  //        return this.afficherTableauInvestissement.reduce((prec, cur) =>parseFloat(prec) + parseFloat(cur.montant_act), 0)
  //     }
  ...
  // },
    ...
    marcherAttribuer(){
      ...
      return this.afficherTableauInvestissement.filter(recuper => recuper.attribue == 1)
